#ifndef K9_SABIT_DEGERLER_FORMU_H
#define K9_SABIT_DEGERLER_FORMU_H
...
namespace Ui {
    class K9_SABIT_DEGERLER_FORMU;
}

class K9_SABIT_DEGERLER_FORMU : public FORM_KERNEL
{
    Q_OBJECT
public:

    K9_SABIT_DEGERLER_FORMU(QWidget *parent = 0);
    ~ K9_SABIT_DEGERLER_FORMU(){}
...
#define     AYRAC_SAYISI                11
    ...
    Ui::K9_SABIT_DEGERLER_FORMU  *       m_ui;

    int                                 m_k9_ayraci_guncellenecek;
    QString                             m_old_k9_ayraci;
...
#endif // K9_SABIT_DEGERLER_FORMU_H
