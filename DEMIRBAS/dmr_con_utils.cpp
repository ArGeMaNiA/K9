...
void DMR_AMORTISMAN_TUTARINI_ARTTIR ( int demirbas_id , int gun_no,double amortisman_tutari )
{
    ...
    select_query.NEXT();
    UNPACK_DOUBLE_ARRAY ( select_query.VALUE(0).toString(),amortisman_tutari_array,K9_ARRAY_SIZE );
    ...
    update_query.SET_VALUE ( ":amortisman_tutari_array" , PACK_DOUBLE_ARRAY(amortisman_tutari_array,K9_ARRAY_SIZE));
...
double DMR_GET_BIRIKMIS_AMORTISMAN_TUTARI ( int demirbas_id,int gun_no ,ADAK_SQL * P_GELEN_DB)
{
    ...
    double birikmis_amortisman_tutari_array [ K9_ARRAY_SIZE ] ;
    ...
    select_query.NEXT();
    UNPACK_DOUBLE_ARRAY ( select_query.VALUE(0).toString(),birikmis_amortisman_tutari_array,K9_ARRAY_SIZE );
...
void DMR_CREATE_DEMIRBAS_GRUPLARI()
{
    ...
    if (GRP_GRUP_EKLENDIMI(K9_PROGRAMI,DEMIRBAS_MODULU) EQ true)  {
        return;
    }
...
void DMR_ENTEGRASYON_FISI_OLUSTUR(int fatura_id , int demirbas_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    int cari_fis_id = CARI_GET_ENT_FIS_ID ( K9_PROGRAMI, FATURA_MODULU, fatura_id , USE_DB);
