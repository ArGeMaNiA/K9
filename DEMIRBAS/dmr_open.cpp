...
void DEMIRBAS_ITEM_CLICKED(int enum_id,QWidget * parent)
{
    switch ( enum_id ) {
        ...
        OPEN_GRUPLAR( K9_PROGRAMI , DEMIRBAS_MODULU , QObject::tr( "DMR - SABİT KIYMET GRUPLAR" ), "sabit-kiymet-demirbaslar_sabit-kiymet-gruplari", DB ,parent );
            break;
        case MENU_DMR_RAPOR_ISLEM_GRUPLARI:
        OPEN_GRUPLAR( K9_PROGRAMI , DEMIRBAS_GRUP_MODULU, QObject::tr( "DMR - SABİT KIYMET İŞLEM GRUPLAR" ), "sabit-kiymetler-demirbaslar_rapor-islem-gruplari", DB ,parent );
            break;
