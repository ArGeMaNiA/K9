...
void DMR_YENIDEN_DEGERLEME_BATCH::RUN_BATCH()
{
    ...
    gruplara_kayitli_demirbaslar_id_list = GRP_GRUBA_EKLI_KAYITLARI_BUL(K9_PROGRAMI , DEMIRBAS_GRUP_MODULU,m_grup_idleri);
    ...
    DMR_FISI->program_id      = K9_PROGRAMI;
    ...
    for ( int i = 0 ; i < gruplara_kayitli_demirbaslar_id_list.size() ; i++ ) {
        ...
        DMR_FIS_SATIRI->program_id = K9_PROGRAMI;
    ...
    K9_LOG_KAYDI_EKLE ( DEMIRBAS_MODULU , LOG_DMR_YENIDEN_DEGERLEME,-1,log_detaylari );
