...
int CEK_SENET_EKLE ( CEK_SENET_STRUCT * P_CEK_SENET )
{
    ...
    //! PORTFOY NUMARASI SON INDIS K9_SABIT DEGERLERDE TUTUYOR.
    ...
    if ( P_CEK_SENET->portfoy_numarasi EQ 0 ) {
        ...
        query.PREPARE_SELECT ( "k9_sabit_degerler","cek_portfoy_numarasi_sayaci",
                               "sabit_deger_id = 1" );
        ...
        query.PREPARE_UPDATE   ( "k9_sabit_degerler", "sabit_deger_id", "cek_portfoy_numarasi_sayaci ",
        ...
        query.PREPARE_SELECT ( "k9_sabit_degerler", "cek_portfoy_numarasi_sayaci ", "sabit_deger_id = :sabit_deger_id" );
        ...
        if ( P_CEK_SENET->portfoy_numarasi > query.VALUE(0).toInt() ) {
            query.PREPARE_UPDATE ( "k9_sabit_degerler ", "sabit_deger_id",
    ...
    query.SET_VALUE ( ":kaydedilecek_sirket"       , P_CEK_SENET->kaydedilecek_sirket       );
...
int CEK_GET_TEMEL_BILGILER( CEK_SENET_STRUCT *P_CEK, int p_cek_id )
{
    ...
    query.PREPARE_SELECT("cek_cekler_senetler",
                           ...
                           "musteri_ceki_mi, kaydedilecek_sirket, cek_senet_son_durumu, "
    ...
    if ( query.SELECT() NE 0 ) {
        ...
        P_CEK->kaydedilecek_sirket      = query.VALUE( "kaydedilecek_sirket" ).toInt();
