...
void CEK_ACILIS_FISI::SETUP_FORM()
{
    ...
    m_ui->reklamViewer->SHOW_REKLAM( "CEK-SENET-ACILIS-FISI" );
...
int CEK_ACILIS_FISI::GET_FIS_RECORD ( int record_id )
{
    ...
    select_query.PREPARE_SELECT ( "cek_bordrolar","bordro_no , bordro_tarihi,aciklama,bordro_islem_turu,"
                                  "hesap_no_id,toplam_tutar,kaydedilecek_sirket ",
                                  "bordro_id = :bordro_id");
    ...
    FIND_AND_SET_COMBOBOX_TEXT(m_ui->comboBox_sirket_turu , K9_GET_KAYDEDILECEK_SIRKET_STRING(select_query.VALUE(6).toInt()));
...
int CEK_ACILIS_FISI::ADD_FIS_RECORD()
{
    ...
    M_BORDRO->kaydedilecek_sirket            = K9_GET_KAYDEDILECEK_SIRKET_ENUM(m_ui->comboBox_sirket_turu->currentText());
...
void CEK_ACILIS_FISI::ADD_LINE ( int bordro_id, int row_number )
{
    ...
    M_CEK_SENET->kaydedilecek_sirket         = K9_GET_KAYDEDILECEK_SIRKET_ENUM(m_ui->comboBox_sirket_turu->currentText());
    ...
    M_BORDRO_SATIRI->kaydedilecek_sirket   = K9_GET_KAYDEDILECEK_SIRKET_ENUM(m_ui->comboBox_sirket_turu->currentText());
...
void CEK_ACILIS_FISI::LINE_SEARCH_EDIT_CLICKED ( int row_number ,QWidget * widget, QLineEdit * lineedit )
{
    ...
    int cari_hesap_id  = OPEN_CARI_KART_ARAMA ( lineedit->text(), SAHIS_ARTI_FIRMA,this,true , K9_PROGRAMI, CARI_MODULU  );
