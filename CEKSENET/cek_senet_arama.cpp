...
CEK_SENET_ARAMA::CEK_SENET_ARAMA ( int aranacak_cek_senet_turu, int cek_mi_senet_mi, int musteri_cek_senedi_mi,
                                   int hesap_id, int para_birimi_id ,int entegre_filtresi, QWidget *parent ) : ARAMA_KERNEL ( parent ), m_ui ( new Ui::CEK_SENET_ARAMA )
{
    ...
    m_entegre_filtresi        = entegre_filtresi;
...
void CEK_SENET_ARAMA::SEARCH()
{
    ...
    if ( m_entegre_filtresi NE FIS_HER_IKI_SIRKET ) {
        if ( m_entegre_filtresi EQ FIS_BIRINCI_SIRKET ) {
