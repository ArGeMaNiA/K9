...
void CEK_LISTESI_BATCH::SETUP_FORM()
{
    ...
    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ EVET ) {
...
void CEK_LISTESI_BATCH::RUN_BATCH()
{
    ...
    CEK_RV->entegre_filtresi      = K9_GET_RAPOR_SIRKET_FILTRESI_ENUM(m_ui->comboBox_sirket_filtresi->currentText());
...
void CEK_LISTESI_BATCH::SEARCH_EDIT_CLICKED(QWidget * widget,QLineEdit * lineedit)
{
    ...
    int cari_hesap_id  = OPEN_CARI_KART_ARAMA ( "", SAHIS_ARTI_FIRMA, this , 1, K9_PROGRAMI, CARI_MODULU );
