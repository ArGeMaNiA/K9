#ifndef K9_KULLANICI_YETKILERI_FORMU_H
#define K9_KULLANICI_YETKILERI_FORMU_H
...
namespace Ui {
    class K9_KULLANICI_YETKILERI_FORMU;
}

class K9_KULLANICI_YETKILERI_FORMU : public FORM_KERNEL
{
    Q_OBJECT

public:

    K9_KULLANICI_YETKILERI_FORMU                                 ( int p_kullanici_id, bool * yetkileri_tazele, QWidget *parent = 0 );
    ~K9_KULLANICI_YETKILERI_FORMU                                () {}

private:

    Ui::K9_KULLANICI_YETKILERI_FORMU  *       m_ui;
    int            m_yetki_id;
...
#endif // K9_KULLANICI_YETKILERI_FORMU_H
