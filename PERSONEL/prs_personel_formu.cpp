 ...
 **********************************************************************/
    ...
    GRP_KAYDIN_GRUPLARINI_BUL( K9_PROGRAMI, PERSONEL_MODULU, record_id, &prs_grup_idleri, new QStringList(), new QStringList() );
...
int PRS_PERSONEL_FORMU::SELECT_RECORD ()
{
    ...
    int cari_hesap_id = OPEN_CARI_KART_ARAMA ( "", SAHIS_KAYDI, this, 0, K9_PROGRAMI, PERSONEL_MODULU, "Personel Arama", "DELETED"  );
...
int PRS_PERSONEL_FORMU::ADD_RECORD ()
{
    ...
    ***********************************************************/
    ...
    int prs_cari_hesap_id = 0;
                ...
                hesap_bilgileri.program_id             = K9_PROGRAMI;
   ...
   sql_query_nufus.INSERT();
    ...
    K9_LOG_KAYDI_EKLE(PERSONEL_MODULU , LOG_PRS_PERSONEL , LOG_ISLEM_ADD , log_detaylari);

    GRP_KAYDI_GRUPLARA_EKLE( K9_PROGRAMI , PERSONEL_MODULU , m_personel_id ,&prs_grup_idleri);
...
void PRS_PERSONEL_FORMU::UPDATE_RECORD (int record_id)
{
    ...
    if (m_fotograf_path.isEmpty() EQ false) {
        ...
        GRP_KAYDI_GRUPLARA_EKLE( K9_PROGRAMI, PERSONEL_MODULU, record_id ,&prs_grup_idleri );
    ...
    K9_LOG_KAYDI_EKLE(PERSONEL_MODULU , LOG_PRS_PERSONEL , LOG_ISLEM_UPDATE , log_detaylari);
...
void PRS_PERSONEL_FORMU::SAVER_BUTTON_CLICKED(QAbstractButton * button, int record_id)
{
    ...
    if ( button EQ m_ui->push_button_aile_bireyleri ) {
        ...
        OPEN_CARI_NOT_DEFTERI( PRS_GET_CARI_HESAP_ID( record_id ), PERSONEL_MODULU, K9_PROGRAMI, this );
...
int PRS_PERSONEL_FORMU::CHANGER_BUTTON_CLICKED ( QAbstractButton * p_button )
{
    ...
    if ( p_button EQ m_ui->pushButton_grup_ekle ) {
        ...
        if ( OPEN_GRUP_SECIM( K9_PROGRAMI, PERSONEL_MODULU , &prs_grup_idleri , DB , this ) EQ true )
        {
            m_ui->textEdit_gruplar->setText ( GRP_GRUP_ADLARINI_BUL(&prs_grup_idleri , new QStringList() , new QStringList() ) );
            return ADAK_RECORD_CHANGED;
        }
...
/**************************************************************************************
                   PRS_PERSONEL_FORMU::SHOW_REKLAM
***************************************************************************************/

void PRS_PERSONEL_FORMU::SHOW_REKLAM()
{
       m_ui->reklamViewer->SHOW_REKLAM("PRS_PERSONEL_FORMU");
}
