...
void PRS_IBRANAME_MADDELERI_BATCH::SETUP_FORM()
{
    ...
    SET_ICON_OF_BATCH_BUTTON        (":/k9_icons/K9_ICONS/kaydet_ikonu.png");
    ...
    sql_query.PREPARE_SELECT("k9_sabit_degerler ","firma_ismi", "sabit_deger_id =:sabit_degerler");
...
void PRS_IBRANAME_MADDELERI_BATCH::RUN_BATCH ()
{
    ...
    K9_LOG_KAYDI_EKLE(PERSONEL_MODULU , LOG_PRS_IBRANAME_MADDELERI , LOG_ISLEM_UPDATE , log_detaylari);
