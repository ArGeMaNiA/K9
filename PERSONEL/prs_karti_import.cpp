...
void PRS_KARTI_IMPORT::IMPORT_ROW( QStringList kayit_bilgisi_list )
{
    ...
    PRS_HESAP_KARTI.program_id      =  K9_PROGRAMI ;
   ...
   //! BUNDAN DLLAYI MODUL ID OLARAK CARI GITMESI LAZIM......
    ...
    if ( cari_borc NE 0.00 OR cari_alacak NE 0.00 ) {
        ...
        if( m_fis_id EQ -1 ){
            ...
            PRS_FIS->program_id           =  K9_PROGRAMI ;
            ...
            PRS_FIS->kaydedilecek_sirket  =  SIRKET_1 ;
        ...
        PRS_FIS_SATIRI.program_id            =  K9_PROGRAMI ;
        PRS_FIS_SATIRI.modul_id              =  CARI_MODULU ;
        PRS_FIS_SATIRI.kaydedilecek_sirket   =  SIRKET_1;
    ...
    if ( GET_GRUP_IDLERI()->size() > 0 ) {
        ...
        GRP_KAYDI_GRUPLARA_EKLE( K9_PROGRAMI, PERSONEL_MODULU, personel_id , GET_GRUP_IDLERI() );
    }
}
