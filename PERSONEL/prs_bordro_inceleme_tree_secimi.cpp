...
{    
    ...
    if ( sql_query.SELECT() NE 0 ) {
        ...
        while ( sql_query.NEXT() EQ true ) {
           ...
           tree_row_type               = 0;
           bordro_donemi               = K9_GET_AYLAR_STRING( bordro_donemi_ay ) + " / "+
...
void BORDRO_INCELEME_TREE_SECIMI::SLOT_URETTIGI_FISLER()
{
    ...
    K9_URETILEN_FIS_SEC( K9_PROGRAMI, PERSONEL_MODULU, push_button_urt_fisler->objectName().toInt(), nativeParentWidget() );
}
