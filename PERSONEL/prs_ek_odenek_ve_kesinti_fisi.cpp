...
void PRS_EK_ODENEK_VE_KESINTI_FISI::SETUP_FORM()
{
    ...
    m_ui->reklamViewer->SHOW_REKLAM( "PERSONEL-EK-KESINTI-VE-ODENEKLER" );
...
int PRS_EK_ODENEK_VE_KESINTI_FISI::CHECK_FIS_FORM_EMPTY()
{
    ...
    query.SET_VALUE     (":bordro_donemi_ay", K9_GET_AYLAR_ENUM( m_ui->comboBox_bordro_donemi_ay->currentText()) );
...
void PRS_EK_ODENEK_VE_KESINTI_FISI::ADD_LINE ( int record_id, int row_number )
{
    ...
    int bordro_donemi_ay    = K9_GET_AYLAR_ENUM( m_ui->comboBox_bordro_donemi_ay->currentText() );
...
void PRS_EK_ODENEK_VE_KESINTI_FISI::LINE_SEARCH_EDIT_CLICKED(int row_number, QWidget * widget, QLineEdit * lineedit )
{
    ...
    if ( widget EQ searchedit_personel_kodu ) {
        ...
        int cari_hesap_id = OPEN_CARI_KART_ARAMA ( lineedit->text(), SAHIS_KAYDI, this, 1, K9_PROGRAMI, PERSONEL_MODULU, "PERSONEL ARAMA", "DELETED" );
