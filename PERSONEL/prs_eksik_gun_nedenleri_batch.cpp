...
void PRS_EKSIK_GUN_NEDENLERI_BATCH::SETUP_FORM ()
{
    ...
    FIND_AND_SET_COMBOBOX_TEXT( m_ui->comboBox_bordro_ay, K9_GET_AYLAR_STRING( current_month));
...
{
    m_ay = K9_GET_AYLAR_ENUM( m_ui->comboBox_bordro_ay->currentText() );
    ...
    query.SET_VALUE(":bordro_donemi_ay"     , K9_GET_AYLAR_ENUM( m_ui->comboBox_bordro_ay->currentText() ));
