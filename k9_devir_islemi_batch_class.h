#ifndef K9_DEVIR_ISLEMI_BATCH_H
#define K9_DEVIR_ISLEMI_BATCH_H
...
namespace Ui {
    class K9_DEVIR_ISLEMI_BATCH;
}

class K9_DEVIR_ISLEMI_BATCH : public BATCH_KERNEL
{
    Q_OBJECT

private:
    Ui::K9_DEVIR_ISLEMI_BATCH *   m_ui;

public:
                           K9_DEVIR_ISLEMI_BATCH                            (QWidget *parent = 0);
                           ~K9_DEVIR_ISLEMI_BATCH                           () {}
private:
    ...
    void                   BNK_ACILIS_FISI_OLUSTUR                          (int entegre_fis_mi);
    ...
    void                   CARI_ACILIS_FISI_OLUSTUR                         (int entegre_fis_mi);
    ...
    void                   CEK_SENET_ACILIS_BORDROSU_OLUSTUR                (int entegre_fis_mi);
    ...
    void                   MUH_ACILIS_FISI_OLUSTUR                          (int entegre_fis_mi);

    void                   MUH_KAPANIS_FISI_OLUSTUR                         (int entegre_fis_mi);
    ...
    void                   STOK_ACILIS_FISI_OLUSTUR                         ( int entegre_fis_mi);
    ...
    int                    FIND_UYGUN_ACILIS_BORDROSU                       (int bordro_islem_turu , int cek_senet_turu,
