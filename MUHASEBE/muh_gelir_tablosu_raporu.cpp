...
QString GELIR_TABLOSU_RAPORU::GET_HEADER()
{
    ...
    ADD_ROW_TO_TABLE ( QStringList() << K9_GET_FIRMA_ISMI() << "<b> GELİR TABLOSU </b>" << "" );
...
void GELIR_TABLOSU_RAPORU::GRUBUN_HESAPLARINI_GELIR_TABLOSUNA_EKLE(int p_grup_indis_no , const char * p_grup_kodu)
{
    ...
    if (sql_query.SELECT() > 0 ) {
        ...
        while (sql_query.NEXT()) {
            ...
            MUH_GET_FROM_GIDER_HESABI_ISLENMEMIS_BAKIYE(hesap_id ,borc_bakiye , alacak_bakiye ,M_MUH_RV->entegre_filtresi,gun_no);
            ...
            if ( tam_hesap_kodu EQ "690") {
                ...
                MUH_GET_FROM_GELIR_TABLOSU_DONEM_NET_KARI_ZARARI(donem_kari,donem_zarari,M_MUH_RV->entegre_filtresi,bts_gun_no);
