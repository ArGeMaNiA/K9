...
void MUH_HESAP_EKSTRESI_BATCH::SETUP_FORM()
{
    ...
    m_ui->label_sirket_turu->setVisible(false);
    m_ui->frame_sirket->setVisible(false);
    ...
    sql_query.PREPARE_SELECT("k9_kullanici_yetkileri" , "hesap_ekstresi_nakli_yekun" ,
...
void MUH_HESAP_EKSTRESI_BATCH::RUN_BATCH()
{
    ...
    if ( m_ui->comboBox_sirket_turu->count() > 0 ) {
