...
void MUH_KDV_AYIRMA_BATCH::RUN_BATCH()
{
    ...
    *m_accepted = true;
    ...
    K9_LOG_KAYDI_EKLE ( MUHASEBE_MODULU,-1 ,LOG_ISLEM_KDV_AYIRMA,log_detaylari );
...
void MUH_KDV_AYIRMA_BATCH::INDIRILECEK_KDV_HESAPLARI_COMBOBOX_DOLDUR ()
{
    ...
    query.PREPARE_SELECT("k9_sabit_degerler" , "ind_kdv_hesap_id_array" );
...
void MUH_KDV_AYIRMA_BATCH::HESAPLANAN_KDV_HESAPLARI_COMBOBOX_DOLDUR ()
{
    ...
    query.PREPARE_SELECT("k9_sabit_degerler" , "hes_kdv_hesap_id_array" );
