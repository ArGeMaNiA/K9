...
void            MUH_HESABININ_BAKIYELERINI_ARTTIR           ( int hesap_id , int gun_no , double borc_tutari ,
                                                              double alacak_tutari, int kaydedilecek_sirket, ADAK_SQL * P_DB = NULL );
...
void            MUH_GET_FROM_GIDER_HESABI_ISLENMEMIS_BAKIYE     ( int gelir_tablosu_hesabi_id , double &borc_bakiye , double &alacak_bakiye , int entegre_filtresi,int gun_no);
