...
QString DEFTERI_KEBIR_RAPORU::GET_BODY()
{
    ...
    for ( ;  ; ) {
        ...
        UNPACK_DOUBLE_ARRAY ( M_MUH_ANA_HESAPLAR [ m_son_hesap_index ].borc_bakiyesi   , BORC_BAKIYESI   , K9_ARRAY_SIZE );
        UNPACK_DOUBLE_ARRAY ( M_MUH_ANA_HESAPLAR [ m_son_hesap_index ].alacak_bakiyesi , ALACAK_BAKIYESI , K9_ARRAY_SIZE );
...
bool DEFTERI_KEBIR_RAPORU::RAPOR_VERILERINI_AL ()
{
    ...
    sql_query.PREPARE_SELECT("muh_hesaplar" ,
                             "hesap_id, tam_hesap_kodu, hesap_ismi,ent_borc_array, ent_alacak_array" ,
    ...
    sql_query.PREPARE_SELECT("muh_hesaplar,muh_fisler,muh_fis_satirlari" ,
                             ...
                             "AND muh_fis_satirlari.kaydedilecek_sirket = :kaydedilecek_sirket ");
