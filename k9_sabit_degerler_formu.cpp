...
#include "k9_sabit_degerler_formu_class.h"
#include "ui_k9_sabit_degerler_formu.h"
...
//      AYRAC SAYISI DEFINITION k9.h DE YER ALMAKTADIR. BURADAKI DEGISIKLIK DEFIMITION A YANSITILMALIDIR



/*************************************************************************************************************
                                            OPEN_K9_SABIT_DEGERLER_FORMU
*************************************************************************************************************/

void OPEN_K9_SABIT_DEGERLER_FORMU  ( QWidget * parent)
{
    K9_SABIT_DEGERLER_FORMU * F = new K9_SABIT_DEGERLER_FORMU ( parent);
    F->SHOW( FULL_SCREEN );
     
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU:: K9_SABIT_DEGERLER_FORMU
*************************************************************************************************************/

 K9_SABIT_DEGERLER_FORMU:: K9_SABIT_DEGERLER_FORMU ( QWidget * p_parent ) : FORM_KERNEL ( p_parent ), m_ui ( new Ui:: K9_SABIT_DEGERLER_FORMU )
{
    m_ui->setupUi     ( this );
 ...
 /*************************************************************************************************************
                                     K9_SABIT_DEGERLER_FORMU::SETUP_FORM
 *************************************************************************************************************/

void  K9_SABIT_DEGERLER_FORMU::SETUP_FORM()
{
     ...
     SET_SETTING_NAME    ( "K9_SABIT_DEGERLER_FORMU" );
      
     m_ui->reklamViewer->SHOW_REKLAM( "K9-SABIT-DEGERLER" );
     ...
     for ( int i = 0; i < AYRAC_SAYISI ; i++ ) {
         m_ui->combobox_k9_ayraci->addItem(AYRACLAR[i][0]);
     }

     REGISTER_CHANGER_BUTTON(m_ui->pushButton_logo);

     K9_FILL_KDV_ORANLARI_COMBOBOX(m_ui->comboBox_ontanimli_kdv_orani);
 ...
 /*************************************************************************************************************
                                     K9_SABIT_DEGERLER_FORMU::CLEAR_FORM_MEMBERS
 *************************************************************************************************************/

void  K9_SABIT_DEGERLER_FORMU::CLEAR_FORM_MEMBERS ()
{
}

 /*************************************************************************************************************
                                     K9_SABIT_DEGERLER_FORMU::NEW_RECORD
 *************************************************************************************************************/

void  K9_SABIT_DEGERLER_FORMU::NEW_RECORD()
{
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::GET_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::GET_RECORD ( int p_record_id )
{
    SQL_QUERY sql_query ( DB );

    sql_query.PREPARE_SELECT("k9_sabit_degerler",
                             ...
                             "k9_ayraci,firma_logosu, ontanimli_kdv_orani, "
    ...
    int k9_ayrac_index = m_ui->combobox_k9_ayraci->findText ( sql_query.VALUE("k9_ayraci").toString() );
    m_ui->combobox_k9_ayraci->setCurrentIndex ( k9_ayrac_index );
    m_ui->lineedit_k9_ayraci->setText         ( AYRACLAR[k9_ayrac_index][1]);
...
/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::CHECK_VAR
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHECK_VAR ( QObject * p_object )
{
    ...
    else if ( p_object EQ m_ui->combobox_k9_ayraci ) {
        m_ui->lineedit_k9_ayraci->setText ( AYRACLAR [ m_ui->combobox_k9_ayraci->currentIndex() ][1] );
    }
...
/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::CHECK_EMPTY
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHECK_EMPTY ()
{
...
/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::CHECK_ADD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHECK_ADD ()
{
    return ADAK_OK;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::ADD_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::ADD_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::CHECK_UPDATE
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHECK_UPDATE ( int p_record_id )
{
    m_k9_ayraci_guncellenecek = 0;
    ...
    QString old_k9_ayraci = sql_query.VALUE(0).toString();

    if ( old_k9_ayraci NE m_ui->combobox_k9_ayraci->currentText() ) {
        ...
        m_k9_ayraci_guncellenecek = 1;
        m_old_k9_ayraci           = old_k9_ayraci;
    }

    sql_query.PREPARE_SELECT("k9_sabit_degerler", "mali_yil_ilk_tarih");
    if ( sql_query.SELECT() EQ 0 ) {
...
/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::UPDATE_RECORD
*************************************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::UPDATE_RECORD ( int p_record_id )
{
    ...
    QDate k9_array_son_tarih        = mali_yil_ilk_tarih.addDays ( K9_ARRAY_SIZE - 2 );

    if ( m_k9_ayraci_guncellenecek EQ true ) {
        K9_DELIMETER_UPDATE ( m_old_k9_ayraci, m_ui->combobox_k9_ayraci->currentText(), this );
    }
    ...
    sql_query.SET_VALUE ( ":k9_array_son_tarih",                        k9_array_son_tarih.toString("yyyy.MM.dd")                                                           );
    sql_query.SET_VALUE ( ":k9_ayraci",                                 m_ui->combobox_k9_ayraci->currentText()                                                             );
    ...
    K9_SET_ACIK_KAPALI_FATURA_SABIT_DEGER   (  FAT_GET_ACIK_KAPALI_FATURA_ENUM ( m_ui->comboBox_acik_fatura_mi->currentText() ) );
    ...
    K9_SET_KDV_ORANLARI_OKUNDUMU_FLAG ( false );
    K9_SET_OTV_ORANLARI_OKUNDUMU_FLAG ( false );

    K9_SET_FIRMA_ISMI( m_ui->lineEdit_firma_ismi->text() );


    K9_LOG_KAYDI_EKLE (K9_YONETIM , LOG_K9_SABIT_DEGERLER , LOG_ISLEM_UPDATE , "Sabit Değerler");

}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::CHECK_DELETE
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHECK_DELETE ( int p_record_id )
{
...
/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::DELETE_RECORD
*************************************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::DELETE_RECORD ( int p_record_id )
{
    Q_UNUSED ( p_record_id );
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::FIND_FIRST_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::FIND_FIRST_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::FIND_LAST_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::FIND_LAST_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::FIND_NEXT_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::FIND_NEXT_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::FIND_PREV_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::FIND_PREV_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::SELECT_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::SELECT_RECORD()
{
    return 0;
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::LOCK_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::LOCK_RECORD ( int p_record_id )
{
    return DB->LOCK_ROW ( "sabit_deger_id","k9_sabit_degerler", QString ( "sabit_deger_id = %1").arg ( p_record_id ) );
}
...
void K9_SABIT_DEGERLER_FORMU::UNLOCK_RECORD ( int p_record_id )
{
    DB->UNLOCK_ROW ( "sabit_deger_id","k9_sabit_degerler", QString ( "sabit_deger_id = %1").arg ( p_record_id ) );
}

/*************************************************************************************************************
                                    K9_SABIT_DEGERLER_FORMU::FIND_RECORD
*************************************************************************************************************/

int K9_SABIT_DEGERLER_FORMU::FIND_RECORD ()
{
    return 0;
}

/*************************************************************************************************************
                            K9_SABIT_DEGERLER_FORMU::SET_WIDGET_DEFAULT_LENGTHS
*************************************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::SET_WIDGET_DEFAULT_LENGTHS ()
{
    ...
    SET_COMBOBOX_LENGTH(m_ui->combobox_k9_ayraci,1);
...
/**************************************************************************/
/*               K9_SABIT_DEGERLER_FORMU::ADRES_BILGILERINI_OLUSTUR             */
/**************************************************************************/

void K9_SABIT_DEGERLER_FORMU::ADRES_BILGILERINI_OLUSTUR()
{
...
/**************************************************************************/
/*               K9_SABIT_DEGERLER_FORMU::CHANGER_BUTTON_CLICKED();       */
/**************************************************************************/

int K9_SABIT_DEGERLER_FORMU::CHANGER_BUTTON_CLICKED(QAbstractButton *button)
{
    Q_UNUSED(button);
...
/**************************************************************************************
                   K9_SABIT_DEGERLER_FORMU::SEARCH_EDIT_CLICKED
***************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::SEARCH_EDIT_CLICKED ( QWidget * p_widget, QLineEdit * p_lineEdit )
{
    Q_UNUSED ( p_widget );
...
/**************************************************************************/
/*               K9_SABIT_DEGERLER_FORMU::LOGO_SEC()                      */
/**************************************************************************/

int K9_SABIT_DEGERLER_FORMU::LOGO_SEC()
{
...
/**************************************************************************************
                   K9_SABIT_DEGERLER_FORMU::WIDGET_DIZILERINI_DUZENLE
***************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::WIDGET_DIZILERINI_DUZENLE ()
{
...
/**************************************************************************************
        K9_SABIT_DEGERLER_FORMU::KDV_OTV_HESAP_SAYISINA_GORE_EKRANI_DUZENLE
***************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::KDV_OTV_HESAP_SAYISINA_GORE_EKRANI_DUZENLE ()
{
    SQL_QUERY query ( DB );
...
/**************************************************************************************
        K9_SABIT_DEGERLER_FORMU::KDV_OTV_HESAPLARI_GUNCELLE
***************************************************************************************/

void K9_SABIT_DEGERLER_FORMU::KDV_OTV_HESAPLARI_GUNCELLE()
{
    SQL_QUERY sql_query( DB );
