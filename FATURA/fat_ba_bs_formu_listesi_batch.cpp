...
void FAT_BA_BS_FORMU_LISTESI_BATCH::SETUP_FORM()
{
    ...
    K9_FILL_COMBOBOX_AYLAR( m_ui->comboBox_ay );

    FIND_AND_SET_COMBOBOX_TEXT( m_ui->comboBox_ay, K9_GET_AYLAR_STRING( QDate::currentDate().month() ) );
...
void FAT_BA_BS_FORMU_LISTESI_BATCH::RUN_BATCH ()
{
     ...
     int ay = K9_GET_AYLAR_ENUM( m_ui->comboBox_ay->currentText() );
     if ( ay < 10  ) {
