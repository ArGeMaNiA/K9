...
int ADRES_ARAMA::CHECK_VAR ( QObject * object )
{
    if ( object EQ m_ui->comboBox_sehir ) {
        ...
        OPEN_GRUP_SECIM( K9_PROGRAMI, ADRES_MODULU, m_grup_idleri, DB, this );
...
void ADRES_ARAMA::SEARCH()
{
    ...
    if ( m_ui->checkBox_grup_filtresi->isChecked() EQ true ) {
        ...
        gruplardaki_kayit_listesi = GRP_GRUBA_EKLI_KAYITLARI_BUL( K9_PROGRAMI, ADRES_MODULU, *m_grup_idleri );
