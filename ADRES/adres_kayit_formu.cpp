...
int ADRES_KAYIT_FORMU::GET_RECORD ( int record_id )
{
    ...
    m_ui->textEdit_gruplar->setText ( GRP_KAYDIN_GRUPLARINI_BUL(K9_PROGRAMI, ADRES_MODULU,record_id , &m_grup_idleri, new QStringList() , new QStringList() ) );
...
int ADRES_KAYIT_FORMU::CHECK_VAR ( QObject * object )
{
    ...
    if ( object EQ m_ui->combo_box_cep_tel_ulke_kodu ) {
        ...
        if ( m_modul_id NE ADRES_MODULU OR m_program_id NE K9_PROGRAMI  ) {
...
int ADRES_KAYIT_FORMU::ADD_RECORD ()
{
    ...
    M_ADR_STRUCT->program_id                  = K9_PROGRAMI;
    ...
    GRP_KAYDI_GRUPLARA_EKLE(K9_PROGRAMI,ADRES_MODULU,record_id,&m_grup_idleri);
    ...
    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_SAHIS_KAYDI,LOG_ISLEM_ADD,log_detaylari);
...
void ADRES_KAYIT_FORMU::UPDATE_RECORD ( int p_adres_id )
{
    ...
    GRP_KAYDI_GRUPLARA_EKLE(K9_PROGRAMI,ADRES_MODULU,p_adres_id,&m_grup_idleri);

    QString log_detaylari = QObject::tr("Log Türü: ŞAHIS KAYDI");
    log_detaylari.append ( " # Şahıs Adı Soyadı: " );
    log_detaylari.append ( m_ui->lineEdit_sahis_adi_soyadi->text() );

    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_SAHIS_KAYDI,LOG_ISLEM_UPDATE ,log_detaylari);
...
void ADRES_KAYIT_FORMU::DELETE_RECORD ( int p_adres_id )
{
    ...
    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_SAHIS_KAYDI,LOG_ISLEM_DELETE ,log_detaylari);
    ...
    GRP_KAYDIN_GRUPLARINI_SIL(K9_PROGRAMI , ADRES_MODULU , p_adres_id);
}
...
void ADRES_KAYIT_FORMU::SAVER_BUTTON_CLICKED ( QAbstractButton * p_button, int p_adres_id  )
{
    if ( p_button EQ m_ui->button_not_defteri ) {
        OPEN_ADRES_NOT_DEFTERI_FISI ( p_adres_id,ADRES_MODULU,K9_PROGRAMI, this );
    }
...
int ADRES_KAYIT_FORMU::CHANGER_BUTTON_CLICKED ( QAbstractButton * p_button )
{
    ...
    if ( p_button EQ m_ui->push_button_gruplar ) {
        ...
        if ( OPEN_GRUP_SECIM( K9_PROGRAMI,ADRES_MODULU , &m_grup_idleri , DB , this ) EQ true ) {
...
/**************************************************************************************
                   ADRES_KAYIT_FORMU::SHOW_REKLAM
***************************************************************************************/

void ADRES_KAYIT_FORMU::SHOW_REKLAM()
{
    m_ui->reklamViewer->SHOW_REKLAM("ADRES-KARTI");
}
