...
//    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_FIRMA_YETKILI_KAYDI,LOG_ISLEM_ADD,log_detaylari);
...
//    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_FIRMA_YETKILI_KAYDI,LOG_ISLEM_UPDATE,log_detaylari);
...
//    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_FIRMA_YETKILI_KAYDI,LOG_ISLEM_DELETE,log_detaylari);
