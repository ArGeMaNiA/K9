...
//    SEND_MAIL ( gonderen_mail, gonderen_mail, alici_mail , "test", "test maili" , K9_PROGRAMI,ADRES_MODULU, "Mesajınız Gönderildi..." );
//    EMAIL_SET_TOPLU_GONDER_FLAG(true);
    ...
    if ( m_ui->combo_box_gonderim_sekli->currentIndex() EQ 0 ) {
        EMAIL_SET_TOPLU_GONDER_FLAG(true);
        SEND_MAIL ( m_ui->lineEdit_kimden->text(), kullanici_adi, m_to_email_address_with_record_id , m_ui->lineEdit_konu->text(), m_ui->textEdit_icerik->toPlainText(),K9_PROGRAMI,ADRES_MODULU, "Mesajınız Gönderildi..." );
    }
    else {
        EMAIL_SET_TOPLU_GONDER_FLAG(false);
        SEND_MAIL ( m_ui->lineEdit_kimden->text(), kullanici_adi, m_to_email_address_with_record_id , m_ui->lineEdit_konu->text(), m_ui->textEdit_icerik->toPlainText() , K9_PROGRAMI,ADRES_MODULU, "Mesajınız Gönderildi..." );
    ...
    K9_LOG_KAYDI_EKLE(ADRES_MODULU,LOG_ADR_MAIL_GONDERIMI,-1,log_detaylari);
