#include "k9_ent_detaylari_batch_class.h"
#include "ui_k9_ent_detaylari_batch.h"
...
/**************************************************************************************
                   OPEN_K9_ENT_DETAYLARI_BATCH
***************************************************************************************/

void OPEN_K9_ENT_DETAYLARI_BATCH ( K9_ENT_DETAYLARI_STRUCT * P_ENT_DETAYLARI, bool kasa_hesabi_gosterilecek  , QWidget * p_parent )
{
    K9_ENT_DETAYLARI_BATCH * F = new K9_ENT_DETAYLARI_BATCH ( P_ENT_DETAYLARI,kasa_hesabi_gosterilecek ,p_parent);
    F->EXEC( NOT_FULL_SCREEN );
}

/**************************************************************************************
                   K9_ENT_DETAYLARI_BATCH::K9_ENT_DETAYLARI_BATCH
***************************************************************************************/

K9_ENT_DETAYLARI_BATCH::K9_ENT_DETAYLARI_BATCH ( K9_ENT_DETAYLARI_STRUCT * P_ENT_DETAYLARI, bool kasa_hesabi_gosterilecek,QWidget * p_parent ) :  BATCH_KERNEL ( p_parent ), m_ui ( new Ui::K9_ENT_DETAYLARI_BATCH )
{
...
/**************************************************************************************
                   K9_ENT_DETAYLARI_BATCH::CHECK_VAR
***************************************************************************************/

void K9_ENT_DETAYLARI_BATCH::SETUP_FORM()
{
    SET_PAGE_TITLE    ( tr ( "ENTEGRASYON DETAYLARI" )        );
    SET_HELP_PAGE     ( "k9_entegrasyon_detaylari_batch.html" );
    ...
    SET_SETTING_NAME  ( "k9_entegrasyon_detaylari_batch"      );
...
int K9_ENT_DETAYLARI_BATCH::CHECK_VAR ( QObject * object )
{
...
/**************************************************************************************
                   K9_ENT_DETAYLARI_BATCH::CHECK_RUN
***************************************************************************************/

int K9_ENT_DETAYLARI_BATCH::CHECK_RUN ()
{
    if ( m_kasa_hesabi_gosterilecek EQ true ) {
        if ( m_ui->searchEdit_kasa_hesap_kodu->GET_TEXT().isEmpty() EQ true ) {
...
/**************************************************************************************
                   K9_ENT_DETAYLARI_BATCH::RUN_BATCH
***************************************************************************************/

void K9_ENT_DETAYLARI_BATCH::RUN_BATCH ()
{

}

/**************************************************************************************
                   K9_ENT_DETAYLARI_BATCH::SEARCH_EDIT_CLICKED
***************************************************************************************/

void K9_ENT_DETAYLARI_BATCH::SEARCH_EDIT_CLICKED(QWidget *widget, QLineEdit *line_edit)
{
    Q_UNUSED ( widget );
