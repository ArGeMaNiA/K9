...
/**************************************************************************************
                   OPEN_K9_PROFIL_SECME
***************************************************************************************/

void  OPEN_K9_PROFIL_SECME ( PROFIL_CAGRILAN_YER p_cagrilan_yer, QWidget * parent, bool * p_degisiklik_yapildimi )
{
    K9_PROFIL_SECME * p = new K9_PROFIL_SECME( p_cagrilan_yer, parent, p_degisiklik_yapildimi );
...
K9_PROFIL_SECME::K9_PROFIL_SECME ( PROFIL_CAGRILAN_YER p_cagrilan_yer, QWidget *parent, bool * p_degisiklik_yapildimi ) :
    BATCH_KERNEL( parent ), m_ui(new Ui::K9_PROFIL_SECME)
{
    m_ui->setupUi(this);
    ...
    *m_degisiklik_yapildimi  = false;
    ...
    this->setWindowTitle( QObject::tr( "K9 PROFİL SEÇME" ));
...
/**************************************************************************************
                   K9_PROFIL_SECME::SETUP_FORM
***************************************************************************************/

void K9_PROFIL_SECME::SETUP_FORM()
{
    SET_HELP_PAGE  ( "yonetim-islemleri_k9-profil-secme" );
    SET_PAGE_TITLE ( tr ( "K9 Profil Seçme" ) );
...
/**************************************************************************************
                   K9_PROFIL_SECME::CHECK_VAR
***************************************************************************************/
int K9_PROFIL_SECME::CHECK_VAR(QObject *p_object)
{
    Q_UNUSED( p_object );
    return ADAK_OK;
}
...
/**************************************************************************************
                   K9_PROFIL_SECME::CHECK_RUN
***************************************************************************************/

int K9_PROFIL_SECME::CHECK_RUN()
{
...
/**************************************************************************************
                   K9_PROFIL_SECME::RUN_BATCH
***************************************************************************************/

void K9_PROFIL_SECME::RUN_BATCH()
{   
    if ( m_cagrilan_yer EQ ENUM_K9_KULLANICI_YETKILERI ) {
        K9_KULLANICI_STRUCT_GUNCELLE();
    }
    else {
        K9_PROFIL_BILGILERINI_DB_YAZ();
    }
...
/**************************************************************************************
                   K9_PROFIL_SECME::SLOT_CHANGE_PROFILE
***************************************************************************************/

void K9_PROFIL_SECME::SLOT_CHANGE_PROFILE( QListWidgetItem * current_item )
{
...
/**************************************************************************************
                   K9_PROFIL_SECME::SLOT_DOUBLE_CLICK_PROFILE
***************************************************************************************/

void K9_PROFIL_SECME::SLOT_DOUBLE_CLICK_PROFILE( QListWidgetItem * current_item )
{
    m_profil_id = GET_PROFIL_TIPI( current_item->text() );
...
/**************************************************************************************
                   K9_PROFIL_SECME::SLOT_CHANGE_CURRENT_ROW
***************************************************************************************/

void K9_PROFIL_SECME::SLOT_CHANGE_CURRENT_ROW( int p_current_row )
{
    SLOT_CHANGE_PROFILE( m_ui->listWidget_profil->item( p_current_row ) );
}

/**************************************************************************************
                   K9_PROFIL_SECME::GET_PROFIL_TIPI
***************************************************************************************/

int K9_PROFIL_SECME::GET_PROFIL_TIPI( QString p_profil_name )
{
...
/**************************************************************************************
                   K9_PROFIL_SECME::FILL_LIST_WIDGET
***************************************************************************************/

void K9_PROFIL_SECME::FILL_LIST_WIDGET( QListWidget *p_list_widget )
{
    p_list_widget->clear();
...
/**************************************************************************************
                   K9_PROFIL_SECME::GET_PROFIL_BILGILERI
***************************************************************************************/

QString K9_PROFIL_SECME::GET_PROFIL_BILGILERI( int p_profil_id )
{
    QString program_icerigi = "";
    if ( p_profil_id EQ FATURA_CARI_STOK_TAKIP_PROGRAMI ) {
        program_icerigi = "K9 ' u Ön Muhasebe Programı olarak kullanmak isteyenler bu seçeneği seçmeli.\n\n"
    ...
    if ( p_profil_id EQ ADRES_ETIKET_TOPLU_MAIL_TOPLU_SMS_PROGRAMI ) {
        program_icerigi = "K9 ' u bir Adres / Etiket programı olarak ta kullanabilirsiniz.\n\n"
    ...
    if ( p_profil_id EQ SERBEST_MESLEK_PROGRAMI ) {
        program_icerigi = "Avukatlar , Doktorlar, Mühendisler , Mimarlar vs verdikleri hizmetin karşılığında "
                          ...
                          "K9 ' da Serbest Meslek Makbuzunu bilgisayardan yazdırabilir , hizmet kalitenizi arttırabilirsiniz.\n\n"
                          "Tasarımcı Modülü sayesinde her türlü makbuzu K9 ' da tasarlamak çok kolay. "
    ...
    if ( p_profil_id EQ KOMPLE_TICARI_PAKET_PROGRAM ) {
        program_icerigi = "K9 çok detaylı bir Ticari Paket Program ' dır. Orta büyüklükteki bir işletmenin tüm ihtiyaçlarına cevap verebilecek şekilde tasarlandı.\n\n"
                          "16 Modülü birbiri ile entegre çalışır. Bir çok işletme 8-10 modüle ihityaç duyar. "
                          "Kullanılmayan modülleri kapatarak K9 ' u sizin istediğiniz şekle sokmak hiç te zor değildir.\n\n"
                          "";
    }
...
/**************************************************************************************
                   K9_PROFIL_SECME::K9_KULLANICI_STRUCT_GUNCELLE
***************************************************************************************/

void K9_PROFIL_SECME::K9_KULLANICI_STRUCT_GUNCELLE()
{
...
/**************************************************************************************
                   K9_PROFIL_SECME::K9_PROFIL_BILGILERINI_DB_YAZ
***************************************************************************************/

void K9_PROFIL_SECME::K9_PROFIL_BILGILERINI_DB_YAZ()
{
