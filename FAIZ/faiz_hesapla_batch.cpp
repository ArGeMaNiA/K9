...
void FAIZ_HESAPLA_BATCH::SETUP_FORM()
{
    ...
    SET_ICON_OF_BATCH_BUTTON(":/k9_icons/K9_ICONS/yazdir_ikonu.png");    
...
double FAIZ_HESAPLA_BATCH::FAIZ_ORANINI_BUL()
{
   ...
   if( m_faiz_hesaplama_sekli EQ AYLIK_FAIZ )
    ...
    double yillik_faiz_orani;
    yillik_faiz_orani = pow( tahmini_faiz_orani ,12);
...
/**************************************************************************************
                   FAIZ_HESAPLA_BATCH::SHOW_REKLAM
***************************************************************************************/

void FAIZ_HESAPLA_BATCH::SHOW_REKLAM()
{
       m_ui->reklamViewer->SHOW_REKLAM("FAIZ_HESAPLA_BATCH");
}
