#include <QMessageBox>
#include "k9_eft_batch_class.h"
#include "ui_k9_eft_batch.h"
#include "cari_enum.h"
                        ...
                        K9_ISLEM_DETAYLARI * P_ISLEM_DETAYLARI,int p_modul_id,QWidget * parent )
{
    ...
    K9_EFT_BATCH * F = new K9_EFT_BATCH ( p_fis_turu , p_islem_turu , p_fis_satiri_id ,
...
/**************************************************************************************
                   K9_EFT_BATCH::K9_EFT_BATCH
***************************************************************************************/

K9_EFT_BATCH::K9_EFT_BATCH ( int fis_turu , int islem_turu ,int fis_satiri_id ,
                                 int makbuz_para_birimi_id, K9_ISLEM_DETAYLARI * P_ISLEM_DETAYLARI ,int p_modul_id,
                                 QWidget * parent ) :  BATCH_KERNEL ( parent ), m_ui ( new Ui::K9_EFT_BATCH )
{
    m_fis_turu              = fis_turu;
...
/**************************************************************************************
                   K9_EFT_BATCH::SETUP_FORM
***************************************************************************************/

void K9_EFT_BATCH::SETUP_FORM()
{
    SET_PAGE_TITLE    ( tr ( "HAVALE / EFT DETAYLARI" ) );
    SET_HELP_PAGE     ( "k9-eft-havele" );
...
/**************************************************************************************
                   K9_EFT_BATCH::CHECK_VAR
***************************************************************************************/

int K9_EFT_BATCH::CHECK_VAR ( QObject * object )
{
...
/**************************************************************************************
                   K9_EFT_BATCH::CHECK_RUN
***************************************************************************************/

int K9_EFT_BATCH::CHECK_RUN ()
{
...
/**************************************************************************************
                   K9_EFT_BATCH::RUN_BATCH
***************************************************************************************/

void K9_EFT_BATCH::RUN_BATCH ()
{
