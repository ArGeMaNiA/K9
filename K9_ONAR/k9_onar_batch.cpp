#include <QMessageBox>
#include "k9_onar_batch_class.h"
#include "ui_k9_onar_batch.h"
#include "k9_enum.h"
...
void OPEN_K9_ONAR_BATCH (QWidget * parent)
{
    K9_ONAR_BATCH * k9_onar = new K9_ONAR_BATCH(parent);
    k9_onar->EXEC( NOT_FULL_SCREEN );
}

/**************************************************/
/*  K9_ONAR_BATCH::K9_ONAR_BATCH                  */
/**************************************************/

K9_ONAR_BATCH::K9_ONAR_BATCH(QWidget *parent) :  BATCH_KERNEL (parent), m_ui(new Ui::K9_ONAR_BATCH)
{
    m_ui->setupUi     (this);
...
{    
    ...
    m_ui->reklamViewer->SHOW_REKLAM( "K9-ONAR" );
...
/*****************************************************/
/*         K9_ONAR_BATCH::CHECK_VAR                  */
/*****************************************************/

int K9_ONAR_BATCH::CHECK_VAR(QObject * object)
{
...
/*****************************************************/
/*          K9_ONAR_BATCH::CHECK_EXIT               */
/*****************************************************/

int K9_ONAR_BATCH::CHECK_EXIT()
{
    return ADAK_OK;
}

/*****************************************************/
/*          K9_ONAR_BATCH::BILGILENDIR               */
/*****************************************************/

void K9_ONAR_BATCH::BILGILENDIR (QString mesaj)
{
