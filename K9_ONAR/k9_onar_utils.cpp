...
void CARI_ENT_FISLERINI_OLUSTUR(int p_program_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    while ( f_query.NEXT() ) {
        ...
        MUH_FIS->kaydedilecek_sirket         = CARI_FIS->kaydedilecek_sirket;
            ...
            default                          :
                {
                    if ( bordro_turu NE ENUM_CEK_SENET_ACILIS_BORDROSU ) {
                        ...
                        MUHASEBE_FISI->kaydedilecek_sirket = CEK_BORDROSU->kaydedilecek_sirket;
...
void FAT_ENT_FISLERINI_OLUSTUR(int p_program_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    while ( f_query.NEXT() ) {
        ...
        MUHASEBE_FISI->kaydedilecek_sirket   = FATURA->kaydedilecek_sirket;
...
void PRK_ENT_FISLERINI_OLUSTUR(int p_program_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    while ( f_query.NEXT() ) {
        ...
        MUHASEBE_FISI->kaydedilecek_sirket       = PRK_FISI->kaydedilecek_sirket;
...
void    BNK_ENT_FISLERINI_OLUSTUR( int p_program_id , ADAK_SQL * P_GELEN_DB )
{
        ...
        while ( query.NEXT() EQ true ) {
               ...
               if ( s_query.SELECT() NE 0 ) {
                   while ( s_query.NEXT() EQ true ) {
                        ...
                        if ( HRK_FIS->kaydedilecek_sirket NE HRK_FIS_SATIRI->kaydedilecek_sirket ) {
                            update_query.PREPARE_UPDATE("bnk_hareket_fis_satirlari" , "fis_satiri_id",
                                                        "kaydedilecek_sirket" , "fis_id = :fis_id");
                            update_query.SET_VALUE(":kaydedilecek_sirket" , HRK_FIS->kaydedilecek_sirket);
                            update_query.SET_VALUE(":fis_id"              , HRK_FIS_SATIRI->fis_id);
    ...
    if ( query.SELECT() NE 0 ) {
        ...
        while ( query.NEXT() EQ true ) {
            ...
            int     kaydedilecek_sirket    = query.VALUE( 4 ).toInt();
            int     fis_no              = query.VALUE( 5 ).toInt();
            ...
            M_FIS->fis_no           = fis_no;
            M_FIS->def_fis_id       = 0;
            M_FIS->program_id       = K9_PROGRAMI;
            M_FIS->modul_id         = BANKA_MODULU;
            M_FIS->base_fis_id      = 0;
            M_FIS->hesap_no_id      = hesap_no_id;
            M_FIS->kaydedilecek_sirket = kaydedilecek_sirket;
            ...
            if ( s_query.SELECT() NE 0 ) {
                ...
                while ( s_query.NEXT() EQ true ) {
                     ...
                     M_FIS_SATIRI->kaydedilecek_sirket         = kaydedilecek_sirket;
    ...
    query.PREPARE_SELECT( "bnk_virman_fisler, bnk_virman_fis_satirlari",
                          ...
                          "bnk_virman_fisler.kaydedilecek_sirket, gonderen_hesap_no_id, alici_hesap_no_id, doviz_kuru, "
    ...
    if ( query.SELECT() NE 0 ) {
        ...
        while ( query.NEXT() EQ true ) {
            ...
            VIRMAN_STRUCT->kaydedilecek_sirket                   = query.VALUE( 5 ).toInt();
...
void STK_ENT_FISLERINI_OLUSTUR ( int p_program_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT( "stk_fisler, stk_fis_satirlari ",
                          ...
                          "stk_fisler.aciklama,                "
                          "irsaliye_tutari,                    "
                          "stk_fisler.kaydedilecek_sirket,        "
                          "stk_fisler.fis_turu,                "
    ...
    if ( query.SELECT() NE 0 ) {
        ...
        while ( query.NEXT() EQ true ) {
            ...
            if ( fis_turu EQ ENUM_STK_SARF_FIRE_FISI ) {
                ...
                STK_FIS->kaydedilecek_sirket        = query.VALUE( "kaydedilecek_sirket").toInt();
                STK_FIS->modul_id                   = STOK_MODULU;
                STK_FIS->program_id                 = K9_PROGRAMI;
                ...
                STK_FIS_SATIRI->kaydedilecek_sirket = STK_FIS->kaydedilecek_sirket;
                ...
                STK_FIS_SATIRI->program_id          = K9_PROGRAMI;
...
void SM_MAKBUZ_ENT_FISLERINI_OLUSTUR(int p_program_id, ADAK_SQL *P_GELEN_DB)
{
    ...
    while ( f_query.NEXT() ) {
        ...
        MUHASEBE_FISI->kaydedilecek_sirket       = SM_MAKBUZU->kaydedilecek_sirket;
...
void MUHASEBE_MODULUNU_ONAR(ADAK_SQL * P_GELEN_DB )
{
    ...
    while ( query.NEXT() EQ true ) {
        ...
        while ( select_query.NEXT() EQ true ) {
            ...
            int kaydedilecek_sirket = select_query.VALUE(4).toInt();
            ...
            MUH_HESABININ_BAKIYELERINI_ARTTIR( hesap_id, gun_no, borc_tutari, alacak_tutari, kaydedilecek_sirket, USE_DB );
...
void CARI_MODULUNU_ONAR( ADAK_SQL * P_GELEN_DB )
{
    ...
    while (select_query.NEXT()) {
        ...
        select_query_satirlar.PREPARE_SELECT("car_fis_satirlari",
                                             ...
                                             "temel_para_birimi_tutari,cari_para_birimi_tutari, "
                                             "kaydedilecek_sirket ",
                                             "fis_id = :fis_id");
        ...
        while (select_query_satirlar.NEXT()) {
            ...
            temel_para_birimi_tutari = ROUND( select_query_satirlar.VALUE(4).toDouble() );
            cari_para_birimi_tutari  = ROUND( select_query_satirlar.VALUE(5).toDouble() );
            int kaydedilecek_sirket     = select_query_satirlar.VALUE(6).toInt();
            ...
            switch (fis_turu) {
                ...
                gun_no = MALI_YIL_ARRAY_INDIS( fis_tarihi );
                    ...
                    if ( borc_tutari > alacak_tutari ) {
                        CARI_HESABIN_BAKIYESINI_ARTTIR(gun_no,line_cari_hesap_id,
                                                       cari_para_birimi_tutari,0.0, kaydedilecek_sirket ,USE_DB);
                        fis_toplam_borc += borc_tutari;
                    }
                    else {
                        CARI_HESABIN_BAKIYESINI_ARTTIR(gun_no,line_cari_hesap_id,
                                                       0.0 ,cari_para_birimi_tutari, kaydedilecek_sirket ,USE_DB);
                ...
                default :
                    ...
                    if ( borc_tutari > alacak_tutari ) {
                        CARI_HESABIN_BAKIYESINI_ARTTIR(gun_no,cari_hesap_id,
                                                       cari_para_birimi_tutari,0.0, kaydedilecek_sirket ,USE_DB);
                        fis_toplam_borc += borc_tutari;
                    }
                    else {
...
void BANKA_MODULUNU_ONAR( ADAK_SQL * P_GELEN_DB )
{
    ...
    while (select_query.NEXT()) {
        ...
        select_fis_satirlari.PREPARE_SELECT("bnk_defter_fis_satirlari",
                                            ...
                                            "hesaptan_cikan,      "
                                            "hesap_turu,kaydedilecek_sirket      ",
                                            "fis_id = :fis_id");
        ...
        while (select_fis_satirlari.NEXT()) {
            ...
            int kaydedilecek_sirket     = select_fis_satirlari.VALUE(4).toInt();
            ...
            if ( etkilenecek_hesap_turu EQ ENUM_BNK_POS_HESABI ) {
                BANKA_HESAP_BAKIYELERINI_ARTTIR(gun_no,hesap_no_id,hesaba_giren,hesaptan_cikan,ENUM_BNK_POS_HESABI, kaydedilecek_sirket ,USE_DB);
                continue;
            }
            else if ( etkilenecek_hesap_turu EQ ENUM_BNK_KREDI_KARTI_HESABI ) {
                BANKA_HESAP_BAKIYELERINI_ARTTIR(gun_no,hesap_no_id,hesaba_giren,hesaptan_cikan,ENUM_BNK_KREDI_KARTI_HESABI, kaydedilecek_sirket ,USE_DB);
                continue;
            }
            else if ( etkilenecek_hesap_turu EQ ENUM_BNK_BANKA_HESABI ) {
                if ( fis_turu EQ ENUM_BANKA_ACILIS_FISI) {
                    BANKA_HESAP_BAKIYELERINI_ARTTIR(gun_no,hesap_no_id,hesaba_giren,hesaptan_cikan,ENUM_BNK_BANKA_HESABI, kaydedilecek_sirket ,USE_DB);
                }
                else {
                    BANKA_HESAP_BAKIYELERINI_ARTTIR(gun_no,hesap_no_id,hesaba_giren,hesaptan_cikan,ENUM_BNK_BANKA_HESABI, kaydedilecek_sirket ,USE_DB);
                }
...
void STOK_MODULUNU_ONAR( ADAK_SQL * P_GELEN_DB )
{
    ...
    while (select_query.NEXT()) {
        ...
        select_fis_satirlari.PREPARE_SELECT("stk_fis_satirlari",
                                            ...
                                            "parti_id , temel_birim_katsayisi,kaydedilecek_sirket  ",
                                            "fis_id = :fis_id" );
        ...
        while ( select_fis_satirlari.NEXT() ) {
            ...
            if ( fis_turu NE ENUM_STK_DEPO_TRANSFER_CIKIS AND fis_turu NE ENUM_STK_DEPO_TRANSFER_GIRIS ) {
                STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR(urun_id,gun_no,stoga_giren_miktar,stoktan_cikan_miktar, kaydedilecek_sirket,USE_DB);
            }

            STK_DEPODAKI_STOK_MIKTARINI_ARTIR       (depo_id,urun_id,gun_no,stoga_giren_miktar,stoktan_cikan_miktar, kaydedilecek_sirket,USE_DB );
            ...
            STK_PARTIDEKI_URUN_MIKTARINI_ARTIR(depo_id,urun_id,gun_no,parti_kodu,stoga_giren_miktar,stoktan_cikan_miktar, kaydedilecek_sirket ,"","",USE_DB);
...
void ISLETME_MODULUNU_ONAR(ADAK_SQL * P_GELEN_DB)
{
    ...
    while ( query.NEXT() ) {
        ...
        if ( s_query.SELECT() NE 0 ) {
            ...
            while ( s_query.NEXT() ) {
                ...
                if (s_query.VALUE("program_id").toInt() EQ 0 ) {
                    t_query.SET_VALUE(":program_id", K9_PROGRAMI);
                }
                else {
        ...
        if (query.VALUE(2).toInt() EQ 0) {
            update_query.SET_VALUE(":program_id", K9_PROGRAMI);
        }
        else {
...
void MUHASEBE_BAKIYELERINI_SIFIRLA()
{
    ...
    while ( select_query.NEXT()  EQ true ) {
        ...
        update_query.PREPARE_UPDATE("muh_hesaplar",
                                    ...
                                    "toplam_borc_array ,"
                                    "toplam_alacak_array  ,"
                                    "ent_borc_array  , ent_alacak_array ,"
                                    "ent_olmayan_borc_array , "
                                    "ent_olmayan_alacak_array  ",
                                    "hesap_id = :hesap_id");

        update_query.SET_VALUE(":toplam_borc_array"        , PACK_DOUBLE_ARRAY(borc_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":toplam_alacak_array"      , PACK_DOUBLE_ARRAY(alacak_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":ent_borc_array"           , PACK_DOUBLE_ARRAY(borc_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":ent_alacak_array"         , PACK_DOUBLE_ARRAY(alacak_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":ent_olmayan_borc_array"   , PACK_DOUBLE_ARRAY(borc_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":ent_olmayan_alacak_array" , PACK_DOUBLE_ARRAY(alacak_bakiyesi , K9_ARRAY_SIZE));
        update_query.SET_VALUE(":hesap_id"                 , hesap_id);
        update_query.UPDATE();
    }
...
void CARI_BAKIYELERINI_SIFIRLA()
{
    ...
    while (select_query.NEXT()) {
        ...
        query.SET_VALUE(":toplam_borc_array"         , PACK_DOUBLE_ARRAY(toplam_borc   , K9_ARRAY_SIZE));
        query.SET_VALUE(":toplam_alacak_array"       , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        query.SET_VALUE(":ent_borc_array"            , PACK_DOUBLE_ARRAY(toplam_borc   , K9_ARRAY_SIZE));
        query.SET_VALUE(":ent_alacak_array"          , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        query.SET_VALUE(":ent_olmayan_borc_array"    , PACK_DOUBLE_ARRAY(toplam_borc   , K9_ARRAY_SIZE));
        query.SET_VALUE(":ent_olmayan_alacak_array"  , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
...
void BANKA_BAKIYELERINI_SIFIRLA()
{
    ...
    while (select_query.NEXT()) {
        ...
        QString sql_query = QString ("toplam_borc_array         ,"
                                     "toplam_alacak_array       ,"
                                     "ent_borc_array            ,"
                                     "ent_alacak_array          ,"
                                     "ent_olmayan_borc_array    ,"
        ...
        update_query.SET_VALUE     ( ":toplam_borc_array"           , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":toplam_alacak_array"         , PACK_DOUBLE_ARRAY(toplam_alacak, K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_borc_array"              , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_alacak_array"            , PACK_DOUBLE_ARRAY(toplam_alacak, K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olmayan_borc_array"      , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olmayan_alacak_array"    , PACK_DOUBLE_ARRAY(toplam_alacak, K9_ARRAY_SIZE));
        ...
        sql_query = QString("toplam_kk_tahsilat_borc_array ,"
                            ...
                            "ent_kk_tahsilat_borc_array    ,"
                            "ent_kk_tahsilat_alacak_array  ,"
                            "ent_olm_kk_tahsilat_borc_array,"
                            "ent_olm_kk_thslat_alacak_array ");
        ...
        update_query.SET_VALUE     ( ":toplam_kk_tahsilat_borc_array"   , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":toplam_kk_thslat_alacak_array"   , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_kk_tahsilat_borc_array"      , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_kk_tahsilat_alacak_array"    , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olm_kk_tahsilat_borc_array"  , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olm_kk_thslat_alacak_array"  , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":hesap_no_id"                 , hesap_no_id);
       ...
       sql_query = QString(" toplam_kk_odeme_borc_array     ,"
                           ...
                           " ent_kk_odeme_borc_array        ,"
                           " ent_kk_odeme_alacak_array      ,"
                           " ent_olm_kk_odeme_borc_array    ,"
                           " ent_olm_kk_odeme_alacak_array   ");

        where_condition = QString( "hesap_no_id = :hesap_no_id" );

        update_query.PREPARE_UPDATE( "bnk_kk_arrayler", "kayit_id", sql_query, where_condition );

        update_query.SET_VALUE     ( ":toplam_kk_odeme_borc_array"       , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":toplam_kk_odeme_alacak_array"     , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_kk_odeme_borc_array"          , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_kk_odeme_alacak_array"        , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olm_kk_odeme_borc_array"      , PACK_DOUBLE_ARRAY(toplam_borc,K9_ARRAY_SIZE));
        update_query.SET_VALUE     ( ":ent_olm_kk_odeme_alacak_array"    , PACK_DOUBLE_ARRAY(toplam_alacak , K9_ARRAY_SIZE));
...
void STOK_BAKIYELERINI_SIFIRLA ()
{
    ...
    double stok_giris_miktari[K9_ARRAY_SIZE];
    double stok_cikis_miktari[K9_ARRAY_SIZE];
    ...
    while (select_query.NEXT()) {
        ...
        QString sql_query = QString ("ent_olmayan_stoga_giren_array , "
                                     "ent_stoga_giren_array         , "
                                     "toplam_stoga_giren_array        ");

        update_query.PREPARE_UPDATE( "stk_urunler", "urun_id", sql_query, "urun_id = :urun_id");

        update_query.SET_VALUE     ( ":ent_olmayan_stoga_giren_array"   , PACK_DOUBLE_ARRAY(stok_giris_miktari , K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":ent_stoga_giren_array"           , PACK_DOUBLE_ARRAY(stok_giris_miktari , K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":toplam_stoga_giren_array"        , PACK_DOUBLE_ARRAY(stok_giris_miktari , K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":urun_id"                         , urun_id );

        update_query.UPDATE();

        sql_query = QString ("ent_olmayan_stktan_cikan_array ,"
                             "ent_stoktan_cikan_array        ,"
                             "toplam_stoktan_cikan_array      " );

        update_query.PREPARE_UPDATE( "stk_urunler", "urun_id", sql_query, "urun_id = :urun_id");

        update_query.SET_VALUE     ( ":ent_olmayan_stktan_cikan_array"  , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":ent_stoktan_cikan_array"         , PACK_DOUBLE_ARRAY(stok_giris_miktari , K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":toplam_stoktan_cikan_array"      , PACK_DOUBLE_ARRAY(stok_giris_miktari , K9_ARRAY_SIZE) );
        update_query.SET_VALUE     ( ":urun_id"                         , urun_id );
    ...
    if ( select_query.SELECT() NE 0 ) {
        ...
        while (select_query.NEXT()) {
            ...
            QString sql_query = QString("ent_olmayan_depoya_giren_array ,"
            ...
            update_query.SET_VALUE     ( ":ent_olmayan_depoya_giren_array"  , PACK_DOUBLE_ARRAY(stok_giris_miktari, K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_depoya_giren_array"          , PACK_DOUBLE_ARRAY(stok_giris_miktari, K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":toplam_depoya_giren_array"       , PACK_DOUBLE_ARRAY(stok_giris_miktari, K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_olmayan_depo_cikan_array"    , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_depodan_cikan_array"         , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":toplam_depodan_cikan_array"      , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
    ...
    if ( select_query.SELECT() NE 0 ) {
        ...
        while (select_query.NEXT()) {
            ...
            QString sql_query = QString("ent_olm_partiye_giren_array    , "
            ...
            update_query.SET_VALUE     ( ":ent_olm_partiye_giren_array"  , PACK_DOUBLE_ARRAY(stok_giris_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_partiye_giren_array"      , PACK_DOUBLE_ARRAY(stok_giris_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":toplam_partiye_giren_array"   , PACK_DOUBLE_ARRAY(stok_giris_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_olm_partiden_cikan_array" , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":ent_partiden_cikan_array"     , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
            update_query.SET_VALUE     ( ":toplam_partiden_cikan_array"  , PACK_DOUBLE_ARRAY(stok_cikis_miktari,K9_ARRAY_SIZE) );
...
void  CEK_SENETIN_YANLIS_URETTIGI_FISLERI_SIL()
{
    ...
    f_query.SET_VALUE       ( ":program_id", K9_PROGRAMI       );
