...
enum LOG_TURLERI {
    LOG_K9_YETKILENDIRME            = 1,
    LOG_K9_ONAR                     = 2,
    LOG_K9_DEVIR                    = 3,
    LOG_K9_SABIT_DEGERLER           = 4,
    LOG_K9_KDV_OTV_ORANLARI         = 5,
...
void        K9_LOG_KAYDI_EKLE                           ( int modul_id ,int log_turu , int log_islemi , QString log_detaylari);

QString     K9_GET_LOG_TURLERI_STRING                   ( int p_log_turu_enum );

int         K9_GET_LOG_TURLERI_ENUM                     ( QString log_turu );
