...
struct K9_KULLANICI_YETKILERI_STRUCT {
    ...
    int        ynt_k9_yetkilendirme_yapabilir_mi;
    int        ynt_k9_devir_islemi_yapabilir_mi;
    int        ynt_k9_log_inceleme_yetkisi;
    int        ynt_k9_sabit_degerler_guncelleme_yetkisi;
    int        ynt_k9_belge_tasarlama_yetkisi;
    int        ynt_k9_ent_bilgilerini_degistirme_yetkisi;
    int        ynt_k9_kullanicinin_calistigi_sirket;
    int        ynt_k9_kullanici_sirket_degistire_bilir_mi;
    int        ynt_k9_onar_yetkisi;
    int        ynt_k9_email_log_inceleme_yetkisi;
    int        ynt_k9_urettigi_fisleri_grbilir_mi;

    int        k9_muh_kullanabilir_mi;
    int        k9_isl_kullanabilir_mi;
    int        k9_adr_kullanabilir_mi;
    int        k9_dvz_kullanabilir_mi;
    int        k9_car_kullanabilir_mi;
    int        k9_cek_kullanabilir_mi;
    int        k9_bnk_kullanabilir_mi;
    int        k9_sub_kullanabilir_mi;
    int        k9_fat_kullanabilir_mi;
    int        k9_irs_kullanabilir_mi;
    int        k9_stk_kullanabilir_mi;
    int        k9_prs_kullanabilir_mi;
    int        k9_dmr_kullanabilir_mi;
    int        k9_faiz_kullanabilir_mi;
    int        k9_prk_kullanabilir_mi;
    int        k9_smm_kullanabilir_mi;
