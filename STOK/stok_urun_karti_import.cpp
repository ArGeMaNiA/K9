...
void STOK_URUN_KARTI_IMPORT::IMPORT_ROW( QStringList p_row_data )
{
    ...
    if( m_fis_id EQ -1 ){
        ...
        STOK_FIS->program_id    = K9_PROGRAMI ;
        ...
        STOK_FIS->kaydedilecek_sirket = SIRKET_1;
    ...
    STOK_FIS_SATIRI.kaydedilecek_sirket    = SIRKET_1 ;
    STOK_FIS_SATIRI.modul_id               = STOK_MODULU ;
    STOK_FIS_SATIRI.program_id             = K9_PROGRAMI ;
    ...
    GRP_KAYDI_GRUPLARA_EKLE( K9_PROGRAMI, STOK_MODULU, urun_id, GET_GRUP_IDLERI() );
