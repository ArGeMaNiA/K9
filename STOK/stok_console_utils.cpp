...
double STK_DEPODAKI_URUN_MIKTARINI_BUL ( int p_depo_id, int p_urun_id, int p_entegrasyon_filtresi )
{

    double ENT_OLMAYAN_DEPOYA_GIREN_ARRAY   [ K9_ARRAY_SIZE ];
    double ENT_OLMAYAN_DEPODAN_CIKAN_ARRAY  [ K9_ARRAY_SIZE ];
    double ENT_DEPOYA_GIREN_ARRAY           [ K9_ARRAY_SIZE ];
    double ENT_DEPODAN_CIKAN_ARRAY          [ K9_ARRAY_SIZE ];
    double TOPLAM_DEPOYA_GIREN_ARRAY        [ K9_ARRAY_SIZE ];
    double TOPLAM_DEPODAN_CIKAN_ARRAY       [ K9_ARRAY_SIZE ];
    ...
    QString ent_olmayan_depoya_giren_array      = sql_query.VALUE(0).toString();
    QString ent_olmayan_depo_cikan_array     = sql_query.VALUE(1).toString();
    QString ent_depoya_giren_array              = sql_query.VALUE(2).toString();
    QString ent_depodan_cikan_array             = sql_query.VALUE(3).toString();
    ...
    UNPACK_DOUBLE_ARRAY ( ent_olmayan_depoya_giren_array,     ENT_OLMAYAN_DEPOYA_GIREN_ARRAY,     K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_olmayan_depo_cikan_array,       ENT_OLMAYAN_DEPODAN_CIKAN_ARRAY,    K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_depoya_giren_array,             ENT_DEPOYA_GIREN_ARRAY,             K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_depodan_cikan_array,            ENT_DEPODAN_CIKAN_ARRAY,            K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_depoya_giren_array,          TOPLAM_DEPOYA_GIREN_ARRAY,          K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_depodan_cikan_array,         TOPLAM_DEPODAN_CIKAN_ARRAY,         K9_ARRAY_SIZE );


    if ( p_entegrasyon_filtresi EQ FIS_BIRINCI_SIRKET ) {
        return ROUND ( ENT_DEPOYA_GIREN_ARRAY [K9_SON_BAKIYE] - ENT_DEPODAN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
    else if ( p_entegrasyon_filtresi EQ FIS_IKINCI_SIRKET ) {
        return ROUND ( ENT_OLMAYAN_DEPOYA_GIREN_ARRAY [K9_SON_BAKIYE] - ENT_OLMAYAN_DEPODAN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
    else {
        return ROUND ( TOPLAM_DEPOYA_GIREN_ARRAY [K9_SON_BAKIYE] - TOPLAM_DEPODAN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
}
...
double STK_PARTIDEKI_URUN_MIKTARINI_BUL ( int p_parti_id, int p_entegrasyon_filtresi )
{
    double ENT_OLMAYAN_PARTIYE_GIREN_ARRAY          [ K9_ARRAY_SIZE ];
    double ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY         [ K9_ARRAY_SIZE ];
    double ENT_PARTIYE_GIREN_ARRAY                  [ K9_ARRAY_SIZE ];
    double ENT_PARTIDEN_CIKAN_ARRAY                 [ K9_ARRAY_SIZE ];
    double TOPLAM_PARTIYE_GIREN_ARRAY               [ K9_ARRAY_SIZE ];
    double TOPLAM_PARTIDEN_CIKAN_ARRAY              [ K9_ARRAY_SIZE ];
    ...
    QString ent_olmayan_prtye_giren_array     = query.VALUE(0).toString();
    QString ent_olmayan_prtden_cikan_array    = query.VALUE(1).toString();
    QString ent_partiye_giren_array             = query.VALUE(2).toString();
    QString ent_partiden_cikan_array            = query.VALUE(3).toString();
    QString toplam_partiye_giren_array          = query.VALUE(4).toString();
    QString toplam_partiden_cikan_array         = query.VALUE(5).toString();



    UNPACK_DOUBLE_ARRAY ( ent_olmayan_prtye_giren_array,  ENT_OLMAYAN_PARTIYE_GIREN_ARRAY,    K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_olmayan_prtden_cikan_array, ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY,   K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_partiye_giren_array,          ENT_PARTIYE_GIREN_ARRAY,            K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_partiden_cikan_array,         ENT_PARTIDEN_CIKAN_ARRAY,           K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_partiye_giren_array,       TOPLAM_PARTIYE_GIREN_ARRAY,         K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_partiden_cikan_array,      TOPLAM_PARTIDEN_CIKAN_ARRAY,        K9_ARRAY_SIZE );

    if ( p_entegrasyon_filtresi EQ FIS_IKINCI_SIRKET ) {
        return ROUND ( ENT_OLMAYAN_PARTIYE_GIREN_ARRAY [K9_SON_BAKIYE] - ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
    else if ( p_entegrasyon_filtresi EQ FIS_BIRINCI_SIRKET ) {
        return ROUND ( ENT_PARTIYE_GIREN_ARRAY[K9_SON_BAKIYE] - ENT_PARTIDEN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
    else {
        return ROUND ( TOPLAM_PARTIYE_GIREN_ARRAY[K9_SON_BAKIYE] - TOPLAM_PARTIDEN_CIKAN_ARRAY[K9_SON_BAKIYE] );
    }
}
...
void STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR ( int p_urun_id, int p_gun_no, double p_stoga_giren_miktar, double p_stoktan_cikan_miktar,
                                               int p_kaydedilecek_sirket ,ADAK_SQL * P_GELEN_DB )
{
    ...
    double ENT_OLMAYAN_STOK_GIRIS_ARRAY     [ K9_ARRAY_SIZE ];
    double ENT_OLMAYAN_STOK_CIKIS_ARRAY     [ K9_ARRAY_SIZE ];

    double ENT_STOK_GIRIS_ARRAY             [ K9_ARRAY_SIZE ];
    double ENT_STOK_CIKIS_ARRAY             [ K9_ARRAY_SIZE ];

    double TOPLAM_STOK_GIRIS_ARRAY          [ K9_ARRAY_SIZE ];
    double TOPLAM_STOK_CIKIS_ARRAY          [ K9_ARRAY_SIZE ];

    SQL_QUERY query ( USE_DB );

    query.PREPARE_SELECT ( "stk_urunler",
                           "ent_olmayan_stoga_giren_array, ent_olmayan_stktan_cikan_array, "
                           "ent_stoga_giren_array, ent_stoktan_cikan_array, "
    ...
    QString ent_olmayan_stoga_giren_array        = query.VALUE ( 0 ).toString();
    QString ent_olmayan_stktan_cikan_array      = query.VALUE ( 1 ).toString();
    QString ent_stoga_giren_array                = query.VALUE ( 2 ).toString();
    QString ent_stoktan_cikan_array              = query.VALUE ( 3 ).toString();
    QString toplam_stoga_giren_array             = query.VALUE ( 4 ).toString();
    QString toplam_stoktan_cikan_array           = query.VALUE ( 5 ).toString();


    UNPACK_DOUBLE_ARRAY ( ent_olmayan_stoga_giren_array,            ENT_OLMAYAN_STOK_GIRIS_ARRAY,  K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_olmayan_stktan_cikan_array,          ENT_OLMAYAN_STOK_CIKIS_ARRAY,  K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_stoga_giren_array,                    ENT_STOK_GIRIS_ARRAY,          K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_stoktan_cikan_array,                  ENT_STOK_CIKIS_ARRAY,          K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_stoga_giren_array,                 TOPLAM_STOK_GIRIS_ARRAY,       K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_stoktan_cikan_array,               TOPLAM_STOK_CIKIS_ARRAY,       K9_ARRAY_SIZE );


    for ( int i = p_gun_no ; i < K9_ARRAY_SIZE ; i++ ) {
        if ( p_stoga_giren_miktar NE 0.00 ) {
            TOPLAM_STOK_GIRIS_ARRAY[i]     = ROUND ( TOPLAM_STOK_GIRIS_ARRAY[i] + p_stoga_giren_miktar );
            if ( p_kaydedilecek_sirket EQ SIRKET_1 ) {
                ENT_STOK_GIRIS_ARRAY[i]     = ROUND ( ENT_STOK_GIRIS_ARRAY[i] + p_stoga_giren_miktar );
            }
            else {
                ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] + p_stoga_giren_miktar );
            }
        }
        if ( p_stoktan_cikan_miktar NE 0.00 ) {
               TOPLAM_STOK_CIKIS_ARRAY[i] = ROUND ( TOPLAM_STOK_CIKIS_ARRAY[i] + p_stoktan_cikan_miktar );
            if ( p_kaydedilecek_sirket EQ SIRKET_1 ) {
               ENT_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_STOK_CIKIS_ARRAY[i] + p_stoktan_cikan_miktar );
            }
            else {
                ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] + p_stoktan_cikan_miktar );
            }
        }
    }

    ent_olmayan_stoga_giren_array       = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_STOK_GIRIS_ARRAY,     K9_ARRAY_SIZE );
    ent_olmayan_stktan_cikan_array     = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_STOK_CIKIS_ARRAY,     K9_ARRAY_SIZE );
    ent_stoga_giren_array               = PACK_DOUBLE_ARRAY ( ENT_STOK_GIRIS_ARRAY,             K9_ARRAY_SIZE );
    ent_stoktan_cikan_array             = PACK_DOUBLE_ARRAY ( ENT_STOK_CIKIS_ARRAY,             K9_ARRAY_SIZE );
    toplam_stoga_giren_array            = PACK_DOUBLE_ARRAY ( TOPLAM_STOK_GIRIS_ARRAY,          K9_ARRAY_SIZE );
    toplam_stoktan_cikan_array          = PACK_DOUBLE_ARRAY ( TOPLAM_STOK_CIKIS_ARRAY,          K9_ARRAY_SIZE );



    query.PREPARE_UPDATE ( "stk_urunler ", "urun_id",
                           "ent_olmayan_stoga_giren_array        , "
                           "ent_olmayan_stktan_cikan_array       , "
                           "ent_stoga_giren_array                , "
                           "ent_stoktan_cikan_array              , "
                           "toplam_stoga_giren_array             , "
                           "toplam_stoktan_cikan_array             ",
                           "urun_id   = :urun_id" );

    query.SET_VALUE ( ":ent_olmayan_stoga_giren_array",     ent_olmayan_stoga_giren_array       );
    query.SET_VALUE ( ":ent_olmayan_stktan_cikan_array",   ent_olmayan_stktan_cikan_array     );
    query.SET_VALUE ( ":ent_stoga_giren_array",             ent_stoga_giren_array               );
    query.SET_VALUE ( ":ent_stoktan_cikan_array",           ent_stoktan_cikan_array             );
...
void STK_URUN_KARTINDAKI_STOK_MIKTARINI_AZALT ( int p_urun_id, int p_gun_no, double p_stoga_giren_miktar, double p_stoktan_cikan_miktar, int p_kaydedilecek_sirket )
{
    if ( p_urun_id < 1 ) {
        return;
    }
    ...
    query.PREPARE_SELECT ( "stk_urunler","ent_olmayan_stoga_giren_array, ent_olmayan_stktan_cikan_array, "
                           "ent_stoga_giren_array, ent_stoktan_cikan_array, "
                           "toplam_stoga_giren_array, toplam_stoktan_cikan_array ",
                           "urun_id = :urun_id" );
...
void STK_DEPODAKI_STOK_MIKTARINI_ARTIR ( int p_depo_id, int p_urun_id, int p_gun_no, double p_depoya_giren_miktar,
                                        double p_depodan_cikan_miktar, int kaydedilecek_sirket , ADAK_SQL * P_GELEN_DB )
{
    ADAK_SQL * USE_DB;
    ...
    QString ent_olmayan_depoya_giren_array          = query.VALUE ( 0 ).toString();
    QString ent_olmayan_depo_cikan_array         = query.VALUE ( 1 ).toString();
    QString ent_depoya_giren_array                  = query.VALUE ( 2 ).toString();
    QString ent_depodan_cikan_array                 = query.VALUE ( 3 ).toString();
    QString toplam_depoya_giren_array               = query.VALUE ( 4 ).toString();
    QString toplam_depodan_cikan_array              = query.VALUE ( 5 ).toString();



    UNPACK_DOUBLE_ARRAY ( ent_olmayan_depoya_giren_array,       ENT_OLMAYAN_STOK_GIRIS_ARRAY,    K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_olmayan_depo_cikan_array,      ENT_OLMAYAN_STOK_CIKIS_ARRAY,    K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_depoya_giren_array,               ENT_STOK_GIRIS_ARRAY,            K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( ent_depodan_cikan_array,              ENT_STOK_CIKIS_ARRAY,            K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_depoya_giren_array,            TOPLAM_STOK_GIRIS_ARRAY,         K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( toplam_depodan_cikan_array,           TOPLAM_STOK_CIKIS_ARRAY,         K9_ARRAY_SIZE );


    for ( int i = p_gun_no ; i < K9_ARRAY_SIZE ; i++ ) {
        if ( p_depoya_giren_miktar NE 0.00 ) {
                TOPLAM_STOK_GIRIS_ARRAY[i]   = ROUND ( TOPLAM_STOK_GIRIS_ARRAY[i] + p_depoya_giren_miktar );
            if ( kaydedilecek_sirket EQ SIRKET_1 ){
                ENT_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_STOK_GIRIS_ARRAY[i] + p_depoya_giren_miktar );
            }
            else {
                ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] + p_depoya_giren_miktar );
            }
        }
        if ( p_depodan_cikan_miktar NE 0.00 ) {
                TOPLAM_STOK_CIKIS_ARRAY[i] = ROUND ( TOPLAM_STOK_CIKIS_ARRAY[i] + p_depodan_cikan_miktar );
            if ( kaydedilecek_sirket EQ SIRKET_1 ) {
                ENT_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_STOK_CIKIS_ARRAY[i] + p_depodan_cikan_miktar );
            }
            else {
                ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] + p_depodan_cikan_miktar );
            }
        }
    }

    ent_olmayan_depoya_giren_array     = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_STOK_GIRIS_ARRAY,     K9_ARRAY_SIZE );
    ent_olmayan_depo_cikan_array    = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_STOK_CIKIS_ARRAY,     K9_ARRAY_SIZE );
    ent_depoya_giren_array             = PACK_DOUBLE_ARRAY ( ENT_STOK_GIRIS_ARRAY,             K9_ARRAY_SIZE );
    ent_depodan_cikan_array            = PACK_DOUBLE_ARRAY ( ENT_STOK_CIKIS_ARRAY,             K9_ARRAY_SIZE );
    toplam_depoya_giren_array          = PACK_DOUBLE_ARRAY ( TOPLAM_STOK_GIRIS_ARRAY,          K9_ARRAY_SIZE );
    toplam_depodan_cikan_array         = PACK_DOUBLE_ARRAY ( TOPLAM_STOK_CIKIS_ARRAY,          K9_ARRAY_SIZE );
    ...
    query.SET_VALUE ( ":ent_olmayan_depoya_giren_array",    ent_olmayan_depoya_giren_array  );
    query.SET_VALUE ( ":ent_olmayan_depo_cikan_array",   ent_olmayan_depo_cikan_array );
    query.SET_VALUE ( ":ent_depoya_giren_array",            ent_depoya_giren_array          );
    query.SET_VALUE ( ":ent_depodan_cikan_array",           ent_depodan_cikan_array         );
...
void STK_DEPODAKI_STOK_MIKTARINI_AZALT ( int p_depo_id, int p_urun_id, int p_gun_no, double p_depoya_giren_miktar, double p_depodan_cikan_miktar, int p_kaydedilecek_sirket )
{
    if ( p_urun_id < 1 ) {
        return;
    }
    ...
    query.PREPARE_SELECT ( "stk_depodaki_urunler","ent_olmayan_depoya_giren_array, ent_olmayan_depo_cikan_array, "
                           "ent_depoya_giren_array, ent_depodan_cikan_array, "
                           "toplam_depoya_giren_array, toplam_depodan_cikan_array ",
                           "kayit_id = :kayit_id " );
...
int STK_PARTIDEKI_URUN_MIKTARINI_ARTIR ( int p_depo_id, int p_urun_id, int p_gun_no, QString p_parti_kodu,
                                         double p_giren_urun_miktari, double p_cikan_urun_miktari, int p_kaydedilecek_sirket,
                                         QString  p_uretim_tarihi, QString p_son_kul_tarihi,ADAK_SQL * P_GELEN_DB )
{
    ...
    query.PREPARE_SELECT ( "stk_urunun_partileri","ent_olm_partiye_giren_array, "
    ...
    for ( int i = p_gun_no ; i < K9_ARRAY_SIZE ; i++ ) {
        if ( p_giren_urun_miktari NE 0.00 ) {
            ...
            if ( p_kaydedilecek_sirket EQ SIRKET_1 ) {
                ENT_PARTIYE_GIREN_ARRAY[i] = ROUND ( ENT_PARTIYE_GIREN_ARRAY[i] + p_giren_urun_miktari );
            }
            else {
                ENT_OLMAYAN_PARTIYE_GIREN_ARRAY[i] = ROUND ( ENT_OLMAYAN_PARTIYE_GIREN_ARRAY[i] + p_giren_urun_miktari );
            }
        }
        if ( p_cikan_urun_miktari NE 0.00 ) {
            TOPLAM_PARTIDEN_CIKAN_ARRAY[i] = ROUND ( TOPLAM_PARTIDEN_CIKAN_ARRAY[i] + p_cikan_urun_miktari );
            if ( p_kaydedilecek_sirket EQ SIRKET_1 ) {
                ENT_PARTIDEN_CIKAN_ARRAY[i] = ROUND ( ENT_PARTIDEN_CIKAN_ARRAY[i] + p_cikan_urun_miktari );
            }
            else {
                ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY[i] = ROUND ( ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY[i] + p_cikan_urun_miktari );
            }
        }
    }

    ent_olmayan_prtye_giren_array     = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_PARTIYE_GIREN_ARRAY,      K9_ARRAY_SIZE );
    ent_olmayan_prtden_cikan_array    = PACK_DOUBLE_ARRAY ( ENT_OLMAYAN_PARTIDEN_CIKAN_ARRAY,     K9_ARRAY_SIZE );
    ent_partiye_giren_array           = PACK_DOUBLE_ARRAY ( ENT_PARTIYE_GIREN_ARRAY,              K9_ARRAY_SIZE );
    ent_partiden_cikan_array          = PACK_DOUBLE_ARRAY ( ENT_PARTIDEN_CIKAN_ARRAY,             K9_ARRAY_SIZE );
    toplam_partiye_giren_array        = PACK_DOUBLE_ARRAY ( TOPLAM_PARTIYE_GIREN_ARRAY,           K9_ARRAY_SIZE );
    toplam_partiden_cikan_array       = PACK_DOUBLE_ARRAY ( TOPLAM_PARTIDEN_CIKAN_ARRAY,          K9_ARRAY_SIZE );
    ...
    query.SET_VALUE ( ":ent_olm_partiye_giren_array",   ent_olmayan_prtye_giren_array         );
    query.SET_VALUE ( ":ent_olm_partiden_cikan_array",  ent_olmayan_prtden_cikan_array        );
    query.SET_VALUE ( ":ent_partiye_giren_array",           ent_partiye_giren_array                 );
    query.SET_VALUE ( ":ent_partiden_cikan_array",          ent_partiden_cikan_array                );
...
void STK_IRSALIYE_TARIH_DEGISIKLIGINE_GORE_STOK_GIRIS_CIKISLARINI_DUZENLE ( int p_irsaliye_id,
                                                                            ...
                                                                            int p_old_kaydedilecek_sirket,
                                                                            int p_new_kaydedilecek_sirket )
{
    ...
    if ( p_old_kaydedilecek_sirket NE p_new_kaydedilecek_sirket ) {
        entegrasyon_degisti_mi = true;
    }
    ...
    while ( sql_query.NEXT() EQ true ) {
        ...
        depo_query.PREPARE_SELECT ( "stk_depodaki_urunler",
                                    "kayit_id, ent_olmayan_depoya_giren_array,          "
                                    "ent_olmayan_depo_cikan_array,                      "
                                    "ent_depoya_giren_array, ent_depodan_cikan_array,   "
                                    "toplam_depoya_giren_array, toplam_depodan_cikan_array    ",
                                    "urun_id = :urun_id AND depo_id = :depo_id    ");
        ...
        QString ent_olmayan_depoya_giren_array          = depo_query.VALUE ( 1 ).toString();
        QString ent_olmayan_depo_cikan_array         = depo_query.VALUE ( 2 ).toString();
        QString ent_depoya_giren_array                  = depo_query.VALUE ( 3 ).toString();
        QString ent_depodan_cikan_array                 = depo_query.VALUE ( 4 ).toString();
        QString toplam_depoya_giren_array               = depo_query.VALUE ( 5 ).toString();
        QString toplam_depodan_cikan_array              = depo_query.VALUE ( 6 ).toString();
        ...
        switch ( p_alis_satis_turu ) {
            ...
            case ENUM_ALIS_IRSALIYESI_FATURASI :
                ...
                if ( entegrasyon_degisti_mi EQ true ) {
                    for ( int i = 0; i < old_gun_no; i++ ) {
                        TOPLAM_STOK_GIRIS_ARRAY[i] = ROUND ( TOPLAM_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                        if ( p_old_kaydedilecek_sirket EQ SIRKET_1 ) {
                            ENT_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                        }
                        else {
                            ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                        }
                    }
                }
                ...
                if ( fis_tarihi_degisti_mi EQ true ) {
                    ...
                    if ( entegrasyon_degisti_mi EQ false ) {
                        for ( int i = 0; i < old_gun_no; i++ ) {
                            TOPLAM_STOK_GIRIS_ARRAY[i] = ROUND ( TOPLAM_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                            if ( p_new_kaydedilecek_sirket EQ SIRKET_1 ) {
                                ENT_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                            }
                            else {
                                ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_GIRIS_ARRAY[i] - temel_birim_urun_miktari );
                    ...
                    query.PREPARE_UPDATE("stk_depodaki_urunler ", "kayit_id",
                                         ...
                                         "toplam_depoya_giren_array       ",
                                         "kayit_id = :kayit_id");
                    query.SET_VALUE(":ent_olmayan_depoya_giren_array" , PACK_DOUBLE_ARRAY(ENT_OLMAYAN_STOK_GIRIS_ARRAY , K9_ARRAY_SIZE));
                    query.SET_VALUE(":ent_depoya_giren_array"         , PACK_DOUBLE_ARRAY(ENT_STOK_GIRIS_ARRAY         , K9_ARRAY_SIZE));
                    query.SET_VALUE(":toplam_depoya_giren_array"      , PACK_DOUBLE_ARRAY(TOPLAM_STOK_GIRIS_ARRAY      , K9_ARRAY_SIZE));
                    query.SET_VALUE(":kayit_id"                       , kayit_id);
                    query.UPDATE();
                ...
                switch ( stok_takip_sekli ) {
                    ...
                    case ENUM_PARTI_TAKIBI :
                        ...
                        if ( entegrasyon_degisti_mi EQ true ) {
                            ...
                            query.PREPARE_SELECT("stk_urunun_partileri",
                                                 "ent_olm_partiye_giren_array ,ent_partiye_giren_array,"
                                                 "toplam_partiye_giren_array ",
                                                 "parti_id = :parti_id ");
                            query.SET_VALUE(":parti_id" , parti_id);
                            ...
                            if ( query.SELECT() NE 0 ) {
                                ...
                                UNPACK_DOUBLE_ARRAY(query.VALUE("ent_olm_partiye_giren_array").toString(),
                                                    ENT_OLMAYAN_STOK_GIRIS_ARRAY ,K9_ARRAY_SIZE);
                                UNPACK_DOUBLE_ARRAY(query.VALUE("ent_partiye_giren_array").toString() ,
                                                    ENT_STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                                UNPACK_DOUBLE_ARRAY(query.VALUE("toplam_partiye_giren_array").toString(),
                                                    TOPLAM_STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                            }
                        ...
                        query.PREPARE_UPDATE("stk_urunun_partileri", "parti_id",
                                             ...
                                             "toplam_partiye_giren_array   ",
                                             "parti_id = :parti_id");
                        query.SET_VALUE(":ent_olm_partiye_giren_array" , PACK_DOUBLE_ARRAY(ENT_OLMAYAN_STOK_GIRIS_ARRAY , K9_ARRAY_SIZE));
                        query.SET_VALUE(":ent_partiye_giren_array"     , PACK_DOUBLE_ARRAY(ENT_STOK_GIRIS_ARRAY         , K9_ARRAY_SIZE));
                        query.SET_VALUE(":toplam_partiye_giren_array"  , PACK_DOUBLE_ARRAY(TOPLAM_STOK_GIRIS_ARRAY      , K9_ARRAY_SIZE));
                        query.SET_VALUE(":parti_id"                    , parti_id);
                        query.UPDATE();
            ...
            case ENUM_SATIS_IRSALIYESI_FATURASI :
                ...
                if ( entegrasyon_degisti_mi EQ true ) {
                    for ( int i = 0; i < old_gun_no; i++ ) {
                        ...
                        if ( p_old_kaydedilecek_sirket EQ SIRKET_1 ) {
                            ENT_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_STOK_CIKIS_ARRAY[i] - temel_birim_urun_miktari );
                        }
                        else {
                            ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] = ROUND ( ENT_OLMAYAN_STOK_CIKIS_ARRAY[i] - temel_birim_urun_miktari );
                        }
                    }
                }
                ...
                query.PREPARE_UPDATE("stk_depodaki_urunler", "kayit_id",
                                     ...
                                     "toplam_depodan_cikan_array     ",
                                     "kayit_id = :kayit_id");
                query.SET_VALUE(":ent_olmayan_depo_cikan_array" , PACK_DOUBLE_ARRAY(ENT_OLMAYAN_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE));
                query.SET_VALUE(":ent_depodan_cikan_array"      , PACK_DOUBLE_ARRAY(ENT_STOK_CIKIS_ARRAY         , K9_ARRAY_SIZE));
                query.SET_VALUE(":toplam_depodan_cikan_array"   , PACK_DOUBLE_ARRAY(TOPLAM_STOK_CIKIS_ARRAY      , K9_ARRAY_SIZE));
                query.SET_VALUE(":kayit_id"                     , kayit_id);
                query.UPDATE();
                ...
                switch ( stok_takip_sekli ) {
                    ...
                    case ENUM_PARTI_TAKIBI :
                    {
                        ...
                        query.PREPARE_SELECT("stk_urunun_partileri", "ent_olm_partiden_cikan_array ,"
                                             "ent_partiden_cikan_array , toplam_partiden_cikan_array ",
                                             "parti_id = :parti_id");
                        query.SET_VALUE(":parti_id" , parti_id);
                        ...
                        if ( query.SELECT() NE 0 ) {
                            ...
                            UNPACK_DOUBLE_ARRAY(query.VALUE("ent_olm_partiden_cikan_array").toString(),
                                                ENT_OLMAYAN_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE);
                            UNPACK_DOUBLE_ARRAY(query.VALUE("ent_partiden_cikan_array").toString() ,
                                                ENT_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE);

                            UNPACK_DOUBLE_ARRAY(query.VALUE("toplam_partiden_cikan_array").toString(),
                                                TOPLAM_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE);
                        ...
                        query.PREPARE_UPDATE("stk_urunun_partileri", "parti_id",
                                             ...
                                             "toplam_partiden_cikan_array   ",
                                             "parti_id = :parti_id");
                        query.SET_VALUE(":ent_partiden_cikan_array" , PACK_DOUBLE_ARRAY(ENT_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE));
                        query.SET_VALUE(":ent_olm_partiden_cikan_array" , PACK_DOUBLE_ARRAY(ENT_OLMAYAN_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE));
                        query.SET_VALUE(":toplam_partiden_cikan_array"  , PACK_DOUBLE_ARRAY(TOPLAM_STOK_CIKIS_ARRAY , K9_ARRAY_SIZE));
                        query.SET_VALUE(":parti_id" , parti_id);
                        query.UPDATE();
    ...
    if ( entegrasyon_degisti_mi EQ true ) {
        sql_query.PREPARE_UPDATE ( "stk_fis_satirlari ", "fis_id",
                                   "kaydedilecek_sirket  ",
                                   "fis_id = :fis_id " );
        sql_query.SET_VALUE ( ":kaydedilecek_sirket",  p_new_kaydedilecek_sirket  );
        sql_query.SET_VALUE ( ":fis_id",            p_irsaliye_id           );
        sql_query.UPDATE();
    }
                                                                      ...
                                                                      QWidget * p_parent )
{
    ...
    double STOK_GIRIS_ARRAY [ K9_ARRAY_SIZE ];
    double STOK_CIKIS_ARRAY [ K9_ARRAY_SIZE ];
                    ...
                    switch ( stok_takip_sekli ) {
                        ...
                        default                     :
                        {
                            ...
                            if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
                                UNPACK_DOUBLE_ARRAY(depo_query.VALUE("ent_depoya_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                                UNPACK_DOUBLE_ARRAY(depo_query.VALUE("ent_depodan_cikan_array").toString(),STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                            }
                            else {
                                UNPACK_DOUBLE_ARRAY(depo_query.VALUE("toplam_depoya_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                                UNPACK_DOUBLE_ARRAY(depo_query.VALUE("toplam_depodan_cikan_array").toString(),STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                            }
            ...
            default                :
            {
                ...
                if ( STK_GET_HIZMET_MI( IRS_SATIR_BILGILERI[i].urun_id ) NE 1 ) {
                    if( iade_irsaliyesi_mi NE ENUM_IRS_IADE ) {
                        for ( int j = gun_no; j < K9_ARRAY_SIZE; j++ ) {
            ...
            switch ( p_stok_takip_sekli ) {
                ...
                default                :
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ SIRKET_1 ) {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_depoya_giren_array").toString() , STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_depodan_cikan_array").toString() , STOK_CIKIS_ARRAY , K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_depoya_giren_array").toString() , STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_depodan_cikan_array").toString() , STOK_CIKIS_ARRAY , K9_ARRAY_SIZE);
                    }
                ...
                case ENUM_PARTI_TAKIBI :
                    ...
                    double PARTIYE_GIREN_URUN_ARRAY  [ K9_ARRAY_SIZE ];
                    double PARTIDEN_CIKAN_URUN_ARRAY [ K9_ARRAY_SIZE ];
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ SIRKET_1 ) {
                        UNPACK_DOUBLE_ARRAY( sql_query.VALUE("ent_partiye_giren_array").toString() , PARTIYE_GIREN_URUN_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY( sql_query.VALUE("ent_partiden_cikan_array").toString() , PARTIDEN_CIKAN_URUN_ARRAY , K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY( sql_query.VALUE("toplam_partiye_giren_array").toString() , PARTIYE_GIREN_URUN_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY( sql_query.VALUE("toplam_partiden_cikan_array").toString() , PARTIDEN_CIKAN_URUN_ARRAY , K9_ARRAY_SIZE);
                    }
        ...
        default                         :
            ...
            switch ( old_stok_takip_sekli ) {
                ...
                default                :
                {
                    ...
                    sql_query.PREPARE_SELECT("stk_depodaki_urunler",
                                             "ent_olmayan_depoya_giren_array,ent_depoya_giren_array,"
                                             "toplam_depoya_giren_array , ent_olmayan_depo_cikan_array,"
                                             "ent_depodan_cikan_array,toplam_depodan_cikan_array ",
                                             "depo_id = :depo_id AND urun_id = :urun_id");
                    sql_query.SET_VALUE(":depo_id", p_depo_id );
                    sql_query.SET_VALUE(":urun_id", p_old_urun_id );
                    if ( sql_query.SELECT() EQ 0 ) {
                ...
                case ENUM_PARTI_TAKIBI :
                    ...
                    if ( p_kaydedilecek_sirket EQ SIRKET_1 ) {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_partiye_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_partiden_cikan_array").toString() , STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_partiye_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_partiden_cikan_array").toString() , STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }
        ...
        case ENUM_SATIS_IRSALIYESI_FATURASI :
            ...
            switch ( p_new_stok_takip_sekli ) {
                ...
                default                :
                {
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ SIRKET_1 ) {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_depoya_giren_array").toString() , STOK_GIRIS_ARRAY,
                                            K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_depodan_cikan_array").toString() , STOK_CIKIS_ARRAY,
                                            K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_depoya_giren_array").toString() , STOK_GIRIS_ARRAY,
                                            K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_depodan_cikan_array").toString() , STOK_CIKIS_ARRAY,
                                            K9_ARRAY_SIZE);
                ...
                case ENUM_PARTI_TAKIBI :
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_partiye_giren_array").toString() ,
                                            STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("ent_partiden_cikan_array").toString(),
                                            STOK_CIKIS_ARRAY, K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_partiye_giren_array").toString() ,
                                            STOK_GIRIS_ARRAY , K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(sql_query.VALUE("toplam_partiden_cikan_array").toString(),
                                            STOK_CIKIS_ARRAY, K9_ARRAY_SIZE);
                    }
        ...
        case ENUM_ALIS_IRSALIYESI_FATURASI :
        {
            ...
            switch ( stok_takip_sekli ) {
                ...
                default                :
                {
                    ...
                    f_query.PREPARE_SELECT ( "stk_depodaki_urunler",
                                             "ent_depoya_giren_array,"
                                             "ent_depodan_cikan_array,toplam_depoya_giren_array,"
                                             "toplam_depodan_cikan_array ",
                                             "urun_id = :urun_id AND depo_id = :depo_id");
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("ent_depoya_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("ent_depodan_cikan_array").toString(),STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("toplam_depoya_giren_array").toString(),STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("toplam_depodan_cikan_array").toString(),STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }


                    for ( int i = gun_no; i < K9_ARRAY_SIZE; i++ ) {
                        double depodaki_urun_miktari = STOK_GIRIS_ARRAY[i] - STOK_CIKIS_ARRAY [i];
...
//                    }
                ...
                case ENUM_PARTI_TAKIBI :
                    ...
                    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("ent_partiye_giren_array").toString() , STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("ent_partiden_cikan_array").toString() , STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }
                    else {
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("toplam_partiye_giren_array").toString() , STOK_GIRIS_ARRAY,K9_ARRAY_SIZE);
                        UNPACK_DOUBLE_ARRAY(f_query.VALUE("toplam_partiden_cikan_array").toString() , STOK_CIKIS_ARRAY,K9_ARRAY_SIZE);
                    }
                              ...
                              bool arrayler_okunacak , ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT("stk_urunler" , "urun_kodu , urun_adi ,barkod_numarasi,"
                         ...
                         "ent_olmayan_stoga_giren_array,ent_stoga_giren_array,"
                         "toplam_stoga_giren_array,ent_olmayan_stktan_cikan_array,"
                         "ent_stoktan_cikan_array,toplam_stoktan_cikan_array,"
    ...
    if ( arrayler_okunacak EQ true ) {
        ...
        UNPACK_DOUBLE_ARRAY( query.VALUE("ent_olmayan_stoga_giren_array").toString() ,
                             P_URUN->ent_olmayan_stoga_giren_array , K9_ARRAY_SIZE );

        UNPACK_DOUBLE_ARRAY( query.VALUE("ent_stoga_giren_array").toString() ,
                             P_URUN->ent_stoga_giren_array , K9_ARRAY_SIZE );

        UNPACK_DOUBLE_ARRAY( query.VALUE("toplam_stoga_giren_array").toString() ,
                             P_URUN->toplam_stoga_giren_array , K9_ARRAY_SIZE);

        UNPACK_DOUBLE_ARRAY( query.VALUE("ent_olmayan_stktan_cikan_array").toString(),
                             P_URUN->ent_olmayan_stktan_cikan_array , K9_ARRAY_SIZE);

        UNPACK_DOUBLE_ARRAY( query.VALUE("ent_stoktan_cikan_array").toString() ,
                             P_URUN->ent_stoktan_cikan_array , K9_ARRAY_SIZE);

        UNPACK_DOUBLE_ARRAY( query.VALUE("toplam_stoktan_cikan_array").toString(),
                             P_URUN->toplam_stoktan_cikan_array , K9_ARRAY_SIZE );
...
int STK_GET_BIRIM_HASSASIYETI()
{
    ...
    query.PREPARE_SELECT( "k9_sabit_degerler", "stok_birim_fiyat_hassasiyeti");
    query.SELECT();
    query.NEXT();
...
int STK_GET_MIKTAR_HASSASIYETI()
{
    ...
    query.PREPARE_SELECT( "k9_sabit_degerler", "stok_birim_miktar_hassasiyeti");
    query.SELECT();
    query.NEXT();
