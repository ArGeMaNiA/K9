...
void STOK_MIKTARLARI_BATCH::SETUP_FORM()
{
    ...
    m_ui->comboBox_sirket->setCurrentIndex(m_ui->comboBox_sirket->findText(K9_GET_RAPOR_SIRKET_FILTRESI_STRING(m_entegrasyon_durumu)));
...
int STOK_MIKTARLARI_BATCH::CHECK_VAR ( QObject * object )
{
    if ( object EQ m_ui->searchEdit_bas_urun_kodu OR object EQ m_ui->searchEdit_bts_urun_kodu ) {
        ...
        m_entegrasyon_durumu = K9_GET_RAPOR_SIRKET_FILTRESI_ENUM(m_ui->comboBox_sirket->currentText());
    }
