...
int STK_IRS_FIS_BILGILERINI_OKU(int p_fis_id, STK_IRS_FIS_STRUCT *P_FIS)
{
    ...
    query.PREPARE_SELECT("stk_fisler" , "fis_no,fis_tarihi,depo_id,belge_seri ,                           "
                         ...
                         "kaydedilecek_sirket ,base_fis_id ,program_id ,modul_id,             "
    ...
    P_FIS->kaydedilecek_sirket          = query.VALUE("kaydedilecek_sirket").toInt();
...
int STK_IRS_SATIR_BILGILERINI_OKU(int p_fis_satiri_id, STK_IRS_FIS_SATIR_STRUCT *P_FIS_SATIRI )
{
    ...
    query.PREPARE_SELECT("stk_fis_satirlari", "fis_id , order_number ,urun_id,urun_adi ,"
                         ...
                         "base_record_id , kaydedilecek_sirket "
    ...
    P_FIS_SATIRI->kaydedilecek_sirket           = query.VALUE("kaydedilecek_sirket").toInt();
...
int STK_IRS_FIS_EKLE( STK_IRS_FIS_STRUCT *P_FIS )
{
    ...
    if ( P_FIS->irsaliye_mi_stok_fisi_mi EQ ENUM_STOK_FISI ) {
        ...
        if ( P_FIS->fis_turu EQ ENUM_STK_SARF_FIRE_FISI ) {
            ...
            STK_FIS->kaydedilecek_sirket    = P_FIS->kaydedilecek_sirket;
    ...
    query.PREPARE_INSERT ( "stk_fisler", "fis_id",
                           ...
                           "modul_id, program_id, kaydedilecek_sirket,      "
...
int STK_IRS_FIS_SATIRI_EKLE ( STK_IRS_FIS_STRUCT * P_FIS, STK_IRS_FIS_SATIR_STRUCT * P_FIS_SATIRI )
{
    ...
    query.PREPARE_INSERT ( "stk_fis_satirlari","fis_satiri_id",
                           ...
                           "t_is_son_satir_kdv_dahil_tutar,kaydedilecek_sirket, modul_id, program_id, base_record_id ");
...
int STK_IRS_FIS_SATIR_HAREKETLERI_OLUSTUR ( STK_IRS_FIS_STRUCT * P_FIS, STK_IRS_FIS_SATIR_STRUCT * P_FIS_SATIRI, int p_irsaliye_satiri_id )
{
    ...
    switch ( P_FIS->irsaliye_alis_satis_turu) {
        ...
        default                                 : {
            ...
            switch ( P_FIS->fis_turu ) {
                ...
                default :
                    // URUN KARTI
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR ( P_FIS_SATIRI->urun_id , gun_no, temel_birim_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
            }
            // DEPO MIKTARI
            STK_DEPODAKI_STOK_MIKTARINI_ARTIR  ( depo_id, P_FIS_SATIRI->urun_id, gun_no, temel_birim_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
            ...
            switch ( stok_takip_sekli ) {
                ...
                case ENUM_PARTI_TAKIBI :
                    P_FIS_SATIRI->parti_id= STK_PARTIDEKI_URUN_MIKTARINI_ARTIR ( P_FIS->depo_id, P_FIS_SATIRI->urun_id, gun_no, P_FIS_SATIRI->parti_kodu, temel_birim_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
        ...
        case ENUM_SATIS_IRSALIYESI_FATURASI : {
            ...
            switch ( P_FIS->fis_turu ) {
                ...
                default :
                    // URUN KARTI
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR ( P_FIS_SATIRI->urun_id, gun_no, 0.00, temel_birim_miktari, P_FIS_SATIRI->kaydedilecek_sirket);
                    break;
            }
            // DEPO MIKTARI
            STK_DEPODAKI_STOK_MIKTARINI_ARTIR ( depo_id, P_FIS_SATIRI->urun_id, gun_no, 0.00, temel_birim_miktari, P_FIS_SATIRI->kaydedilecek_sirket );
            ...
            switch ( stok_takip_sekli ) {
                case ENUM_SERI_NO_ILE_TAKIP :
                    ...
                    break;
                case ENUM_PARTI_TAKIBI :
                    STK_PARTIDEKI_URUN_MIKTARINI_ARTIR ( depo_id, P_FIS_SATIRI->urun_id , gun_no, P_FIS_SATIRI->parti_kodu, 0.00, temel_birim_miktari, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
                case ENUM_BASIT_TAKIP       :
                default                     :
                    break;
    ...
    if ( P_FIS->fis_turu EQ ENUM_STK_SARF_FIRE_FISI ) {
        ...
        STK_FIS_SATIRI->kaydedilecek_sirket = P_FIS->kaydedilecek_sirket;
...
int STK_IRS_FIS_SATIRI_GUNCELLE( STK_IRS_FIS_STRUCT *P_FIS, STK_IRS_FIS_SATIR_STRUCT *P_NEW_FIS_SATIRI, int p_irsaliye_satiri_id )
{
    ...
    int     old_entegre_olsun_mu         = OLD_FIS_SATIRI->kaydedilecek_sirket;
    ...
    int     new_entegre_olsun_mu         = P_NEW_FIS_SATIRI->kaydedilecek_sirket;
    ...
    switch ( irsaliye_stok_fisi_alis_satis_turu ) {
        ...
        default                            :
            ...
            switch ( P_FIS->fis_turu ) {
                ...
                default :
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_AZALT ( old_urun_id, gun_no, old_temel_birim_stok_miktari, 0.00 , old_entegre_olsun_mu );
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR ( new_urun_id, gun_no, new_temel_birim_stok_miktari, 0.00 , new_entegre_olsun_mu );
                    break;
            }

            STK_DEPODAKI_STOK_MIKTARINI_AZALT        ( depo_id, old_urun_id, gun_no, old_temel_birim_stok_miktari, 0.00 , old_entegre_olsun_mu);
            STK_DEPODAKI_STOK_MIKTARINI_ARTIR        ( depo_id, new_urun_id, gun_no, new_temel_birim_stok_miktari, 0.00 , new_entegre_olsun_mu);
            ...
            if ( old_urun_id EQ new_urun_id ) { // Sadece ürün miktarı değiştirilmiş
                if ( old_satir_stok_miktari NE new_satir_stok_miktari OR old_parti_kodu_id NE new_parti_id ) {
                    ...
                    if ( old_stok_takip_sekli EQ ENUM_PARTI_TAKIBI ) {
                        ...
                        STK_PARTIDEKI_URUN_MIKTARINI_AZALT ( old_parti_kodu_id, gun_no, old_temel_birim_stok_miktari, 0.00, old_entegre_olsun_mu );
                        STK_PARTIDEKI_URUN_MIKTARINI_ARTIR ( depo_id, new_urun_id, gun_no, P_NEW_FIS_SATIRI->parti_kodu, new_temel_birim_stok_miktari, 0.00, new_entegre_olsun_mu );
                    }
        ...
        case ENUM_SATIS_IRSALIYESI_FATURASI :
            ...
            switch ( P_FIS->fis_turu ) {
                ...
                default :
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_AZALT ( old_urun_id, gun_no, 0.00, old_temel_birim_stok_miktari, old_entegre_olsun_mu );
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_ARTIR ( new_urun_id, gun_no, 0.00, new_temel_birim_stok_miktari, new_entegre_olsun_mu );
                    break;
            }

            STK_DEPODAKI_STOK_MIKTARINI_AZALT ( depo_id, old_urun_id, gun_no, 0.00, old_temel_birim_stok_miktari , old_entegre_olsun_mu);
            STK_DEPODAKI_STOK_MIKTARINI_ARTIR ( depo_id, new_urun_id, gun_no, 0.00, new_temel_birim_stok_miktari , new_entegre_olsun_mu);

            if ( old_urun_id EQ new_urun_id ) { // Sadece ürün miktarı değiştirilmiş
                if ( old_satir_stok_miktari NE new_satir_stok_miktari ) {

                    if ( old_stok_takip_sekli EQ ENUM_PARTI_TAKIBI ) {
                        STK_PARTIDEKI_URUN_MIKTARINI_AZALT ( old_parti_kodu_id, gun_no,  0.00, old_temel_birim_stok_miktari,old_entegre_olsun_mu );
                        STK_PARTIDEKI_URUN_MIKTARINI_ARTIR ( depo_id, new_urun_id, gun_no, P_NEW_FIS_SATIRI->parti_kodu, 0.00, new_temel_birim_stok_miktari, new_entegre_olsun_mu );
                    }
                    else if( old_stok_takip_sekli EQ ENUM_SERI_NO_ILE_TAKIP ) {
    ...
    f_query.SET_VALUE ( ":kaydedilecek_sirket"                , P_NEW_FIS_SATIRI->kaydedilecek_sirket               );
    f_query.SET_VALUE ( ":fis_satiri_id"                      , p_irsaliye_satiri_id                            );
    ...
    if( OLD_FIS_SATIRI->satir_tutari NE P_NEW_FIS_SATIRI->satir_tutari ) {
        ...
        if ( P_FIS->fis_turu EQ  ENUM_STK_SARF_FIRE_FISI ) {
            ...
            QStringList muh_row_list = MUH_GET_ENT_ROW_ID_LIST( K9_PROGRAMI, STOK_MODULU, p_irsaliye_satiri_id );
            ...
            if ( muh_row_list.count() > 0 ) {
                ...
                MUH_FIS->program_id             = K9_PROGRAMI;
                MUH_FIS->base_fis_id            = P_NEW_FIS_SATIRI->fis_id;
                MUH_FIS->kaydedilecek_sirket    = P_NEW_FIS_SATIRI->kaydedilecek_sirket;
...
void STK_IRS_FIS_SATIRI_SIL( STK_IRS_FIS_STRUCT *P_FIS, STK_IRS_FIS_SATIR_STRUCT *P_FIS_SATIRI, int p_irsaliye_satiri_id  )
{
    ...
    if ( P_FIS->muh_fis_id > 0 ) {
        ...
        if ( muh_row_list.count() > 0 ) {
            ...
            MUH_FIS->kaydedilecek_sirket    = P_FIS_SATIRI->kaydedilecek_sirket;
        ...
        default                            :
            ...
            switch ( stok_takip_sekli ) {
                ...
                case ENUM_PARTI_TAKIBI :
                    ...
                    STK_PARTIDEKI_URUN_MIKTARINI_AZALT( P_FIS_SATIRI->parti_id, gun_no, temel_stok_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
            }
            // URUN KARTINDAKI VE DEPODAKI URUN MIKTARLARI AZALTILIYOR
            STK_URUN_KARTINDAKI_STOK_MIKTARINI_AZALT ( P_FIS_SATIRI->urun_id, gun_no, temel_stok_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
            STK_DEPODAKI_STOK_MIKTARINI_AZALT        ( P_FIS->depo_id, P_FIS_SATIRI->urun_id, gun_no, temel_stok_miktari, 0.00, P_FIS_SATIRI->kaydedilecek_sirket );
            break;
        ...
        case ENUM_SATIS_IRSALIYESI_FATURASI :
            ...
            switch ( stok_takip_sekli ) {
                ...
                case ENUM_SERI_NO_ILE_TAKIP :
                    ...
                    break;
                case ENUM_PARTI_TAKIBI :
                    STK_PARTIDEKI_URUN_MIKTARINI_AZALT ( P_FIS_SATIRI->parti_id, gun_no,  0.00, temel_stok_miktari, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
            }
            switch ( P_FIS->fis_turu ) {
                ...
                default :
                    STK_URUN_KARTINDAKI_STOK_MIKTARINI_AZALT ( P_FIS_SATIRI->urun_id, gun_no, 0.00, temel_stok_miktari, P_FIS_SATIRI->kaydedilecek_sirket );
                    break;
            }
            STK_DEPODAKI_STOK_MIKTARINI_AZALT ( P_FIS->depo_id, P_FIS_SATIRI->urun_id, gun_no, 0.00, temel_stok_miktari, P_FIS_SATIRI->kaydedilecek_sirket );
            break;
    }
...
void STK_IRS_CLEAR_SATIR_STRUCT ( STK_IRS_FIS_SATIR_STRUCT * P_FIS_SATIRI )
{
    ...
    P_FIS_SATIRI->kaydedilecek_sirket               = -1;
...
int STK_ENT_FIS_SATIRI_EKLE ( STK_IRS_FIS_STRUCT * P_FIS, STK_IRS_FIS_SATIR_STRUCT * P_FIS_SATIRI, ADAK_SQL * P_GELEN_DB)
{
    ...
    MUH_FIS_SATIRI->kaydedilecek_sirket  = P_FIS->kaydedilecek_sirket ;
