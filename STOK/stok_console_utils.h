...
double              STK_DEPODAKI_URUN_MIKTARINI_BUL          ( int p_depo_id, int p_urun_id, int p_entegre_filtresi );
...
int                 STK_PARTIDEKI_URUN_MIKTARINI_ARTIR       ( int p_depo_id, int p_urun_id, int p_gun_no, QString p_parti_kodu,
                                                               double p_giren_urun_miktari, double p_cikan_urun_miktari, int kaydedilecek_sirket,
...
void                STK_IRSALIYE_TARIH_DEGISIKLIGINE_GORE_STOK_GIRIS_CIKISLARINI_DUZENLE ( int       p_irsaliye_id,
                                                                                           ...
                                                                                           int       p_old_entegre_olsun_mu,
                                                                                           int       p_new_entegre_olsun_mu );
