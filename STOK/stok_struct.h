...
struct STK_URUNLER_STRUCT {
    ...
    double     ent_olmayan_stoga_giren_array    [K9_ARRAY_SIZE];
    double     ent_olmayan_stktan_cikan_array   [K9_ARRAY_SIZE];
    double     toplam_stoga_giren_array         [K9_ARRAY_SIZE];
    double     toplam_stoktan_cikan_array       [K9_ARRAY_SIZE];
    double     ent_stoga_giren_array            [K9_ARRAY_SIZE];
    double     ent_stoktan_cikan_array          [K9_ARRAY_SIZE];
