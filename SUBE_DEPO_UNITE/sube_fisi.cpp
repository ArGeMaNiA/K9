...
void SUBE_FISI::SETUP_FORM()
{
    ...
    K9_KULLANICI_YETKILERI_STRUCT * SUBE_KULLANICI_YETKILERI = (K9_KULLANICI_YETKILERI_STRUCT *) K9_GET_KULLANICI_YETKILERI();
...
int SUBE_FISI::ADD_FIS_RECORD()
{
    ...
    K9_LOG_KAYDI_EKLE ( SUBE_MODULU , LOG_SUBE_SUBELER , LOG_ISLEM_ADD , log_detaylari );
...
void SUBE_FISI::UPDATE_FIS_RECORD ( int p_sube_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( SUBE_MODULU , LOG_SUBE_SUBELER , LOG_ISLEM_UPDATE , log_detaylari );
...
void SUBE_FISI::DELETE_FIS_RECORD ( int p_sube_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( SUBE_MODULU , LOG_SUBE_SUBELER , LOG_ISLEM_DELETE , sube_kodu_adi);
...
void SUBE_FISI::ADD_LINE ( int p_sube_id, int p_row_number )
{
    ...
    K9_LOG_KAYDI_EKLE(SUBE_MODULU , LOG_SUBE_UNITELER , LOG_ISLEM_ADD , sube_kodu_adi);
...
void SUBE_FISI::UPDATE_LINE ( int p_sube_id, int p_row_number )
{
    ...
    K9_LOG_KAYDI_EKLE ( SUBE_MODULU , LOG_SUBE_UNITELER , LOG_ISLEM_UPDATE , sube_kodu_adi );
}
...
void SUBE_FISI::DELETE_LINE ( int fis_id, int row_number )
{
    ...
    K9_LOG_KAYDI_EKLE ( SUBE_MODULU , LOG_SUBE_UNITELER , LOG_ISLEM_DELETE , sube_kodu_adi );
...
/**************************************************************************************
                   SUBE_FISI::SHOW_REKLAM
***************************************************************************************/

void  SUBE_FISI::SHOW_REKLAM()
{
     m_ui->reklamViewer->SHOW_REKLAM( "SUBE-FISI" );
}
