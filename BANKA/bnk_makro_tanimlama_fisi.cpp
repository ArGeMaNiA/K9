...
void BNK_MAKRO_TANIMLAMA_FISI::SETUP_FORM ()
{
    ...
    reklamViewer->SHOW_REKLAM( "BANKA-MAKRO-TANIMLAMA" );    
...
int BNK_MAKRO_TANIMLAMA_FISI::ADD_FIS_RECORD()
{
    ...
    K9_LOG_KAYDI_EKLE ( BANKA_MODULU , LOG_BNK_ISLEMLER , LOG_ISLEM_ADD , log_detaylari);
...
void BNK_MAKRO_TANIMLAMA_FISI::UPDATE_FIS_RECORD(int record_id)
{
    ...
    K9_LOG_KAYDI_EKLE (BANKA_MODULU , LOG_BNK_ISLEMLER , LOG_ISLEM_UPDATE , log_detaylari);
...
void BNK_MAKRO_TANIMLAMA_FISI::DELETE_FIS_RECORD ( int record_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( BANKA_MODULU , LOG_BNK_ISLEMLER , LOG_ISLEM_DELETE , log_detaylari );
