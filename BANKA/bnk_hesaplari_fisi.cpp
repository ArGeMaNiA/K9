...
void BNK_HESAPLARI_FISI::SETUP_FORM()
{
    ...
    m_ui->reklamViewer->SHOW_REKLAM( "BANKA-HESAPLARI" );
...
int BNK_HESAPLARI_FISI::GET_FIS_RECORD ( int record_id )
{
    ...
    select_query.PREPARE_SELECT ( "bnk_hesaplar,bnk_pos_arrayler,bnk_kk_arrayler",
                                  ...
                                  "ent_borc_array , ent_alacak_array, odeme_emirleri_hesap_id, banka_hesap_unvani ",
    ...
    double toplam_borc   = toplam_borc_array[K9_ARRAY_SIZE-1];
    double toplam_alacak = toplam_alacak_array[K9_ARRAY_SIZE-1];
    ...
    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
        UNPACK_DOUBLE_ARRAY(select_query.VALUE("ent_kk_tahsilat_borc_array").toString(),toplam_borc_array,K9_ARRAY_SIZE);
        UNPACK_DOUBLE_ARRAY(select_query.VALUE("ent_kk_tahsilat_alacak_array").toString(),toplam_alacak_array,K9_ARRAY_SIZE);
    ...
    toplam_borc   = toplam_borc_array[K9_ARRAY_SIZE-1];
    toplam_alacak = toplam_alacak_array[K9_ARRAY_SIZE-1];
    ...
    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ 1 ) {
        UNPACK_DOUBLE_ARRAY(select_query.VALUE("ent_kk_odeme_borc_array").toString(),toplam_borc_array,K9_ARRAY_SIZE);
        UNPACK_DOUBLE_ARRAY(select_query.VALUE("ent_kk_odeme_alacak_array").toString(),toplam_alacak_array,K9_ARRAY_SIZE);
...
int BNK_HESAPLARI_FISI::ADD_FIS_RECORD ()
{
    ...
    K9_LOG_KAYDI_EKLE ( BANKA_MODULU , LOG_BNK_HESAPLAR , LOG_ISLEM_ADD , log_detaylari);
...
void BNK_HESAPLARI_FISI::UPDATE_FIS_RECORD ( int record_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( BANKA_MODULU , LOG_BNK_HESAPLAR , LOG_ISLEM_UPDATE , log_detaylari);
}
...
void BNK_HESAPLARI_FISI::DELETE_FIS_RECORD ( int record_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( BANKA_MODULU , LOG_BNK_HESAPLAR , LOG_ISLEM_DELETE , log_detaylari);
}
...
void BNK_HESAPLARI_FISI::ADD_LINE ( int record_id, int row_number )
{
    ...
    K9_LOG_KAYDI_EKLE (BANKA_MODULU , LOG_BNK_POS_ISLEMLERI,LOG_ISLEM_ADD,log_detaylari);
...
void BNK_HESAPLARI_FISI::UPDATE_LINE ( int record_id, int row_number )
{
    ...
    QString log_detaylari = QObject::tr("Banka hesap numarası : ")+ m_ui->lineedit_hesap_numarasi->text()
                            + QObject::tr(" , Pos Numarası : ") + lineedit_pos_no->text();
    K9_LOG_KAYDI_EKLE (BANKA_MODULU , LOG_BNK_POS_ISLEMLERI,LOG_ISLEM_UPDATE,log_detaylari);
...
void BNK_HESAPLARI_FISI::DELETE_LINE ( int record_id, int row_number )
{
    ...
    K9_LOG_KAYDI_EKLE (BANKA_MODULU , LOG_BNK_POS_ISLEMLERI,LOG_ISLEM_DELETE,log_detaylari);
