...
void BANKA_HESAP_BAKIYELERINI_ARTTIR ( int gun_no ,int hesap_no_id, double borc_tutari , double alacak_tutari,
                                       int bakiye_turu , int kaydedilecek_sirket ,ADAK_SQL * P_GELEN_DB)
{
    ...
    select_query.PREPARE_SELECT("bnk_hesaplar, bnk_pos_arrayler, bnk_kk_arrayler",
                                ...
                                "toplam_borc_array,toplam_alacak_array,ent_borc_array,                      "
    ...
    switch (bakiye_turu) {
        case ENUM_BNK_BANKA_HESABI :
        {
            UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_borc_array").toString()  , toplam_borc_array  , K9_ARRAY_SIZE );
            UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_alacak_array").toString(), toplam_alacak_array, K9_ARRAY_SIZE );

            UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_borc_array").toString()     , ent_borc_array  , K9_ARRAY_SIZE );
            UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_alacak_array").toString()   , ent_alacak_array, K9_ARRAY_SIZE );

            UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olmayan_borc_array").toString()  , ent_olmayan_borc_array  , K9_ARRAY_SIZE );
            UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olmayan_alacak_array").toString(), ent_olmayan_alacak_array, K9_ARRAY_SIZE );
            ...
            for (int i = gun_no ; i < K9_ARRAY_SIZE ; i++) {
                ...
                if (borc_tutari NE 0.0) {
                    ...
                    if( kaydedilecek_sirket EQ 1 ){
                        ent_borc_array[i] += borc_tutari;
                    }
                    else {
                        ent_olmayan_borc_array[i] += borc_tutari;
                    }
                }
                if ( alacak_tutari NE 0.0) {
                    ...
                    if ( kaydedilecek_sirket EQ 1 ) {
                        ent_alacak_array[i]  += alacak_tutari;
                    }
                    else {
                        ent_olmayan_alacak_array[i] += alacak_tutari;
                    }
                }
            }

            update_query.PREPARE_UPDATE("bnk_hesaplar","hesap_no_id",
                                        "toplam_borc_array,ent_borc_array,toplam_alacak_array,"
                                        "ent_alacak_array,ent_olmayan_borc_array,ent_olmayan_alacak_array",
                                        "hesap_no_id = :hesap_no_id");
            update_query.SET_VALUE(":toplam_borc_array"        , PACK_DOUBLE_ARRAY( toplam_borc_array       , K9_ARRAY_SIZE));
            update_query.SET_VALUE(":ent_borc_array"           , PACK_DOUBLE_ARRAY( ent_borc_array   , K9_ARRAY_SIZE));
            update_query.SET_VALUE(":toplam_alacak_array"      , PACK_DOUBLE_ARRAY( toplam_alacak_array     , K9_ARRAY_SIZE));
            update_query.SET_VALUE(":ent_alacak_array"         , PACK_DOUBLE_ARRAY( ent_alacak_array , K9_ARRAY_SIZE));
            update_query.SET_VALUE(":ent_olmayan_borc_array"   , PACK_DOUBLE_ARRAY( ent_olmayan_borc_array  , K9_ARRAY_SIZE));
            update_query.SET_VALUE(":ent_olmayan_alacak_array" , PACK_DOUBLE_ARRAY( ent_olmayan_alacak_array, K9_ARRAY_SIZE));
        ...
        case ENUM_BNK_KREDI_KARTI_HESABI :
        {
                ...
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_kk_odeme_borc_array").toString()  , toplam_borc_array,   K9_ARRAY_SIZE);
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_kk_odeme_alacak_array").toString(), toplam_alacak_array, K9_ARRAY_SIZE);

                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_kk_odeme_borc_array").toString(),      ent_borc_array,      K9_ARRAY_SIZE);
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_kk_odeme_alacak_array").toString(),    ent_alacak_array,    K9_ARRAY_SIZE);


                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olm_kk_odeme_borc_array").toString()  , ent_olmayan_borc_array  , K9_ARRAY_SIZE);
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olm_kk_odeme_alacak_array").toString(), ent_olmayan_alacak_array, K9_ARRAY_SIZE);
                ...
                update_query.PREPARE_UPDATE("bnk_kk_arrayler","hesap_no_id","toplam_kk_odeme_borc_array, "
                                            "ent_kk_odeme_borc_array,toplam_kk_odeme_alacak_array , "
                                            "ent_kk_odeme_alacak_array,ent_olm_kk_odeme_borc_array, "
                                            "ent_olm_kk_odeme_alacak_array ",
                                            "hesap_no_id = :hesap_no_id");

                update_query.SET_VALUE(":toplam_kk_odeme_borc_array"    , PACK_DOUBLE_ARRAY( toplam_borc_array        , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":ent_kk_odeme_borc_array"       , PACK_DOUBLE_ARRAY( ent_borc_array           , K9_ARRAY_SIZE));

                update_query.SET_VALUE(":toplam_kk_odeme_alacak_array"  , PACK_DOUBLE_ARRAY( toplam_alacak_array      , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":ent_kk_odeme_alacak_array"     , PACK_DOUBLE_ARRAY( ent_alacak_array         , K9_ARRAY_SIZE));

                update_query.SET_VALUE(":ent_olm_kk_odeme_borc_array"   , PACK_DOUBLE_ARRAY( ent_olmayan_borc_array   , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":ent_olm_kk_odeme_alacak_array" , PACK_DOUBLE_ARRAY( ent_olmayan_alacak_array , K9_ARRAY_SIZE));
        ...
        case ENUM_BNK_POS_HESABI         :
        {
                ...
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_kk_tahsilat_borc_array").toString()   , toplam_borc_array  , K9_ARRAY_SIZE );
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("toplam_kk_thslat_alacak_array").toString() , toplam_alacak_array, K9_ARRAY_SIZE );

                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_kk_tahsilat_borc_array").toString()      , ent_borc_array  , K9_ARRAY_SIZE );
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_kk_tahsilat_alacak_array").toString()    , ent_alacak_array, K9_ARRAY_SIZE );

                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olm_kk_tahsilat_borc_array").toString()  , ent_olmayan_borc_array  , K9_ARRAY_SIZE );
                UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_olm_kk_thslat_alacak_array").toString(), ent_olmayan_alacak_array, K9_ARRAY_SIZE );
                ...
                update_query.PREPARE_UPDATE("bnk_pos_arrayler","hesap_no_id","toplam_kk_tahsilat_borc_array,    "
                                            "toplam_kk_thslat_alacak_array ,ent_kk_tahsilat_borc_array ,       "
                                            "ent_kk_tahsilat_alacak_array,ent_olm_kk_tahsilat_borc_array,  "
                                            "ent_olm_kk_thslat_alacak_array ",
                                            "hesap_no_id = :hesap_no_id");

                update_query.SET_VALUE(":toplam_kk_tahsilat_borc_array"    , PACK_DOUBLE_ARRAY( toplam_borc_array    , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":toplam_kk_thslat_alacak_array"  , PACK_DOUBLE_ARRAY( toplam_alacak_array  , K9_ARRAY_SIZE));

                update_query.SET_VALUE(":ent_kk_tahsilat_borc_array"       , PACK_DOUBLE_ARRAY( ent_borc_array       , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":ent_kk_tahsilat_alacak_array"     , PACK_DOUBLE_ARRAY( ent_alacak_array     , K9_ARRAY_SIZE));

                update_query.SET_VALUE(":ent_olm_kk_tahsilat_borc_array"   , PACK_DOUBLE_ARRAY( ent_olmayan_borc_array   , K9_ARRAY_SIZE));
                update_query.SET_VALUE(":ent_olm_kk_thslat_alacak_array" , PACK_DOUBLE_ARRAY( ent_olmayan_alacak_array , K9_ARRAY_SIZE));
    ...
    switch (bakiye_turu) {
        case ENUM_BNK_BANKA_HESABI :
        {
            ...
            update_query.PREPARE_UPDATE("bnk_hesaplar","hesap_no_id","toplam_borc_array,   "
                                        "ent_borc_array,toplam_alacak_array, "
