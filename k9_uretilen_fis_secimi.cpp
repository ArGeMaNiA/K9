...
#include "adak_sql.h"
#include "k9_uretilen_fis_secimi_class.h"
...
void K9_URETILEN_FIS_SEC ( int p_program_id, int p_modul_id, int p_fis_id, QWidget * parent )
{
    K9_URETILEN_FIS_SECIMI * F = new K9_URETILEN_FIS_SECIMI ( p_program_id, p_modul_id, p_fis_id, parent );
    F->EXEC( NOT_FULL_SCREEN );
}

/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::K9_URETILEN_FIS_SECIMI
***************************************************************************************/

K9_URETILEN_FIS_SECIMI::K9_URETILEN_FIS_SECIMI( int p_program_id, int p_modul_id, int p_fis_id, QWidget * parent ) : SECIM_KERNELI ( parent )
{
    ...
    SET_SETTING_NAME  ( "K9_URETILEN_FIS_SECIMI" );
    SET_HELP_PAGE     ( tr("k9_uretilen_fisler") );
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::FILL_TABLE
***************************************************************************************/

void K9_URETILEN_FIS_SECIMI::FILL_TABLE()
{
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::SINGLE_LINE_SELECTED
***************************************************************************************/

int K9_URETILEN_FIS_SECIMI::SINGLE_LINE_SELECTED(int selected_row_number)
{
    QTableWidget * table_widget = GET_TABLE_WIDGET();
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::CARI_FILL_FIS
***************************************************************************************/

void K9_URETILEN_FIS_SECIMI::CARI_ENT_OLMUS_MU()
{
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::BNK_ENT_OLMUS_MU
***************************************************************************************/

void K9_URETILEN_FIS_SECIMI::BNK_ENT_OLMUS_MU()
{
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::MUH_ENT_OLMUS_MU
***************************************************************************************/

void K9_URETILEN_FIS_SECIMI::MUH_ENT_OLMUS_MU()
{
...
/**************************************************************************************
                   K9_URETILEN_FIS_SECIMI::CEKSENET_ENT_OLMUS_MU
***************************************************************************************/

void K9_URETILEN_FIS_SECIMI::CEKSENET_ENT_OLMUS_MU()
{
