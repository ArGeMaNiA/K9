...
static K9_SABIT_DEGERLER_STRUCT G_K9_SABIT_DEGERLER;
struct K9_KULLANICI_YETKILERI_STRUCT * K9_KULLANICI_YETKILERI = NULL;

/**************************************************************************************
                   K9_SET_DEFAULT_VALUES
***************************************************************************************/
...
void K9_SET_DEFAULT_VALUES()
{
    ...
    query.PREPARE_SELECT("k9_sabit_degerler", "k9_sabit_degerler_atandi_mi" );
    if ( query.SELECT() NE 0 ) {
        query.NEXT();
        if ( query.VALUE(0).toInt() EQ EVET ) {
            // KURULU ISE DEGERLERIN YUKLENMESI LAZIM
            K9_SET_SABIT_DEGERLER_STRUCT            ();
    ...
    K9_KULLANICI_YETKILERI_FISI_VE_KULLANICI_YETKILERI_ORDER_NUM_OLUSTUR();
...
/**************************************************************************************
                  K9_GET_KULLANICI_YETKILERI
***************************************************************************************/

void *  K9_GET_KULLANICI_YETKILERI()
{
    return K9_KULLANICI_YETKILERI;
}

/*********************************************************/
/*        K9_KULLANICIYI_TAM_YETKILENDIR()           */
/*********************************************************/

void K9_KULLANICIYI_TAM_YETKILENDIR()
{
    SQL_QUERY query ( DB );

    int kullanici_id = KULLANICI_ID();

    query.PREPARE_SELECT("k9_kullanici_yetkileri","yetki_id","kullanici_id = :kullanici_id");
    ...
    query.PREPARE_INSERT( "k9_kullanici_yetkileri","yetki_id","kullanici_id");

    query.SET_VALUE(":kullanici_id", KULLANICI_ID());
    query.INSERT();

    query.PREPARE_INSERT("k9_kullanici_yetkileri_fisi",
                         "kullanici_yetkileri_fisi_id",
                         "lock_flag " );
    query.SET_VALUE(":lock_flag",1);
    query.INSERT();

    if ( K9_KULLANICI_YETKILERI EQ NULL ) {
        K9_KULLANICI_YETKILERI = new K9_KULLANICI_YETKILERI_STRUCT;
    }

 /*********************************************************  ADRES ************************************************/

    K9_KULLANICI_YETKILERI->adr_adres_karti_tanimlama_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->adr_not_defteri_inceleme_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->adr_adres_kayitlari_rapor_alma_yetkisi  = 1;
    K9_KULLANICI_YETKILERI->adr_tel_web_kayitlari_rapor_alma_yetkisi= 1;
    K9_KULLANICI_YETKILERI->adr_etiket_yazdirma_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->adr_fihrist_raporu_alma_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->adr_toplu_mail_gonderme_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->adr_grup_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->adr_toplu_sms_gonderme_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->adr_export_yetkisi                      = 1;
    K9_KULLANICI_YETKILERI->adr_import_yetkisi                      = 1;



/************************************************************** BANKA  *****************************************/

    K9_KULLANICI_YETKILERI->bnk_banka_hesabi_acma_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->bnk_ent_fisleri_inceleme_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->bnk_defter_raporu_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->bnk_pos_ekstresi_alma_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->bnk_hareket_fisi_islem_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->bnk_acilis_fisi_islem_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->bnk_makro_tanimlama_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->bnk_kk_ekstresi_alma_yetkisi            = 1;
    K9_KULLANICI_YETKILERI->bnk_virman_islem_yetkisi                = 1;
    K9_KULLANICI_YETKILERI->bnk_makro_fisi_islem_yetkisi            = 1;


/******************************************************************* CARI   *************************************/

    K9_KULLANICI_YETKILERI->cari_tahsilat_fisi_islem_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->cari_odeme_fisi_islem_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->cari_hareket_fisi_islem_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->cari_acilis_fisi_islem_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->cari_grup_tanimlama_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->cari_kart_tanimlama_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->cari_ent_fisleri_inceleme_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->cari_ekstre_alma_yetkisi                = 1;
    K9_KULLANICI_YETKILERI->cari_bakiye_raporu_alma_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->cari_virman_islem_yetkisi               = 1;
    K9_KULLANICI_YETKILERI->cari_hesap_hareketleri_gorebilir_mi     = 1;



/********************************************************* CEKSENET *****************************************************************/

    K9_KULLANICI_YETKILERI->cek_senet_girebilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->cek_bordrosu_islem_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->cek_ent_fisleri_inceleme_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->cek_listesi_rapor_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->cek_mus_cek_senet_arama_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->cek_acilis_bordrosu_islem_yetkisi       = 1;


/***************************************************** DEMIRBAS *****************************************************/

    K9_KULLANICI_YETKILERI->dmr_demirbas_karti_tanimlama_yetkisi    = 1;
    K9_KULLANICI_YETKILERI->dmr_grup_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->dmr_yen_degerleme_fisi_islem_yetkisi    = 1;
    K9_KULLANICI_YETKILERI->dmr_amortisman_fisi_islem_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->dmr_demirbas_listesi_rapor_alma_yetkisi = 1;
    K9_KULLANICI_YETKILERI->dmr_toplu_amortisman_ayirma_yetkisi     = 1;
    K9_KULLANICI_YETKILERI->dmr_toplu_yeniden_degerleme_yetkisi     = 1;
    K9_KULLANICI_YETKILERI->dmr_rapor_islem_grubu_tanimlama_yetkisi = 1;


/*********************************************************** MUHASEBE *******************************************/

    K9_KULLANICI_YETKILERI->muh_muhasebe_fisi_islem_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->muh_ent_fisleri_inceleme_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->muh_hesap_plani_islem_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->muh_yvm_no_olusturma_yetkisi            = 1;
    K9_KULLANICI_YETKILERI->muh_hesap_ekstresi_alma_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->muh_mizan_raporu_alma_yetkisi           = 1;
    K9_KULLANICI_YETKILERI->muh_hesap_plani_rapor_alma_yetkisi      = 1;
    K9_KULLANICI_YETKILERI->muh_gelir_tablosu_rapor_alma_yetkisi    = 1;
    K9_KULLANICI_YETKILERI->muh_bilanco_rapor_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->muh_yvm_dokumu_alma_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->muh_defteri_kebir_raporu_alma_yetkisi   = 1;
    K9_KULLANICI_YETKILERI->muh_fis_dokumu_alma_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->muh_hatali_fisleri_inceleme_yetkisi     = 1;
    K9_KULLANICI_YETKILERI->muh_grup_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->muh_yansitma_hesabi_tanimlama_yetkisi   = 1;
    K9_KULLANICI_YETKILERI->muh_yansitma_fisi_olusturma_yetkisi     = 1;
    K9_KULLANICI_YETKILERI->muh_hesap_ekstresi_nakli_yekun          = 1;
    K9_KULLANICI_YETKILERI->muh_mizan_nakli_yekun                   = 1;
    K9_KULLANICI_YETKILERI->muh_hesap_plani_kopyalama_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->muh_acilis_fisi_islem_yetkisi           = 1;



/***************************************************************** PERSONEL ***************************************/

    K9_KULLANICI_YETKILERI->prs_sicil_karti_tanimlama_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->prs_ek_odenek_tanimlama_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->prs_ek_kesinti_tanimlama_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->prs_sabit_deger_guncelleme_yetkisi      = 1;
    K9_KULLANICI_YETKILERI->prs_maas_bordrosu_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->prs_maas_bordrosu_iptal_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->prs_maas_bordrosu_raporu_alma_yetkisi   = 1;
    K9_KULLANICI_YETKILERI->prs_ihbar_ve_kidem_tazminati_raporu_alma_yetkisi = 1;
    K9_KULLANICI_YETKILERI->prs_isten_ayrilma_islem_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->prs_bordro_inceleme_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->prs_personel_raporu_alma_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->prs_e_bildirge_alma_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->prs_grup_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->prs_isten_ayrilan_personel_arama_yetkisi= 1;
    K9_KULLANICI_YETKILERI->prs_eksik_gun_nedenleri_giris_yetkisi   = 1;
    K9_KULLANICI_YETKILERI->prs_ucret_pusulasi_raporu_alma_yetkisi  = 1;

/*************************************************** SUBE / DEPO / UNITE  ****************************************/

    K9_KULLANICI_YETKILERI->sub_sube_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->sub_depo_tanimlama_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->sub_depo_islem_yetkisi                  = TUM_DEPOLARDA;
    K9_KULLANICI_YETKILERI->sub_sube_islem_yetkisi                  = TUM_SUBELERDE;
    K9_KULLANICI_YETKILERI->sub_ent_hesaplari_guncelleme_yetkisi    = 0; // ent esaplarini degistiremez


/********************************************************* STOK *************************************************/

    K9_KULLANICI_YETKILERI->stok_urun_karti_tanimlama_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->stok_hizmet_karti_tanimlama_yetkisi     = 1;
    K9_KULLANICI_YETKILERI->stok_grup_tanimlama_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->stok_fisi_islem_yetkisi                 = 1;
    K9_KULLANICI_YETKILERI->stok_urun_listesi_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->stok_miktar_raporu_alma_yetkisi         = 1;
    K9_KULLANICI_YETKILERI->stok_ekstresi_alma_yetkisi              = 1;
    K9_KULLANICI_YETKILERI->stok_urun_hareketlerini_gorebilir_mi    = 1;


/*********************************************    FATURA          **************************************************/

    K9_KULLANICI_YETKILERI->fat_alis_faturasi_kesebilir_mi          = 1;
    K9_KULLANICI_YETKILERI->fat_sts_faturasi_kesebilir_mi           = 1;
    K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_elle             = 1;
    K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_oto              = 1;
    K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_toplu            = 1;
    K9_KULLANICI_YETKILERI->fat_satir_iskontosu_yapabilir_mi        = 1; // default'ta gosterilyor
    K9_KULLANICI_YETKILERI->fat_toplu_iskonto_yapabilir_mi          = 1;
    K9_KULLANICI_YETKILERI->fat_hizmet_ekstresi_alma_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->fat_ba_bs_listesi_alma_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->fat_fatura_listesi_alma_yetkisi         = 1;


/******************************************   İRSALİYE *************************************************************/

    K9_KULLANICI_YETKILERI->irs_alis_irsaliyesi_islem_yetkisi       = 1;
    K9_KULLANICI_YETKILERI->irs_sts_irsaliyesi_islem_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_elle           = 1;
    K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_oto            = 1;
    K9_KULLANICI_YETKILERI->irs_satir_iskontosu_yapabilir_mi        = 1;
    K9_KULLANICI_YETKILERI->irs_listesi_gorebilir_mi                = 1;
    K9_KULLANICI_YETKILERI->irs_toplu_iskonto_yapabilir_mi          = 1;


/******************************************************** ISLETME ****************************************************/

    K9_KULLANICI_YETKILERI->isl_isletme_defteri_rapor_alma_yetkisi  = 1;
    K9_KULLANICI_YETKILERI->isl_kdv_raporu_alma_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->isl_fisi_islem_yetkisi                  = 1;


/******************************************************** SM_MAKBUZU ****************************************************/

    K9_KULLANICI_YETKILERI->smm_makbuzu_islem_yetkisi               = 1;
    K9_KULLANICI_YETKILERI->smm_hizmet_tanimlama_yetkisi            = 1;
    K9_KULLANICI_YETKILERI->smm_tahsil_edildi_odendi_secili_gelsin  = 1;

/******************************************************** DOVIZ ****************************************************/

    K9_KULLANICI_YETKILERI->dvz_dovizleri_inceleme_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->dvz_doviz_tanimlama_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->dvz_kur_guncelleme_yetkisi              = 1;

/********************************************       PERAKENDE      ************************************************/

    K9_KULLANICI_YETKILERI->prk_fis_girebilir_mi                    = 1;
    K9_KULLANICI_YETKILERI->prk_gdr_tur_tanimlayabilir_mi           = 1;
    K9_KULLANICI_YETKILERI->prk_kasa_raporu_alabilir_mi             = 1;


/************************************************************* SISTEM **********************************************/

    K9_KULLANICI_YETKILERI->sis_blg_formuna_girebilir_mi            = 1;
    K9_KULLANICI_YETKILERI->sis_kul_formuna_girebilir_mi            = 1;
    K9_KULLANICI_YETKILERI->sis_veritabani_formuna_girebilir_mi     = 1;
    K9_KULLANICI_YETKILERI->sis_yonetim_log_inceleme_yetkisi        = 1;
    K9_KULLANICI_YETKILERI->sis_mail_srv_tanimlayabilirmi           = 1;
    K9_KULLANICI_YETKILERI->sis_sms_srv_tanimlayabilirmi            = 1;


    K9_KULLANICI_YETKILERI->ynt_k9_yetkilendirme_yapabilir_mi       = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_onar_yetkisi                     = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_devir_islemi_yapabilir_mi        = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_log_inceleme_yetkisi             = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_sabit_degerler_guncelleme_yetkisi= 1;
    K9_KULLANICI_YETKILERI->ynt_k9_belge_tasarlama_yetkisi          = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_ent_bilgilerini_degistirme_yetkisi= 0;
    K9_KULLANICI_YETKILERI->ynt_k9_kullanicinin_calistigi_sirket     = 1;
    K9_KULLANICI_YETKILERI->ynt_k9_kullanici_sirket_degistire_bilir_mi= 0;
    K9_KULLANICI_YETKILERI->ynt_k9_urettigi_fisleri_grbilir_mi         = 1;

    K9_KULLANICI_YETKILERI->k9_adr_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_bnk_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_car_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_cek_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_dmr_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_dvz_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_faiz_kullanabilir_mi                 = 1;
    K9_KULLANICI_YETKILERI->k9_fat_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_irs_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_isl_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_muh_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_prk_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_prs_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_smm_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_stk_kullanabilir_mi                  = 1;
    K9_KULLANICI_YETKILERI->k9_sub_kullanabilir_mi                  = 1;

    K9_KULLANICIYI_YETKILERI_UPDATE ( K9_KULLANICI_YETKILERI , KULLANICI_ID() );

    K9_LOG_KAYDI_EKLE(K9_YONETIM , LOG_K9_YETKILENDIRME , LOG_ISLEM_ADD , "Kullanıcı Yetkileri");
...
void K9_KULLANICI_YETKILERI_FISI_VE_KULLANICI_YETKILERI_ORDER_NUM_OLUSTUR ()
{
    SQL_QUERY sql_query    ( DB );
    SQL_QUERY second_query ( DB );

    sql_query.PREPARE_SELECT("k9_kullanici_yetkileri_fisi", "kullanici_yetkileri_fisi_id");
    if ( sql_query.SELECT() > 0 ) {
        return;
    }

    sql_query.PREPARE_INSERT("k9_kullanici_yetkileri_fisi", "kullanici_yetkileri_fisi_id", "lock_flag");
    sql_query.SET_VALUE     (":lock_flag", 1 );
    sql_query.INSERT();

    int order_number = 0;
    sql_query.PREPARE_SELECT("k9_kullanici_yetkileri", "yetki_id");
    ...
    while ( sql_query.NEXT() EQ true ) {
        ...
        order_number += 1024;
        second_query.PREPARE_UPDATE("k9_kullanici_yetkileri ", "sabit_deger_id", "order_number ",
                                    "yetki_id = :yetki_id"  );
...
/////// !!!!!!! TASARIM ADLARININ BASLARINA 'ADAK' EKLENMELI VE SON ALINAN CIKTI KULLANILMALI
    ...
    #include "k9_default_belge_degiskenleri.h"
...
void K9_DELIMETER_UPDATE ( const QString p_old_delimeter, const QString p_new_delimeter, QWidget * p_parent )
{
...
void K9_SET_SABIT_DEGERLER_STRUCT ()
{
    ...
    sql_query.PREPARE_SELECT("k9_sabit_degerler","fat_acik_fatura_mi_kapali_mi ","");
    ...
    G_K9_SABIT_DEGERLER.acik_kapali_fatura        = sql_query.VALUE ( 0 ).toInt();

    K9_RESTORE_MUHASEBE_ALAMLARI_VALUE();
}

/**************************************************************************************************************
                                        K9_GET_ACIK_KAPALI_FATURA_SABIT_DEGER
***************************************************************************************************************/

int K9_GET_ACIK_KAPALI_FATURA_SABIT_DEGER ()
{
    return G_K9_SABIT_DEGERLER.acik_kapali_fatura;
}

/**************************************************************************************************************
                                        K9_SET_ACIK_KAPALI_FATURA_SABIT_DEGER
***************************************************************************************************************/

void K9_SET_ACIK_KAPALI_FATURA_SABIT_DEGER ( int p_acik_kapali_fatura )
{
    G_K9_SABIT_DEGERLER.acik_kapali_fatura = p_acik_kapali_fatura;
}
...
void K9_CREATE_SABIT_DEGERLER ()
{
    ...
    sql_query.PREPARE_SELECT("k9_sabit_degerler","sabit_deger_id");
    ...
    QString k9_array_son_tarih = QDate    ( QDate::currentDate().year(), 01, 01 ).addDays ( K9_ARRAY_SIZE -2 ).toString("yyyy.MM.dd");
    ...
    sql_query.PREPARE_INSERT ( "k9_sabit_degerler", "sabit_deger_id",
                               ...
                               "  mali_yil_son_tarih             , k9_array_son_tarih               , "
                               "  k9_ayraci                      , kdv_orani_sayisi                 , "
    ...
    sql_query.SET_VALUE ( ":k9_array_son_tarih"              , k9_array_son_tarih);
    sql_query.SET_VALUE ( ":k9_ayraci"                       , k9_ayraci);
    ...
    K9_LOG_KAYDI_EKLE(K9_YONETIM , LOG_K9_SABIT_DEGERLER , LOG_ISLEM_ADD , "K9 Sabit Değerler");
}
/********************************************************************************************************
                                       K9_GET_KDV_ORANLARI_OKUNDUMU_FLAG
*********************************************************************************************************/
...
/********************************************************************************************************
                                       K9_GET_OTV_ORANLARI_OKUNDUMU_FLAG
*********************************************************************************************************/
...
/********************************************************************************************************
                                       K9_SET_KDV_ORANLARI_OKUNDUMU_FLAG
*********************************************************************************************************/
...
/********************************************************************************************************
                                            K9_SET_OTV_ORANLARI_OKUNDUMU_FLAG
*********************************************************************************************************/
...
int K9_GET_ADAK_MODULES_ENUM ( QString p_adak_module_name )
{
    ...
    else if (p_adak_module_name EQ QObject::tr("K9 Yönetim")) {
        return K9_YONETIM;
    }
    return -1;
}
...
/********************************************************************************************************
                                    K9_GET_LOG_ISLEMLERI_STRING
*********************************************************************************************************/

QString K9_GET_LOG_ISLEMLERI_STRING ( int p_k9_log_islemi_enum )
{
    switch ( p_k9_log_islemi_enum ) {
        case LOG_ISLEM_ADD :
...
void K9_LOG_KAYDI_EKLE (int p_modul_id,int p_log_turu, int p_log_islemi, QString p_log_detaylari)
{
    SQL_QUERY sql_query(DB);
    ...
    sql_query.PREPARE_INSERT("k9_log_bilgileri",
                             "log_id" ,
...
/*******************************************************************************************************
                                  K9_GET_LOG_TURLERI_STRING
********************************************************************************************************/

QString K9_GET_LOG_TURLERI_STRING ( int p_log_turu_enum )
{
    switch ( p_log_turu_enum ) {
        ...
        case LOG_K9_ONAR:
            return QObject::tr("K9 Onar");

        case LOG_K9_DEVIR:
            return QObject::tr("Devir İşlemi");

        case LOG_K9_KDV_OTV_ORANLARI:
            return QObject::tr("Kdv Ötv Tanımları");

        case LOG_K9_SABIT_DEGERLER:
            return QObject::tr("Sabit Değerler");

        case LOG_K9_YETKILENDIRME:
...
/*******************************************************************************************************
                                  K9_GET_LOG_TURLERI_ENUM
********************************************************************************************************/

int K9_GET_LOG_TURLERI_ENUM ( QString p_log_turu )
{
    ...
    else if ( p_log_turu EQ QObject::tr("K9 Onar")) {
        return LOG_K9_ONAR;
    }
...
QString K9_GET_DELIMETER()
{
    ...
    select_query.PREPARE_SELECT ( "k9_sabit_degerler","k9_ayraci" );
...
int K9_GET_FIS_NO ( int p_modul_id , int fis_id ) //Fislerin entegre edildikleri moduldeki fis_idlerine gore fis_no dondurur
{
    QString where_query;
    QString table_name;
    QString column_name;
...
/**************************************************************************************
                   K9_KULLANICI_SIRKET_DEGISTIRE_BILIR_MI()
***************************************************************************************/

int K9_KULLANICI_SIRKET_DEGISTIRE_BILIR_MI()
{
    return K9_KULLANICI_YETKILERI->ynt_k9_kullanici_sirket_degistire_bilir_mi;
}

/**************************************************************************************
                   K9_KULLANICININ_CALISTIGI_SIRKET()
***************************************************************************************/

int K9_KULLANICININ_CALISTIGI_SIRKET()
{
    return K9_KULLANICI_YETKILERI->ynt_k9_kullanicinin_calistigi_sirket;
}
/*
*************************************************************************************
                   K9_KULLANICI_URETTIGI_ENT_FISLERINI_GOREBILIR_MI
***************************************************************************************/

int K9_KULLANICI_FISIN_URETTIGI_ENT_FISLERINI_GOREBILIR_MI()
{
    return K9_KULLANICI_YETKILERI->ynt_k9_urettigi_fisleri_grbilir_mi;
}

/**************************************************************************************
                   K9_KULLANICI_ENT_BILGILERINI_DEGISTIREBILIR_MI()
***************************************************************************************/

int K9_KULLANICI_ENT_BILGILERINI_DEGISTIREBILIR_MI()
{
    return K9_KULLANICI_YETKILERI->ynt_k9_ent_bilgilerini_degistirme_yetkisi;
}

/**************************************************************************************
                   K9_KULLANICI_URUN_HAREKETLERINI_GOREBILIR_MI()
***************************************************************************************/

int K9_KULLANICI_URUN_HAREKETLERINI_GOREBILIR_MI()
{
    return K9_KULLANICI_YETKILERI->stok_urun_hareketlerini_gorebilir_mi;
}

/**************************************************************************************
                   K9_KULLANICI_CARI_HAREKETLERINI_GOREBILIR_MI
***************************************************************************************/

int K9_KULLANICI_CARI_HAREKETLERINI_GOREBILIR_MI()
{
    return K9_KULLANICI_YETKILERI->cari_hesap_hareketleri_gorebilir_mi;
}

/**************************************************************************************
                   K9_CLEAR_ENT_DETAYLARI_STRUCT
***************************************************************************************/
...
/**************************************************************************************
                   K9_GET_FIS_FILTRESI_ENUM()
***************************************************************************************/

int K9_GET_FIS_FILTRESI_ENUM  (QString p_entegre_filtresi)
{
    if ( p_entegre_filtresi EQ QObject::tr("1.Şirkete Ait Olanlar" ) ) {
        return FIS_BIRINCI_SIRKET;
    }
    else if ( p_entegre_filtresi EQ QObject::tr("2.Şirkete Ait Olanlar") ) {
        return FIS_IKINCI_SIRKET;
    }
    else if ( p_entegre_filtresi EQ QObject::tr("Hepsi")) {
        return FIS_HER_IKI_SIRKET;
    }
    return -1;
}
...
QString K9_GET_FIS_FILTRESI_STRING(int p_entegre_filtresi)
{
    switch (p_entegre_filtresi) {
        case FIS_HER_IKI_SIRKET :
            return QObject::tr("Hepsi");
        case FIS_BIRINCI_SIRKET :
            return QObject::tr("1.Şirkete Ait Olanlar");
        case FIS_IKINCI_SIRKET :
            return QObject::tr("2.Şirkete Ait Olanlar");
        default:
            break;
    }
    return "";
...
/**************************************************************************************
                   K9_KULLANICILARI_YETKILERI_STRUCT_DOLDUR()
***************************************************************************************/
...
void K9_KULLANICI_YETKILERI_STRUCT_DOLDUR(int kullanici_id)
{
    ...
    K9_CLEAR_KULLANICI_YETKILERI_STRUCT ( K9_KULLANICI_YETKILERI );
    ...
    /************************************************** SISTEM  ***************************************************/
        ...
        sql_query.PREPARE_SELECT("k9_kullanici_yetkileri",
                                 ...
                                 "prk_kullanabilir_mi,                  "
                                 "k9_onar_yapabilir_mi,                 "
                                 "k9_devir_islemi_yapabilir_mi,         "
                                 "k9_log_gorebilir_mi ,                 "
                                 "k9_sabit_degerlere_girebilirmi,       "
                                 "k9_belge_tasarlayabilir_mi,           "
                                 "k9_ent_blg_degistirebilir_mi,         "
                                 "k9_kullanicinin_sirketi,              "
                                 "k9_sirket_degistire_bilir_mi,         "
                                 "k9_urettigi_fisleri_grbilir_mi,       "
    ...
    K9_KULLANICI_YETKILERI->sis_blg_formuna_girebilir_mi         = sql_query.VALUE ( "sis_blg_formuna_girebilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->sis_kul_formuna_girebilir_mi         = sql_query.VALUE ( "sis_kul_formuna_girebilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->sis_veritabani_formuna_girebilir_mi  = sql_query.VALUE ( "sis_frm_formuna_girebilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->sis_yonetim_log_inceleme_yetkisi     = sql_query.VALUE ( "sis_yonetim_log_gorebilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->sis_mail_srv_tanimlayabilirmi        = sql_query.VALUE ( "sis_mail_srv_tanimlayabilirmi" ).toInt();
    K9_KULLANICI_YETKILERI->sis_sms_srv_tanimlayabilirmi         = sql_query.VALUE ( "sis_sms_srv_tanimlayabilirmi"  ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_yetkilendirme_yapabilir_mi    = sql_query.VALUE ( "k9_yetkilendirme_yapabilir_mi"    ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_onar_yetkisi                  = sql_query.VALUE ( "k9_onar_yapabilir_mi"             ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_devir_islemi_yapabilir_mi     = sql_query.VALUE ( "k9_devir_islemi_yapabilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_log_inceleme_yetkisi          = sql_query.VALUE ( "k9_log_gorebilir_mi"              ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_sabit_degerler_guncelleme_yetkisi  = sql_query.VALUE ( "k9_sabit_degerlere_girebilirmi"  ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_belge_tasarlama_yetkisi            = sql_query.VALUE ( "k9_belge_tasarlayabilir_mi"       ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_ent_bilgilerini_degistirme_yetkisi = sql_query.VALUE ( "k9_ent_blg_degistirebilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_kullanicinin_calistigi_sirket      = sql_query.VALUE ( "k9_kullanicinin_sirketi"          ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_kullanici_sirket_degistire_bilir_mi= sql_query.VALUE ( "k9_sirket_degistire_bilir_mi"     ).toInt();
    K9_KULLANICI_YETKILERI->ynt_k9_urettigi_fisleri_grbilir_mi        = sql_query.VALUE ( "k9_urettigi_fisleri_grbilir_mi"     ).toInt();

    K9_KULLANICI_YETKILERI->k9_muh_kullanabilir_mi             = sql_query.VALUE ( "muh_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_isl_kullanabilir_mi             = sql_query.VALUE ( "isl_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_adr_kullanabilir_mi             = sql_query.VALUE ( "adr_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_dvz_kullanabilir_mi             = sql_query.VALUE ( "dvz_kullanabilir_mi").toInt();
    K9_KULLANICI_YETKILERI->k9_car_kullanabilir_mi             = sql_query.VALUE ( "car_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_cek_kullanabilir_mi             = sql_query.VALUE ( "cek_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_bnk_kullanabilir_mi             = sql_query.VALUE ( "bnk_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_sub_kullanabilir_mi             = sql_query.VALUE ( "sub_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_fat_kullanabilir_mi             = sql_query.VALUE ( "fat_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_irs_kullanabilir_mi             = sql_query.VALUE ( "irs_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_stk_kullanabilir_mi             = sql_query.VALUE ( "stk_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_prs_kullanabilir_mi             = sql_query.VALUE ( "prs_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_dmr_kullanabilir_mi             = sql_query.VALUE ( "dmr_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_smm_kullanabilir_mi             = sql_query.VALUE ("smm_makbuzu_kullanabilir_mi").toInt();
    K9_KULLANICI_YETKILERI->k9_faiz_kullanabilir_mi            = sql_query.VALUE ( "faiz_kullanabilir_mi" ).toInt();
    K9_KULLANICI_YETKILERI->k9_prk_kullanabilir_mi             = sql_query.VALUE ( "prk_kullanabilir_mi" ).toInt();

    //Modul yetkileri

    /************************************************************** ADRES ************************************************/

        K9_KULLANICI_YETKILERI->adr_adres_karti_tanimlama_yetkisi                   = sql_query.VALUE ( "adr_frm_shs_blg_gorebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->adr_not_defteri_inceleme_yetkisi                    = sql_query.VALUE ( "adr_not_defterini_gorebilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->adr_adres_kayitlari_rapor_alma_yetkisi              = sql_query.VALUE ( "adr_adres_kayitlari_raporu"      ).toInt();
        K9_KULLANICI_YETKILERI->adr_tel_web_kayitlari_rapor_alma_yetkisi            = sql_query.VALUE ( "adr_tel_web_kayitlari_raporu"    ).toInt();
        K9_KULLANICI_YETKILERI->adr_etiket_yazdirma_yetkisi                         = sql_query.VALUE ( "adr_etiket_yazdirabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->adr_fihrist_raporu_alma_yetkisi                     = sql_query.VALUE ( "adr_fihrist_yazdirabilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->adr_toplu_mail_gonderme_yetkisi                     = sql_query.VALUE ( "adr_toplu_mail_gonderebilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->adr_grup_tanimlama_yetkisi                          = sql_query.VALUE ( "adr_grup_tanimlayabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->adr_toplu_sms_gonderme_yetkisi                      = sql_query.VALUE ( "adr_toplu_sms_gonderebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->adr_export_yetkisi                                  = sql_query.VALUE ( "adr_export_yetkisi").toInt();
        K9_KULLANICI_YETKILERI->adr_import_yetkisi                                  = sql_query.VALUE ( "adr_import_yetkisi").toInt();


    /************************************************************** BANKA *************************************************/

        K9_KULLANICI_YETKILERI->bnk_banka_hesabi_acma_yetkisi                       = sql_query.VALUE ( "bnk_hesabi_acabilir_mi"           ).toInt();
        K9_KULLANICI_YETKILERI->bnk_ent_fisleri_inceleme_yetkisi                    = sql_query.VALUE ( "bnk_ent_fislerini_gorebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->bnk_defter_raporu_alma_yetkisi                      = sql_query.VALUE ( "bnk_defterini_inceleyebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->bnk_pos_ekstresi_alma_yetkisi                       = sql_query.VALUE ( "bnk_pos_ekst_inceleyebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->bnk_hareket_fisi_islem_yetkisi                      = sql_query.VALUE ( "bnk_hareket_fisi_girebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->bnk_acilis_fisi_islem_yetkisi                       = sql_query.VALUE ( "bnk_acilis_fisi_girebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->bnk_makro_fisi_islem_yetkisi                        = sql_query.VALUE ( "bnk_makro_fisi_kesebilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->bnk_kk_ekstresi_alma_yetkisi                        = sql_query.VALUE ( "bnk_kk_ekstresi_alabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->bnk_virman_islem_yetkisi                            = sql_query.VALUE ( "bnk_virman_islemi_yapabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->bnk_makro_tanimlama_yetkisi                         = sql_query.VALUE ( "bnk_makro_tanimlayabilir_mi"      ).toInt();


    /***************************************************************** CARI ****************************************************/


        K9_KULLANICI_YETKILERI->cari_tahsilat_fisi_islem_yetkisi                      = sql_query.VALUE ( "car_tah_fisi_kesebilir_mi"        ).toInt();
        K9_KULLANICI_YETKILERI->cari_odeme_fisi_islem_yetkisi                         = sql_query.VALUE ( "car_odeme_fisi_kesebilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->cari_hareket_fisi_islem_yetkisi                       = sql_query.VALUE ( "car_hareket_fisi_kesebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->cari_acilis_fisi_islem_yetkisi                        = sql_query.VALUE ( "car_acilis_fisi_kesebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->cari_grup_tanimlama_yetkisi                           = sql_query.VALUE ( "car_grup_tanimlayabilir_mi"       ).toInt();
        K9_KULLANICI_YETKILERI->cari_kart_tanimlama_yetkisi                           = sql_query.VALUE ( "car_kart_tanimlayabilir_mi"       ).toInt();
        K9_KULLANICI_YETKILERI->cari_ent_fisleri_inceleme_yetkisi                     = sql_query.VALUE ( "car_ent_fislerini_gorebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->cari_ekstre_alma_yetkisi                              = sql_query.VALUE ( "car_ekstreyi_inceleyebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->cari_bakiye_raporu_alma_yetkisi                       = sql_query.VALUE ( "car_bakiye_rpr_inceleyebilirmi"  ).toInt();
        K9_KULLANICI_YETKILERI->cari_virman_islem_yetkisi                             = sql_query.VALUE ( "car_virman_fisi_kesebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->cari_hesap_hareketleri_gorebilir_mi                   = sql_query.VALUE ( "car_hesap_hareketleri_grb_mi"     ).toInt();

    /**************************************************************** CEKSENET ***********************************************/

        K9_KULLANICI_YETKILERI->cek_senet_girebilir_mi                              = sql_query.VALUE ( "cek_senet_girebilir_mi"         ).toInt();
        K9_KULLANICI_YETKILERI->cek_bordrosu_islem_yetkisi                          = sql_query.VALUE ( "cek_bordro_girebilir_mi"        ).toInt();
        K9_KULLANICI_YETKILERI->cek_ent_fisleri_inceleme_yetkisi                    = sql_query.VALUE ( "cek_ent_fislerini_gorebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->cek_listesi_rapor_alma_yetkisi                      = sql_query.VALUE ( "cek_listesini_inceleyebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->cek_mus_cek_senet_arama_yetkisi                     = sql_query.VALUE ( "cek_mus_ceklerini_gorebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->cek_acilis_bordrosu_islem_yetkisi                   = sql_query.VALUE ( "cek_acilis_bordrosu_yetkisi"    ).toInt();

    /*************************************************************** DEMIRBAS ************************************************/

        K9_KULLANICI_YETKILERI->dmr_demirbas_karti_tanimlama_yetkisi                = sql_query.VALUE ( "dmr_karti_tanimlayabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->dmr_grup_tanimlama_yetkisi                          = sql_query.VALUE ( "dmr_grubu_tanimlayabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->dmr_yen_degerleme_fisi_islem_yetkisi                = sql_query.VALUE ( "dmr_yeni_deger_fis_kesebilirmi" ).toInt();
        K9_KULLANICI_YETKILERI->dmr_amortisman_fisi_islem_yetkisi                   = sql_query.VALUE   ( "dmr_amrtsman_fisi_kesebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->dmr_demirbas_listesi_rapor_alma_yetkisi             = sql_query.VALUE ( "dmr_listesi_raporu_alabilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->dmr_toplu_amortisman_ayirma_yetkisi                 = sql_query.VALUE ( "dmr_toplu_amortisman_ayrablrmi").toInt();
        K9_KULLANICI_YETKILERI->dmr_toplu_yeniden_degerleme_yetkisi                 = sql_query.VALUE ( "dmr_toplu_yeni_deger_ypblrmi").toInt();
        K9_KULLANICI_YETKILERI->dmr_rapor_islem_grubu_tanimlama_yetkisi             = sql_query.VALUE ( "dmr_rpr_islm_grup_tanmlyblr_mi").toInt();

    /**************************************************************** MUHASEBE ************************************************/


        K9_KULLANICI_YETKILERI->muh_muhasebe_fisi_islem_yetkisi                     = sql_query.VALUE ( "muh_mhs_fisi_kesebilir_mi"        ).toInt();
        K9_KULLANICI_YETKILERI->muh_ent_fisleri_inceleme_yetkisi                    = sql_query.VALUE ( "muh_ent_fislerini_gorebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->muh_hesap_plani_islem_yetkisi                       = sql_query.VALUE ( "muh_hesap_planini_gorebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->muh_yvm_no_olusturma_yetkisi                        = sql_query.VALUE ( "muh_yvm_no_olusturabilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->muh_hesap_ekstresi_alma_yetkisi                     = sql_query.VALUE ( "muh_hsp_ekstre_gorebilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->muh_mizan_raporu_alma_yetkisi                       = sql_query.VALUE ( "muh_mizan_rprunu_gorebilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->muh_hesap_plani_rapor_alma_yetkisi                  = sql_query.VALUE ( "muh_hsp_plani_rpr_gorebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->muh_gelir_tablosu_rapor_alma_yetkisi                = sql_query.VALUE ( "muh_gelir_tblsunu_gorebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->muh_bilanco_rapor_alma_yetkisi                      = sql_query.VALUE ( "muh_bilanco_inceleyebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->muh_yvm_dokumu_alma_yetkisi                         = sql_query.VALUE ( "muh_yvm_dkmunu_gorebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->muh_defteri_kebir_raporu_alma_yetkisi               = sql_query.VALUE ( "muh_dftri_kbr_inceleyebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->muh_fis_dokumu_alma_yetkisi                         = sql_query.VALUE ( "muh_fis_dokumunu_gorebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->muh_hatali_fisleri_inceleme_yetkisi                 = sql_query.VALUE ( "muh_hata_fisleri_gorebilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->muh_grup_tanimlama_yetkisi                          = sql_query.VALUE ( "muh_hsp_grbu_tanimlayabilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->muh_yansitma_fisi_olusturma_yetkisi                 = sql_query.VALUE ( "muh_yan_fisi_olusturabilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->muh_yansitma_hesabi_tanimlama_yetkisi               = sql_query.VALUE ( "muh_yan_hesabi_girebilir_mi"      ).toInt();
        K9_KULLANICI_YETKILERI->muh_hesap_plani_kopyalama_yetkisi                   = sql_query.VALUE ( "muh_hesap_plani_kopyalama"        ).toInt();
        K9_KULLANICI_YETKILERI->muh_acilis_fisi_islem_yetkisi                       = sql_query.VALUE ( "muh_acilis_fisi_islem_yetkisi"    ).toInt();

    /******************************************************************* PERSONEL ******************************************/

        K9_KULLANICI_YETKILERI->prs_bordro_inceleme_yetkisi                         =  sql_query.VALUE ( "prs_brd_inceleme_yapabilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->prs_ihbar_ve_kidem_tazminati_raporu_alma_yetkisi    =  sql_query.VALUE ( "prs_ihbr_kdm_rpr_alabilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->prs_isten_ayrilan_personel_arama_yetkisi            =  sql_query.VALUE ( "prs_isten_ayr_prs_arayabilirmi"  ).toInt();
        K9_KULLANICI_YETKILERI->prs_isten_ayrilma_islem_yetkisi                     =  sql_query.VALUE ( "prs_is_ayrilma_rpr_alabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->prs_maas_bordrosu_alma_yetkisi                      =  sql_query.VALUE ( "prs_maas_brd_alabilir_mi"         ).toInt();
        K9_KULLANICI_YETKILERI->prs_maas_bordrosu_iptal_yetkisi                     =  sql_query.VALUE ( "prs_maas_brd_iptal_edebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->prs_maas_bordrosu_raporu_alma_yetkisi               =  sql_query.VALUE ( "prs_maas_brd_rpr_alabilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->prs_ek_kesinti_tanimlama_yetkisi                    =  sql_query.VALUE ( "prs_ek_ksnti_tanimlayabilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->prs_ek_odenek_tanimlama_yetkisi                     =  sql_query.VALUE ( "prs_ek_odnk_tanimlayabilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->prs_personel_raporu_alma_yetkisi                    =  sql_query.VALUE ( "prs_prsonel_raporu_alabilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->prs_sicil_karti_tanimlama_yetkisi                   =  sql_query.VALUE ( "prs_tanimlarina_girebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->prs_sabit_deger_guncelleme_yetkisi                  =  sql_query.VALUE ( "prs_sbt_degerlere_girebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->prs_e_bildirge_alma_yetkisi                         =  sql_query.VALUE ( "prs_e_bildirge_alabilir_mi").toInt();
        K9_KULLANICI_YETKILERI->prs_grup_tanimlama_yetkisi                          =  sql_query.VALUE ( "prs_prsonel_grup_girebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->prs_eksik_gun_nedenleri_giris_yetkisi               =  sql_query.VALUE ( "prs_eksik_gun_nedeni_girisi").toInt();
        K9_KULLANICI_YETKILERI->prs_ucret_pusulasi_raporu_alma_yetkisi              =  sql_query.VALUE ( "prs_ucret_pusulasi_raporu").toInt();

    /******************************************************************* STOK *************************************************/

        K9_KULLANICI_YETKILERI->stok_urun_karti_tanimlama_yetkisi                    =  sql_query.VALUE ( "stk_urun_kartina_girebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->stok_hizmet_karti_tanimlama_yetkisi                  =  sql_query.VALUE ( "stk_hizmet_tanimlayabilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->stok_fisi_islem_yetkisi                              =  sql_query.VALUE ( "stk_fisine_girebilir_mi"       ).toInt();
        K9_KULLANICI_YETKILERI->stok_grup_tanimlama_yetkisi                          =  sql_query.VALUE ( "stk_grubu_tanimlayabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->stok_urun_listesi_alma_yetkisi                       =  sql_query.VALUE ( "stk_urn_listesini_gorebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->stok_miktar_raporu_alma_yetkisi                      =  sql_query.VALUE ( "stk_miktar_rprunu_gorebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->stok_ekstresi_alma_yetkisi                           =  sql_query.VALUE ( "stk_ekstre_inceleyebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->stok_urun_hareketlerini_gorebilir_mi                 =  sql_query.VALUE ( "stk_urun_hareketlerini_grb_mi").toInt();

    /****************************************************        FATURA             *********************************************/

        K9_KULLANICI_YETKILERI->fat_alis_faturasi_kesebilir_mi                     = sql_query.VALUE ( "fat_alis_faturasi_kesebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->fat_sts_faturasi_kesebilir_mi                      = sql_query.VALUE ( "fat_sts_faturasi_kesebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_elle                        = sql_query.VALUE ( "fat_irs_faturalastirma_elle"      ).toInt();
        K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_oto                         = sql_query.VALUE ( "fat_irs_faturalastirma_oto"       ).toInt();
        K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_toplu                       = sql_query.VALUE ( "fat_irs_faturalastirma_toplu"     ).toInt();
        K9_KULLANICI_YETKILERI->fat_satir_iskontosu_yapabilir_mi                   = sql_query.VALUE ( "fat_satir_iskonto_yapabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->fat_toplu_iskonto_yapabilir_mi                     = sql_query.VALUE ( "fat_toplu_iskonto_yapabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->fat_hizmet_ekstresi_alma_yetkisi                      = sql_query.VALUE ( "fat_hizmet_ekstre_alabilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->fat_ba_bs_listesi_alma_yetkisi                              = sql_query.VALUE ( "fat_ba_bs_alabilir_mi"            ).toInt();
        K9_KULLANICI_YETKILERI->fat_fatura_listesi_alma_yetkisi                     = sql_query.VALUE ( "fat_fatura_listesi_alabilir_mi"   ).toInt();

    /******************************************************        İRSALİYE         ************************************************/

        K9_KULLANICI_YETKILERI->irs_alis_irsaliyesi_islem_yetkisi                  = sql_query.VALUE ( "irs_alis_irsaliye_kesebilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->irs_sts_irsaliyesi_islem_yetkisi                   = sql_query.VALUE ( "irs_sts_irsaliye_kesebilir_mi"    ).toInt();
        K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_elle                      = sql_query.VALUE ( "irs_fat_irsaliyelestirme_elle"    ).toInt();
        K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_oto                       = sql_query.VALUE ( "irs_fat_irsaliyelestirme_oto"     ).toInt();
        K9_KULLANICI_YETKILERI->irs_satir_iskontosu_yapabilir_mi                   = sql_query.VALUE ( "irs_satir_iskonto_yapabilir_mi"   ).toInt();
        K9_KULLANICI_YETKILERI->irs_listesi_gorebilir_mi                           = sql_query.VALUE ( "irs_listesi_gorebilir_mi"         ).toInt();
        K9_KULLANICI_YETKILERI->irs_toplu_iskonto_yapabilir_mi                     = sql_query.VALUE ( "irs_toplu_iskonto_yapabilir_mi"   ).toInt();
    ...
    /***************************************************************** SUBE DEPO UNITE ***************************************/
        ...
        K9_KULLANICI_YETKILERI->sub_sube_tanimlama_yetkisi                          = sql_query.VALUE ( "sub_tanimlayabilir_mi"       ).toInt();
        K9_KULLANICI_YETKILERI->sub_depo_tanimlama_yetkisi                          = sql_query.VALUE ( "sub_depo_tanimlayabilir_mi"  ).toInt();
        K9_KULLANICI_YETKILERI->sub_depo_islem_yetkisi                              = sql_query.VALUE ( "sub_depo_islem_yetkisi"      ).toInt();
        K9_KULLANICI_YETKILERI->sub_sube_islem_yetkisi                              = sql_query.VALUE ( "sub_sube_islem_yetkisi"      ).toInt();
        K9_KULLANICI_YETKILERI->sub_ent_hesaplari_guncelleme_yetkisi                = sql_query.VALUE ( "sub_ent_hesaplari_yetkisi"   ).toInt();

    /**************************************************************** ISLETME ************************************************/

        K9_KULLANICI_YETKILERI->isl_isletme_defteri_rapor_alma_yetkisi               = sql_query.VALUE ( "isl_raporunu_gorebilir_mi"     ).toInt();
        K9_KULLANICI_YETKILERI->isl_kdv_raporu_alma_yetkisi                          = sql_query.VALUE ( "isl_kdv_raporunu_gorebilir_mi" ).toInt();
        K9_KULLANICI_YETKILERI->isl_fisi_islem_yetkisi                               = sql_query.VALUE ( "isl_fisi_kesebilir_mi"         ).toInt();



    /**************************************************************** SM_MAKBUZU ************************************************/

        K9_KULLANICI_YETKILERI->smm_makbuzu_islem_yetkisi                           = sql_query.VALUE("smm_makbuzu_gorebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->smm_hizmet_tanimlama_yetkisi                        = sql_query.VALUE("smm_hizmet_tanimlayabilir_mi").toInt();
        K9_KULLANICI_YETKILERI->smm_tahsil_edildi_odendi_secili_gelsin              = sql_query.VALUE("smm_tahsil_edildi_odendi").toInt();

    /**************************************************************** DOVIZ ************************************************/

        K9_KULLANICI_YETKILERI->dvz_dovizleri_inceleme_yetkisi                        = sql_query.VALUE("dvz_kurlarini_gorebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->dvz_kur_guncelleme_yetkisi                            = sql_query.VALUE("dvz_kuru_guncelleyebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->dvz_doviz_tanimlama_yetkisi                           = sql_query.VALUE("dvz_tanimlayabilir_mi").toInt();


    /*******************************************************    PERAKENDE      *****************************************/

        K9_KULLANICI_YETKILERI->prk_fis_girebilir_mi                               = sql_query.VALUE  ( "prk_fisi_girebilir_mi").toInt();
        K9_KULLANICI_YETKILERI->prk_gdr_tur_tanimlayabilir_mi                      = sql_query.VALUE  ( "prk_gdr_tur_tanimlayabilir_mi").toInt();
        K9_KULLANICI_YETKILERI->prk_kasa_raporu_alabilir_mi                        = sql_query.VALUE  ( "prk_kasa_raporu_alabilir_mi").toInt();
}

/**************************************************************************************
                   K9_UPDATE_TANIMLANMAMIS_ENT_HESAPLARI
***************************************************************************************/
void K9_UPDATE_TANIMLANMAMIS_ENT_HESAPLARI( ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT("k9_sabit_degerler",
                         "ind_kdv_hesap_id_array, "
                         "ind_kdv_iade_hesap_id_array , hes_kdv_hesap_id_array,"
                         "hes_kdv_iade_hesap_id_array,otv_alis_hesap_id_array ,"
                         "otv_satis_hesap_id_array,tevkifat_kdv_hesap_id_array,"
    ...
    if ( query.SELECT() NE 0 ) {
        ...
        sql_query.PREPARE_UPDATE("k9_sabit_degerler",
                                 "sabit_deger_id",
                                 "ind_kdv_hesap_id_array               , "
...
static void UPGRADE_TO_VERSION (QString version)
{
    ...
    else if ( version EQ "2.40" ) {
        K9_V2_40_TO_V2_41_UPGRADE();
    }
    else if ( version EQ "2.42" ) {
        K9_V2_42_TO_V2_43_UPGRADE();
    }
    else if ( version EQ "2.43" ) {
        K9_V2_43_TO_V2_44_UPGRADE();
    }
    else if ( version EQ "2.44" ) {
        K9_V2_44_TO_V2_45_UPGRADE();
    }
    else if ( version EQ "2.46" ) {
        K9_V2_46_TO_V2_47_UPGRADE();
    }
    else if ( version EQ "2.48" ) {
        K9_V2_48_TO_V2_49_UPGRADE();
    }
    else if ( version EQ "2.50" ) {
        K9_V2_50_TO_V2_51_UPGRADE();
    }
    else if ( version EQ "2.52" ) {
        K9_V2_52_TO_V2_53_UPGRADE();
    }
    else if ( version EQ "2.56" ) {
        K9_V2_56_TO_V2_57_UPGRADE();
    }
    else if ( version EQ "2.60" ) {
        K9_V2_60_TO_V2_61_UPGRADE();
    }
    else if ( version EQ "2.62" ) {
        K9_V2_62_TO_V2_63_UPGRADE();
    }
    else if ( version EQ "2.63" ) {
        K9_V2_63_TO_V2_64_UPGRADE();
    }
    else if ( version EQ "2.64" ) {
        K9_V2_64_TO_V2_65_UPGRADE();
    }
    else if ( version EQ "2.65" ) {
        K9_V2_65_TO_V2_66_UPGRADE();
    }
    else if ( version EQ "2.66" ) {
        K9_V2_66_TO_V2_67_UPGRADE();
    }
    else if ( version EQ "2.67" ) {
        K9_V2_67_TO_V2_68_UPGRADE();
    }
    else if ( version EQ "2.68" ) {
        K9_V2_68_TO_V2_69_UPGRADE();
    }
    else if ( version EQ "2.70" ) {
        K9_V2_70_TO_V2_71_UPGRADE();
    }
    else if ( version EQ "2.71" ) {
        K9_V2_71_TO_V2_72_UPGRADE();
    }
    else if ( version EQ "2.73" ) {
        K9_V2_73_TO_V2_74_UPGRADE();
    }
    else if ( version EQ "2.74" ) {
        K9_V2_74_TO_V2_75_UPGRADE();
    }
    else if ( version EQ "2.76" ) {
        K9_V2_76_TO_V2_77_UPGRADE();
    }
    else if ( version EQ "2.81" ) {
...
{
    Q_INIT_RESOURCE(k9_icons);

    CHECK_VERSION_UPGRADES ( "program_version","k9_sabit_degerler",&UPGRADE_TO_VERSION );

    K9_SET_DEFAULT_VALUES();

    // K9 yetkileri yukleniyor
    K9_KULLANICI_YETKILERI_STRUCT_DOLDUR( KULLANICI_ID() );
    ...
    query.PREPARE_SELECT( "k9_sabit_degerler", "firma_ismi, mali_yil_ilk_tarih", "sabit_deger_id = :sabit_deger_id");
...
QString K9_GET_TAH_ODM_SEKLI_STRING(int tah_odm_sekli , int fis_turu)
{
...
void K9_RESTORE_MUHASEBE_ALAMLARI_VALUE ()
{
    ...
    query.PREPARE_SELECT("k9_sabit_degerler","muhasebe_alarmlari_kapalimi");
    if ( query.SELECT() NE 0 ) {
        query.NEXT();
...
/**************************************************************************************
                   K9_MUHASEBE_ALARMLARI_KAPALIMI
***************************************************************************************/
...
/**************************************************************************************
                   K9_SUBE_ENT_HESAPLARINI_GUNCELLE
***************************************************************************************/

void K9_SUBE_ENT_HESAPLARINI_GUNCELLE( int p_sube_id , ADAK_SQL * P_GELEN_DB)
{
...
/**************************************************************************************
                   K9_CLEAR_KULLANICI_YETKILERI_STRUCT
***************************************************************************************/

void K9_CLEAR_KULLANICI_YETKILERI_STRUCT( K9_KULLANICI_YETKILERI_STRUCT * P_K9_KULLANICI_YETKILERI )
{

    P_K9_KULLANICI_YETKILERI->sis_blg_formuna_girebilir_mi                                 = 0;
    P_K9_KULLANICI_YETKILERI->sis_kul_formuna_girebilir_mi                                 = 0;
    P_K9_KULLANICI_YETKILERI->sis_veritabani_formuna_girebilir_mi                          = 0;
    P_K9_KULLANICI_YETKILERI->sis_yonetim_log_inceleme_yetkisi                             = 0;
    P_K9_KULLANICI_YETKILERI->sis_mail_srv_tanimlayabilirmi                                = 0;
    P_K9_KULLANICI_YETKILERI->sis_sms_srv_tanimlayabilirmi                                 = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_yetkilendirme_yapabilir_mi                            = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_onar_yetkisi                                          = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_devir_islemi_yapabilir_mi                             = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_log_inceleme_yetkisi                                  = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_sabit_degerler_guncelleme_yetkisi                     = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_belge_tasarlama_yetkisi                               = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_ent_bilgilerini_degistirme_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_email_log_inceleme_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->ynt_k9_urettigi_fisleri_grbilir_mi                           = 0;

    //ADRES

    P_K9_KULLANICI_YETKILERI->adr_adres_karti_tanimlama_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->adr_not_defteri_inceleme_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->adr_etiket_yazdirma_yetkisi                               = 0;
    P_K9_KULLANICI_YETKILERI->adr_fihrist_raporu_alma_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->adr_toplu_mail_gonderme_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->adr_grup_tanimlama_yetkisi                                = 0;
    P_K9_KULLANICI_YETKILERI->adr_toplu_sms_gonderme_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->adr_adres_kayitlari_rapor_alma_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->adr_tel_web_kayitlari_rapor_alma_yetkisi                  = 0;

    //BANKA

    P_K9_KULLANICI_YETKILERI->bnk_banka_hesabi_acma_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->bnk_ent_fisleri_inceleme_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->bnk_defter_raporu_alma_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->bnk_pos_ekstresi_alma_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->bnk_hareket_fisi_islem_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->bnk_acilis_fisi_islem_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->bnk_makro_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->bnk_makro_fisi_islem_yetkisi                             = 0;
    P_K9_KULLANICI_YETKILERI->bnk_kk_ekstresi_alma_yetkisi                             = 0;
    P_K9_KULLANICI_YETKILERI->bnk_virman_islem_yetkisi                                 = 0;

    //CARI

    P_K9_KULLANICI_YETKILERI->cari_tahsilat_fisi_islem_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->cari_odeme_fisi_islem_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->cari_hareket_fisi_islem_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->cari_acilis_fisi_islem_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->cari_grup_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->cari_kart_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->cari_ent_fisleri_inceleme_yetkisi                        = 0;
    P_K9_KULLANICI_YETKILERI->cari_ekstre_alma_yetkisi                                 = 0;
    P_K9_KULLANICI_YETKILERI->cari_bakiye_raporu_alma_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->cari_virman_islem_yetkisi                                = 0;

    //CEKSENET

    P_K9_KULLANICI_YETKILERI->cek_senet_girebilir_mi                                  = 0;
    P_K9_KULLANICI_YETKILERI->cek_bordrosu_islem_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->cek_ent_fisleri_inceleme_yetkisi                        = 0;
    P_K9_KULLANICI_YETKILERI->cek_listesi_rapor_alma_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->cek_mus_cek_senet_arama_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->cek_acilis_bordrosu_islem_yetkisi                       = 0;

    //DEMIRBAS

    P_K9_KULLANICI_YETKILERI->dmr_amortisman_fisi_islem_yetkisi                       = 0;
    P_K9_KULLANICI_YETKILERI->dmr_grup_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->dmr_demirbas_karti_tanimlama_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->dmr_yen_degerleme_fisi_islem_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->dmr_demirbas_listesi_rapor_alma_yetkisi                 = 0;
    P_K9_KULLANICI_YETKILERI->dmr_toplu_amortisman_ayirma_yetkisi                     = 0;
    P_K9_KULLANICI_YETKILERI->dmr_toplu_yeniden_degerleme_yetkisi                     = 0;
    P_K9_KULLANICI_YETKILERI->dmr_rapor_islem_grubu_tanimlama_yetkisi                 = 0;


    //ISLETME

    P_K9_KULLANICI_YETKILERI->isl_isletme_defteri_rapor_alma_yetkisi                 = 0;
    P_K9_KULLANICI_YETKILERI->isl_kdv_raporu_alma_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->isl_fisi_islem_yetkisi                                 = 0;

    //MUHASEBE

    P_K9_KULLANICI_YETKILERI->muh_muhasebe_fisi_islem_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->muh_hesap_plani_islem_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->muh_yvm_no_olusturma_yetkisi                             = 0;
    P_K9_KULLANICI_YETKILERI->muh_hesap_ekstresi_alma_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->muh_mizan_raporu_alma_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->muh_hesap_plani_rapor_alma_yetkisi                       = 0;
    P_K9_KULLANICI_YETKILERI->muh_gelir_tablosu_rapor_alma_yetkisi                     = 0;
    P_K9_KULLANICI_YETKILERI->muh_bilanco_rapor_alma_yetkisi                           = 0;
    P_K9_KULLANICI_YETKILERI->muh_yvm_dokumu_alma_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->muh_defteri_kebir_raporu_alma_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->muh_fis_dokumu_alma_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->muh_hatali_fisleri_inceleme_yetkisi                      = 0;
    P_K9_KULLANICI_YETKILERI->muh_ent_fisleri_inceleme_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->muh_grup_tanimlama_yetkisi                               = 0;

    //PERSONEL

    P_K9_KULLANICI_YETKILERI->prs_bordro_inceleme_yetkisi                        = 0;
    P_K9_KULLANICI_YETKILERI->prs_ihbar_ve_kidem_tazminati_raporu_alma_yetkisi   = 0;
    P_K9_KULLANICI_YETKILERI->prs_isten_ayrilan_personel_arama_yetkisi           = 0;
    P_K9_KULLANICI_YETKILERI->prs_isten_ayrilma_islem_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->prs_maas_bordrosu_alma_yetkisi                     = 0;
    P_K9_KULLANICI_YETKILERI->prs_maas_bordrosu_iptal_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->prs_maas_bordrosu_raporu_alma_yetkisi              = 0;
    P_K9_KULLANICI_YETKILERI->prs_ek_kesinti_tanimlama_yetkisi                   = 0;
    P_K9_KULLANICI_YETKILERI->prs_ek_odenek_tanimlama_yetkisi                    = 0;
    P_K9_KULLANICI_YETKILERI->prs_personel_raporu_alma_yetkisi                   = 0;
    P_K9_KULLANICI_YETKILERI->prs_sicil_karti_tanimlama_yetkisi                  = 0;
    P_K9_KULLANICI_YETKILERI->prs_sabit_deger_guncelleme_yetkisi                 = 0;
    P_K9_KULLANICI_YETKILERI->prs_grup_tanimlama_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->prs_e_bildirge_alma_yetkisi                        = 0;
    P_K9_KULLANICI_YETKILERI->prs_ucret_pusulasi_raporu_alma_yetkisi             = 0;
    P_K9_KULLANICI_YETKILERI->prs_eksik_gun_nedenleri_giris_yetkisi              = 0;

    //STOK

    P_K9_KULLANICI_YETKILERI->stok_urun_karti_tanimlama_yetkisi                 =  0;
    P_K9_KULLANICI_YETKILERI->stok_fisi_islem_yetkisi                           =  0;
    P_K9_KULLANICI_YETKILERI->stok_grup_tanimlama_yetkisi                       =  0;
    P_K9_KULLANICI_YETKILERI->stok_hizmet_karti_tanimlama_yetkisi               =  0;
    P_K9_KULLANICI_YETKILERI->stok_urun_listesi_alma_yetkisi                    =  0;
    P_K9_KULLANICI_YETKILERI->stok_miktar_raporu_alma_yetkisi                   =  0;
    P_K9_KULLANICI_YETKILERI->stok_ekstresi_alma_yetkisi                        =  0;

    //FATURA

    P_K9_KULLANICI_YETKILERI->fat_alis_faturasi_kesebilir_mi                         = 0;
    P_K9_KULLANICI_YETKILERI->fat_sts_faturasi_kesebilir_mi                          = 0;
    P_K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_elle                            = 0;
    P_K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_oto                             = 0;
    P_K9_KULLANICI_YETKILERI->fat_irs_faturalastirma_toplu                           = 0;
    P_K9_KULLANICI_YETKILERI->fat_satir_iskontosu_yapabilir_mi                       = 0;
    P_K9_KULLANICI_YETKILERI->fat_toplu_iskonto_yapabilir_mi                         = 0;
    P_K9_KULLANICI_YETKILERI->fat_hizmet_ekstresi_alma_yetkisi                       = 0;
    P_K9_KULLANICI_YETKILERI->fat_ba_bs_listesi_alma_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->fat_fatura_listesi_alma_yetkisi                        = 0;

    //İRSALİYE

    P_K9_KULLANICI_YETKILERI->irs_alis_irsaliyesi_islem_yetkisi                         = 0;
    P_K9_KULLANICI_YETKILERI->irs_sts_irsaliyesi_islem_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_elle                          = 0;
    P_K9_KULLANICI_YETKILERI->irs_fat_irsaliyelestirme_oto                           = 0;
    P_K9_KULLANICI_YETKILERI->irs_satir_iskontosu_yapabilir_mi                       = 0;
    P_K9_KULLANICI_YETKILERI->irs_listesi_gorebilir_mi                               = 0;
    P_K9_KULLANICI_YETKILERI->irs_toplu_iskonto_yapabilir_mi                         = 0;



    //SUBE_DEPO_UNITE

    P_K9_KULLANICI_YETKILERI->sub_sube_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->sub_depo_tanimlama_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->sub_depo_islem_yetkisi                                  = 0;
    P_K9_KULLANICI_YETKILERI->sub_sube_islem_yetkisi                                  = 0;
    P_K9_KULLANICI_YETKILERI->sub_ent_hesaplari_guncelleme_yetkisi                    = 0;

    //SM_MAKBUZU

    P_K9_KULLANICI_YETKILERI->smm_makbuzu_islem_yetkisi                               = 0;
    P_K9_KULLANICI_YETKILERI->smm_hizmet_tanimlama_yetkisi                            = 0;
    P_K9_KULLANICI_YETKILERI->smm_tahsil_edildi_odendi_secili_gelsin                  = 0;

    //DOVIZ

    P_K9_KULLANICI_YETKILERI->dvz_dovizleri_inceleme_yetkisi                          = 0;
    P_K9_KULLANICI_YETKILERI->dvz_kur_guncelleme_yetkisi                              = 0;
    P_K9_KULLANICI_YETKILERI->dvz_doviz_tanimlama_yetkisi                             = 0;

    //PERAKENDE

    P_K9_KULLANICI_YETKILERI->prk_fis_girebilir_mi                                     = 0;
}
...
void K9_COPY_TABLES ( ADAK_SQL * P_SOURCE_DB, ADAK_SQL * P_TARGET_DB, QString p_table_name , QString p_where_condition, QStringList p_where_set_values )
{
    /*
     *  P_SOURCE_DB->GET_SQL_STRUCT(K9_PROGRAMI);
     *  parametre olarak k9 gonderilmesinin sebebi k9 devir ettigimiz icin.
     *  ADAK_VERITABANI_ID() kullannirsa SYS den giris yapildiginda sys tablolarinda
     *  kopyalama islemi yapmaya calisiyor.
     */

    ADAK_SQL_STRUCT  * SOURCE_STRUCT = P_SOURCE_DB->GET_SQL_STRUCT(K9_PROGRAMI);
...
int K9_GET_AYLAR_ENUM ( QString p_ay )
{
    if ( p_ay EQ  "OCAK" ) {
        return ENUM_OCAK;
    }
...
//*******************************************************************************
//             K9_KULLANICIYI_YETKILERI_UPDATE
//*******************************************************************************

void  K9_KULLANICIYI_YETKILERI_UPDATE ( K9_KULLANICI_YETKILERI_STRUCT * P_YETKI_STRUCT , int kullanici_id )
{

    SQL_QUERY query ( DB );


    query.PREPARE_UPDATE ( "k9_kullanici_yetkileri",
                          "yetki_id",
...
/************************************************** SISTEM  ***************************************************/
                    ...
                    "k9_yetkilendirme_yapabilir_mi      , muh_kullanabilir_mi,              "
                    ...
                    "faiz_kullanabilir_mi               ,                                   "
                    "k9_onar_yapabilir_mi               , k9_devir_islemi_yapabilir_mi,     "
                    "k9_log_gorebilir_mi                , "
                    "k9_sabit_degerlere_girebilirmi     , k9_belge_tasarlayabilir_mi,       "
                    "k9_ent_blg_degistirebilir_mi       , k9_kullanicinin_sirketi ,         "
                    "k9_sirket_degistire_bilir_mi            ,"
                    "prk_kullanabilir_mi,                k9_urettigi_fisleri_grbilir_mi " ,
                     "kullanici_id = :kullanici_id");
        ...
        query.SET_VALUE( ":k9_yetkilendirme_yapabilir_mi"       , P_YETKI_STRUCT->ynt_k9_yetkilendirme_yapabilir_mi                 );
        query.SET_VALUE( ":muh_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_muh_kullanabilir_mi                            );
        query.SET_VALUE( ":isl_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_isl_kullanabilir_mi                            );
        query.SET_VALUE( ":adr_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_adr_kullanabilir_mi                            );
        query.SET_VALUE( ":dvz_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_dvz_kullanabilir_mi                            );
        query.SET_VALUE( ":car_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_car_kullanabilir_mi                            );
        query.SET_VALUE( ":cek_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_cek_kullanabilir_mi                            );
        query.SET_VALUE( ":bnk_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_bnk_kullanabilir_mi                            );
        query.SET_VALUE( ":sub_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_sub_kullanabilir_mi                            );
        query.SET_VALUE( ":fat_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_fat_kullanabilir_mi                            );
        query.SET_VALUE( ":irs_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_irs_kullanabilir_mi                            );
        query.SET_VALUE( ":stk_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_stk_kullanabilir_mi                            );
        query.SET_VALUE( ":prs_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_prs_kullanabilir_mi                            );
        query.SET_VALUE( ":dmr_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_dmr_kullanabilir_mi                            );
        query.SET_VALUE( ":smm_makbuzu_kullanabilir_mi"         , P_YETKI_STRUCT->k9_smm_kullanabilir_mi                            );
        query.SET_VALUE( ":faiz_kullanabilir_mi"                , P_YETKI_STRUCT->k9_faiz_kullanabilir_mi                           );
        query.SET_VALUE( ":k9_onar_yapabilir_mi"                , P_YETKI_STRUCT->ynt_k9_onar_yetkisi                               );
        query.SET_VALUE( ":k9_devir_islemi_yapabilir_mi"        , P_YETKI_STRUCT->ynt_k9_devir_islemi_yapabilir_mi                  );
        query.SET_VALUE( ":k9_log_gorebilir_mi"                 , P_YETKI_STRUCT->ynt_k9_log_inceleme_yetkisi                       );
        query.SET_VALUE( ":k9_sabit_degerlere_girebilirmi"      , P_YETKI_STRUCT->ynt_k9_sabit_degerler_guncelleme_yetkisi          );
        query.SET_VALUE( ":k9_belge_tasarlayabilir_mi"          , P_YETKI_STRUCT->ynt_k9_belge_tasarlama_yetkisi                    );
        query.SET_VALUE( ":k9_ent_blg_degistirebilir_mi"        , P_YETKI_STRUCT->ynt_k9_ent_bilgilerini_degistirme_yetkisi         );
        query.SET_VALUE( ":k9_kullanicinin_sirketi"             , P_YETKI_STRUCT->ynt_k9_kullanicinin_calistigi_sirket              );
        query.SET_VALUE( ":k9_sirket_degistire_bilir_mi"        , P_YETKI_STRUCT->ynt_k9_kullanici_sirket_degistire_bilir_mi        );
        query.SET_VALUE( ":prk_kullanabilir_mi"                 , P_YETKI_STRUCT->k9_prk_kullanabilir_mi                            );
        query.SET_VALUE( ":k9_urettigi_fisleri_grbilir_mi"      , P_YETKI_STRUCT->ynt_k9_urettigi_fisleri_grbilir_mi                );

        query.SET_VALUE(":kullanici_id"       , kullanici_id );

        query.UPDATE();

        K9_LOG_KAYDI_EKLE(K9_YONETIM , LOG_K9_YETKILENDIRME , LOG_ISLEM_UPDATE , "Kullanıcı Yetkileri");

}

/*************************************************************************************************
                                 K9_GET_KAYDEDILECEK_SIRKET_ENUM
*************************************************************************************************/

int K9_GET_KAYDEDILECEK_SIRKET_ENUM(QString sirket_turu)
{
    if ( sirket_turu EQ QObject::tr("Her İki Şirkete")) {
        return SIRKET_1;
    }
    else if ( sirket_turu EQ QObject::tr("Sadece 2.şirkete")) {
        return SIRKET_2;
    }
    return -1;
}
...
/*************************************************************************************************
                                 K9_GET_KAYDEDILECEK_SIRKET_STRING
*************************************************************************************************/

QString K9_GET_KAYDEDILECEK_SIRKET_STRING(int sirket_turu)
{
    if ( sirket_turu EQ SIRKET_1 ) {
        return QObject::tr("Her İki Şirkete");
    }
    else if ( sirket_turu EQ SIRKET_2 ) {
        return QObject::tr("Sadece 2.şirkete");
    }
    return "";
}
...
{
    if ( rapor_sirket_turu EQ QObject::tr("Her İki Şirket")) {
        return FIS_HER_IKI_SIRKET;
    }
    else if ( rapor_sirket_turu EQ QObject::tr("Birinci Şirket") ) {
        return FIS_BIRINCI_SIRKET;
    }
    else if ( rapor_sirket_turu EQ QObject::tr("İkinci Şirket")) {
        return FIS_IKINCI_SIRKET;
    }
    return -1;
}
...
/*************************************************************************************************
                                 K9_GET_RAPOR_SIRKET_FILTRESI_STRING
*************************************************************************************************/

QString K9_GET_RAPOR_SIRKET_FILTRESI_STRING(int rapor_sirket_turu)
{
    switch ( rapor_sirket_turu ) {
        case FIS_HER_IKI_SIRKET :
            return QObject::tr("Her İki Şirket");

        case FIS_BIRINCI_SIRKET :
            return QObject::tr("Birinci Şirket");

        case FIS_IKINCI_SIRKET:
            return QObject::tr("İkinci Şirket");
...
QString K9_GET_SM_SICIL_NUMARASI()
{
    ...
    query.PREPARE_SELECT( "k9_sabit_degerler","sm_sicil_numarasi");
...
/*************************************************************************************************
                                 K9_GET_SISTEM_KULLANICI_YETKILERI
*************************************************************************************************/

void K9_GET_SISTEM_KULLANICI_YETKILERI( int p_kullanici_id, SYSTEM_MENU_ITEMS &SISTEM_STRUCT )
{
    K9_KULLANICI_YETKILERI_STRUCT_DOLDUR( p_kullanici_id );

    SISTEM_STRUCT.sis_blg_formuna_girebilir_mi          = K9_KULLANICI_YETKILERI->sis_blg_formuna_girebilir_mi;
    SISTEM_STRUCT.sis_kul_formuna_girebilir_mi          = K9_KULLANICI_YETKILERI->sis_kul_formuna_girebilir_mi;
    SISTEM_STRUCT.sis_mail_srv_tanimlayabilirmi         = K9_KULLANICI_YETKILERI->sis_mail_srv_tanimlayabilirmi;
    SISTEM_STRUCT.sis_sms_srv_tanimlayabilirmi          = K9_KULLANICI_YETKILERI->sis_sms_srv_tanimlayabilirmi;
    SISTEM_STRUCT.sis_veritabani_formuna_girebilir_mi   = K9_KULLANICI_YETKILERI->sis_veritabani_formuna_girebilir_mi;
    SISTEM_STRUCT.sis_yonetim_log_inceleme_yetkisi      = K9_KULLANICI_YETKILERI->sis_yonetim_log_inceleme_yetkisi;
...
/*************************************************************************************************
                                 LOAD_K9_KOMPLE_PAKET
*************************************************************************************************/

void LOAD_K9_KOMPLE_PAKET()
{
    SQL_QUERY query( DB );
    query.PREPARE_UPDATE( "k9_kullanici_yetkileri", "yetki_id",
                          "muh_kullanabilir_mi          ,"
                          "isl_kullanabilir_mi          ,"
                          "adr_kullanabilir_mi          ,"
                          "dvz_kullanabilir_mi          ,"
