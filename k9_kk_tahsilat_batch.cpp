#include <QMessageBox>
#include "k9_kk_tahsilat_batch_class.h"
#include "ui_k9_kk_tahsilat_batch.h"
#include "dvz_enum.h"
...
/**************************************************************************************
                   OPEN_K9_KK_TAHSILAT_BATCH
***************************************************************************************/

bool OPEN_K9_KK_TAHSILAT_BATCH ( int fis_satiri_id , K9_ISLEM_DETAYLARI * P_ISLEM_DETAYLARI ,int p_modul_id,QWidget * parent )
{
    bool kayit_degisti_mi = false;
    K9_KK_TAHSILAT_BATCH * F = new K9_KK_TAHSILAT_BATCH ( fis_satiri_id , P_ISLEM_DETAYLARI , p_modul_id ,parent );
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::K9_KK_TAHSILAT_BATCH
***************************************************************************************/

K9_KK_TAHSILAT_BATCH::K9_KK_TAHSILAT_BATCH ( int fis_satiri_id , K9_ISLEM_DETAYLARI * P_ISLEM_DETAYLARI ,int p_modul_id,
                                                 QWidget * parent ) :  BATCH_KERNEL ( parent ), m_ui ( new Ui::K9_KK_TAHSILAT_BATCH )
{
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::SETUP_FORM
***************************************************************************************/

void K9_KK_TAHSILAT_BATCH::SETUP_FORM()
{
    SET_PAGE_TITLE    ( tr ( "KREDİ KARTI DETAYLARI" ) );
    SET_HELP_PAGE     ( "k9-kk-tahsilat"               );
    ...
    SET_SETTING_NAME             ( "K9_KK_TAHSILAT_BATCH"         );
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::CHECK_VAR
***************************************************************************************/

int K9_KK_TAHSILAT_BATCH::CHECK_VAR ( QObject * object )
{
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::CHECK_RUN
***************************************************************************************/

int K9_KK_TAHSILAT_BATCH::CHECK_RUN ()
{
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::RUN_BATCH
***************************************************************************************/

void K9_KK_TAHSILAT_BATCH::RUN_BATCH ()
{
...
/**************************************************************************************
                   K9_KK_TAHSILAT_BATCH::SEARCH_EDIT_CLICKED
***************************************************************************************/

void K9_KK_TAHSILAT_BATCH::SEARCH_EDIT_CLICKED ( QWidget * , QLineEdit * line_edit)
{
