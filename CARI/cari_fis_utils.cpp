...
int CARI_FIS_EKLE ( CARI_FIS_STRUCT * P_FIS , ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_INSERT ("car_fisler", "fis_id", "fis_no, fis_tarihi, cari_hesap_id, aciklama, "
                           ...
                           "last_order_number, kaydedilecek_sirket , muh_fis_id, yazdirildi_mi, iptal_mi " );
                           ...
                           int p_fis_satiri_id , int *p_muh_olusan_fis_satiri_id, ADAK_SQL * P_GELEN_DB)
{
    ...
    //! k9 onardan gelmis ise hareket eklemesi lazim
    ...
    if ( base_fis_satiri_eklenecek EQ true ) {
        ...
        if ( fis_turu EQ ENUM_CARI_TAHSILAT_FISI ) {
            ...
            if ( P_FIS_SATIRI->islem_turu EQ ENUM_MUSTERI_CEKI OR
                ...
                CEK_SENET->kaydedilecek_sirket      =   P_FIS_SATIRI->kaydedilecek_sirket;
    ...
    if ( modul_id EQ CARI_MODULU OR program_id NE K9_PROGRAMI ) {
    ...
    if ( base_fis_satiri_eklenecek EQ true ) {
        ...
        CARI_HESABIN_BAKIYESINI_ARTTIR  ( gun_no, cari_hesap_id, cari_para_birimi_borc_tutari,
                                          cari_para_birimi_alacak_tutari, P_FIS_SATIRI->kaydedilecek_sirket ,USE_DB );
    }
...
int CARI_FIS_SATIRI_SIL ( CARI_FIS_STRUCT * P_FIS, int p_fis_satiri_id ,ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT ( "car_fisler, car_fis_satirlari ",
                           ...
                           "cek_senet_id, car_fis_satirlari.kaydedilecek_sirket, base_record_id, "
    ...
    int     kaydedilecek_sirket         = query.VALUE ( 15 ).toInt();
    ...
    // K9 programi sys den geldiginde kapora iptal edilmemesi icin 0 geliyor. onun  icin if girmesi gerekiyor
    if ( P_FIS->modul_id EQ CARI_MODULU OR P_FIS->program_id NE K9_PROGRAMI ) {
        if ( base_fis_id EQ 0 ) {
            base_fis_id = fis_id;
        }
        ...
        case ENUM_KREDI_KARTI:
            {
                ...
                if ( BNK_FIS_SATIRI_ID_LIST.size() > 0 ) {
                    ...
                    BNK_FIS->kaydedilecek_sirket   = P_FIS->kaydedilecek_sirket;
    ...
    CARI_HESABIN_BAKIYESINI_AZALT ( gun_no, cari_hesap_id, cari_para_birimi_borc, cari_para_birimi_alacak, kaydedilecek_sirket ,USE_DB);
...
void CARI_FISI_GUNCELLE ( CARI_FIS_STRUCT * P_FIS, int p_fis_id  )
{
    ...
    f_query.PREPARE_SELECT ( "car_fisler",
                             ...
                             "makbuz_para_birimi_id, doviz_kuru, parite, kaydedilecek_sirket, muh_fis_id, "
    ...
    int     old_entegre_olsun_mu        =   f_query.VALUE ( "kaydedilecek_sirket" ).toInt();
    ...
    if ( old_entegre_olsun_mu NE P_FIS->kaydedilecek_sirket ) {
        bakiyeler_guncellenecek = true;
    }
            ...
            default                     :
                ...
                if ( f_query.SELECT( "order_number" ) > 0 ) {
                    while ( f_query.NEXT() EQ true ) {
                        ...
                        CARI_HESABIN_BAKIYESINI_AZALT  ( old_gun_no, satir_cari_hesap_id, cari_para_birimi_borc_tutari, cari_para_birimi_alacak_tutari, old_entegre_olsun_mu    );
                        CARI_HESABIN_BAKIYESINI_ARTTIR ( new_gun_no, satir_cari_hesap_id, cari_para_birimi_borc_tutari, cari_para_birimi_alacak_tutari, P_FIS->kaydedilecek_sirket );
                    }
                }
                break;
                ...
                if ( satirlari_tekrar_hesapla EQ true ) {
                    ...
                    if ( f_query.SELECT() > 0 ) {
                        while ( f_query.NEXT() EQ true ) {
                            ...
                            CARI_HESABIN_BAKIYESINI_AZALT  ( old_gun_no, old_cari_hesap_id, old_cari_para_birimi_borc_tutari, old_cari_para_birimi_alacak_tutari, old_entegre_olsun_mu    );
                            CARI_HESABIN_BAKIYESINI_ARTTIR ( new_gun_no, new_cari_hesap_id, new_cari_para_birimi_borc_tutari, new_cari_para_birimi_alacak_tutari, P_FIS->kaydedilecek_sirket );
                    ...
                    if ( f_query.SELECT() > 0 ) {
                        while ( f_query.NEXT() EQ true ) {
                            ...
                            CARI_HESABIN_BAKIYESINI_AZALT  ( old_gun_no, old_cari_hesap_id, cari_para_birimi_borc_tutari, cari_para_birimi_alacak_tutari, old_entegre_olsun_mu );
                            CARI_HESABIN_BAKIYESINI_ARTTIR ( new_gun_no, new_cari_hesap_id, cari_para_birimi_borc_tutari, cari_para_birimi_alacak_tutari, P_FIS->kaydedilecek_sirket );
    ...
    f_query.SET_VALUE ( ":kaydedilecek_sirket",        P_FIS->kaydedilecek_sirket                     );
    ...
    if ( old_entegre_olsun_mu NE P_FIS->kaydedilecek_sirket ) {
        ...
        f_query.PREPARE_UPDATE("car_fis_satirlari","fis_id","kaydedilecek_sirket ",
                               "fis_id = :fis_id");
        f_query.SET_VALUE(":kaydedilecek_sirket" , P_FIS->kaydedilecek_sirket );
        f_query.SET_VALUE(":fis_id" , p_fis_id);
        f_query.UPDATE();
    ...
    if ( muh_fis_id > 0 ) {
        ...
        MUHASEBE_FISI->kaydedilecek_sirket = P_FIS->kaydedilecek_sirket;
...
int CARI_FIS_SATIRINI_GUNCELLE ( CARI_FIS_STRUCT * P_FIS, CARI_FIS_SATIRI_STRUCT * P_FIS_SATIRI, int p_fis_satiri_id )
{
    ...
    query.PREPARE_SELECT ( "car_fis_satirlari, car_fisler",
                           ...
                           "car_fisler.fis_id, car_fis_satirlari.kaydedilecek_sirket, base_record_id, "
    ...
    double  fis_parite                              = query.VALUE ( 21 ).toDouble();
    int     fis_cari_hesap_id                       = query.VALUE ( 11 ).toInt();

    QDate   fis_tarihi                              = QDate::fromString ( query.VALUE("fis_tarihi").toString(), "yyyy.MM.dd" );
    int     muh_fis_id                              = query.VALUE("muh_fis_id").toInt();

    int     kaydedilecek_sirket                        = query.VALUE ( 18 ).toInt();
    ...
    if ( cari_bakiye_guncellenecek EQ true ) {
        ...
        CARI_HESABIN_BAKIYESINI_AZALT  ( gun_no, old_cari_hesap_id, old_cari_para_birimi_borc_tutari, old_cari_para_birimi_alacak_tutari, kaydedilecek_sirket );
        CARI_HESABIN_BAKIYESINI_ARTTIR ( gun_no, new_cari_hesap_id, new_cari_para_birimi_borc_tutari, new_cari_para_birimi_alacak_tutari, kaydedilecek_sirket );
            ...
            case ENUM_KENDI_SENEDIMIZ :
                if ( P_FIS->modul_id EQ CARI_MODULU ) {
                    if ( old_cek_senet_id > 0 ) {
                        ...
                        CEK_BORDROSU->modul_id         = P_FIS->modul_id;
                        CEK_BORDROSU->program_id       = P_FIS->program_id;
                        CEK_BORDROSU->kaydedilecek_sirket = P_FIS->kaydedilecek_sirket;
            ...
            case ENUM_MUSTERI_SENEDI    :
                ...
                if ( P_FIS_SATIRI->cek_senet_id > 0 ) {
                    ...
                    if ( bordro_id EQ 0 ) {
                        ...
                        CEK_BORDROSU->aciklama         = aciklama;
                        CEK_BORDROSU->kaydedilecek_sirket = P_FIS_SATIRI->kaydedilecek_sirket;
                        CEK_BORDROSU->muh_fis_id       = muh_fis_id;
                    ...
                    BORDRO_SATIRI->kaydedilecek_sirket         = P_FIS_SATIRI->kaydedilecek_sirket;
            ...
            case ENUM_KREDI_KARTI:
                {
                    ...
                    BNK_FIS_SATIRI->kaydedilecek_sirket       = P_FIS_SATIRI->kaydedilecek_sirket;
...
void CARI_FIS_BILGILERINI_OKU ( CARI_FIS_STRUCT * P_FIS, int p_fis_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT ( "car_fisler",
                           ...
                           "muh_kasa_hesap_id, modul_id, program_id , kaydedilecek_sirket ,"
...
void CARI_FIS_SATIRINI_OKU(CARI_FIS_SATIRI_STRUCT *P_FIS_SATIRI, int p_fis_satiri_id ,ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT("car_fis_satirlari","fis_id, aciklama, borc_tutari, alacak_tutari, kredi_karti_numarasi,"
                         ...
                         "kaydedilecek_sirket , base_record_id , modul_id , program_id, cari_para_birimi_tutari ",
                         "fis_satiri_id = :fis_satiri_id");
    query.SET_VALUE(":fis_satiri_id" , p_fis_satiri_id);
