...
void CARI_HESABIN_BAKIYESINI_ARTTIR ( int gun_no, int cari_hesap_id, double borc_tutari,
                                      double alacak_tutari, int p_kaydedilecek_sirket , ADAK_SQL * P_GELEN_DB)

{
    ...
    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 0 ).toString(), TOPLAM_BORC_ARRAY      , K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 2 ).toString(), ENT_BORC_ARRAY         , K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 4 ).toString(), ENT_OLMAYAN_BORC_ARRAY , K9_ARRAY_SIZE );

    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 1 ).toString(), TOPLAM_ALACAK_ARRAY      , K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 3 ).toString(), ENT_ALACAK_ARRAY         , K9_ARRAY_SIZE );
    UNPACK_DOUBLE_ARRAY ( query.VALUE ( 5 ).toString(), ENT_OLMAYAN_ALACAK_ARRAY , K9_ARRAY_SIZE);
...
void CARI_HESABIN_BAKIYESINI_AZALT ( int gun_no, int cari_hesap_id,double borc_tutari, double alacak_tutari,
...
int CARI_KART_OLUSTUR ( int cari_kart_turu , CARI_HESAP_STRUCT * kayit_bilgileri )
{
    ...
    if ( kayit_bilgileri->modul_id EQ CARI_MODULU AND kayit_bilgileri->program_id EQ K9_PROGRAMI ) {
    ...
    K9_LOG_KAYDI_EKLE(CARI_MODULU,LOG_CARI_HESAPLAR,LOG_ISLEM_ADD,log_detaylari);
...
bool CARI_KART_GUNCELLE ( int cari_hesap_id,int cari_kart_turu,CARI_HESAP_STRUCT * kayit_bilgileri )
{
    ...
    K9_LOG_KAYDI_EKLE(CARI_MODULU,LOG_CARI_HESAPLAR,LOG_ISLEM_UPDATE,log_detaylari);
...
bool CARI_KART_SIL ( int cari_hesap_id )
{
    ...
    K9_LOG_KAYDI_EKLE ( CARI_MODULU , LOG_CARI_HESAPLAR , LOG_ISLEM_DELETE,log_detaylari);
...
{ 
    ...
    if ( !( program_id EQ K9_PROGRAMI AND modul_id EQ CARI_MODULU ) ) {
...
int  CARI_KART_BORC_BILGISINI_GETIR  ( int cari_hesap_id, BORC_BILGISI * borc_bilgisi )
{
    ...
    if ( K9_KULLANICININ_CALISTIGI_SIRKET() EQ SIRKET_1 ) {
        UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_borc_array").toString(), toplam_borc_array     , K9_ARRAY_SIZE);
        UNPACK_DOUBLE_ARRAY( select_query.VALUE("ent_alacak_array").toString(), toplam_alacak_array , K9_ARRAY_SIZE);
    }
    else {
    ...
    double toplam_borc   = toplam_borc_array   [K9_SON_BAKIYE];
    double toplam_alacak = toplam_alacak_array [K9_SON_BAKIYE];
