...
void CARI_HESAP_EKSTRESI_BATCH::RUN_BATCH()
{
    ...
    CARI_RV->entegre_filtresi    = K9_GET_RAPOR_SIRKET_FILTRESI_ENUM(m_ui->comboBox_sirket->currentText());
    ...
    K9_LOG_KAYDI_EKLE ( CARI_MODULU ,LOG_CARI_RAPORLAR , LOG_ISLEM_RAPOR_ALINDI , log_detaylari );
