...
void CARI_OTO_EKSTRE_ARAMA::SEARCH ()
{
    ...
    if( K9_KULLANICININ_CALISTIGI_SIRKET() EQ SIRKET_1 ) {
        query.AND_EKLE ( "car_fisler.kaydedilecek_sirket = :kaydedilecek_sirket");
    ...
    QList <int> irsaliye_list = IRS_GET_IRSALIYE_ID_LIST( m_cari_hesap_id, CARI_FIS.kaydedilecek_sirket );
