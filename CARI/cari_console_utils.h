...
void        CARI_HESABIN_BAKIYESINI_ARTTIR                      ( int gun_no,int cari_hesap_id,double doviz_borc_tutari,double doviz_alacak_tutari, int p_entegre_olsun_mu ,ADAK_SQL * P_GELEN_DB = NULL );

void        CARI_HESABIN_BAKIYESINI_AZALT                       ( int gun_no,int cari_hesap_id,double doviz_borc_tutari,double doviz_alacak_tutari, int p_entegre_olsun_mu ,ADAK_SQL * P_GELEN_DB = NULL);
