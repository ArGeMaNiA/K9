...
void CARI_ITEM_CLICKED(int enum_id,QWidget * parent)
{
    ...
    switch ( enum_id ) {
        ...
        case MENU_CARI_GRUPLAR               :
            OPEN_GRUPLAR( K9_PROGRAMI,CARI_MODULU, QObject::tr( "CARİ - CARİ GRUPLAR" ), QObject::tr("cari-hesap-islemleri_cari-gruplar"), DB, parent );
            break;
        ...
        case MENU_CARI_HESAP_EKSTRESI               :
            OPEN_CARI_HESAP_EKSTRESI_BATCH ( K9_PROGRAMI, CARI_MODULU, -1, parent );
            break;

        case MENU_CARI_BAKIYE_RAPORU                :
            OPEN_CARI_BAKIYE_RAPORU_BATCH ( K9_PROGRAMI, CARI_MODULU, parent );
            break;
        ...
        case MENU_CARI_KART_EXPORT :
            OPEN_CARI_KART_ARAMA( "" , SAHIS_ARTI_FIRMA , parent , 1 , K9_PROGRAMI, CARI_MODULU , QObject::tr( "Dışarıya Kayıt İhraç Etme" ) ,
