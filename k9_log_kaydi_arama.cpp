#include "k9_log_kaydi_arama_class.h"
#include "ui_k9_log_kaydi_arama.h"
#include "yonetim.h"
...
/**************************************************************************************
                              OPEN_K9_LOG_KAYDI_BATCH
***************************************************************************************/

void OPEN_K9_LOG_KAYDI_ARAMA ( QWidget * p_parent )
{
    K9_LOG_KAYDI_ARAMA *  F  = new K9_LOG_KAYDI_ARAMA ( p_parent );
    F->EXEC( NOT_FULL_SCREEN );
}

/**************************************************************************************
                            K9_LOG_KAYDI_ARAMA::K9_LOG_KAYDI_ARAMA
***************************************************************************************/

K9_LOG_KAYDI_ARAMA::K9_LOG_KAYDI_ARAMA ( QWidget * p_parent ) : ARAMA_KERNEL ( p_parent ), m_ui ( new Ui::K9_LOG_KAYDI_ARAMA )
{
    m_ui->setupUi     ( this );
...
/**************************************************************************************
                                K9_LOG_KAYDI_ARAMA::SETUP_FORM
***************************************************************************************/

void K9_LOG_KAYDI_ARAMA::SETUP_FORM()
{
    SET_HELP_PAGE  ( "yonetim-islemleri_k9-log-bilgileri" );

    QString page_title = tr("K9 Log Bilgisi Arama");
    ...
    K9_FILL_COMBOBOX_ADAK_MODULES   ( m_ui->comboBox_modul_secimi );
    ...
    m_ui->comboBox_modul_secimi->setCurrentIndex ( m_ui->comboBox_modul_secimi->findText ( K9_GET_ADAK_MODULES_STRING ( ADRES_MODULU ) ));
    ...
    SET_SETTING_NAME                  ( "K9_LOG_KAYDI_ARAMA" );
}

/**************************************************************************************
                                K9_LOG_KAYDI_ARAMA::CHECK_VAR
***************************************************************************************/

int K9_LOG_KAYDI_ARAMA::CHECK_VAR ( QObject * p_object )
{
...
/**************************************************************************************
                               K9_LOG_KAYDI_ARAMA::CHECK_RUN
***************************************************************************************/

int K9_LOG_KAYDI_ARAMA::CHECK_RUN ()
{
    if ( m_ui->checkBox_kullanici_secimi->isChecked() EQ true ) {
        if ( m_ui->searchEdit_kullanici_kodu->GET_TEXT().isEmpty() EQ true ) {
...
/**************************************************************************************
                             K9_LOG_KAYDI_ARAMA::SEARCH
***************************************************************************************/

void K9_LOG_KAYDI_ARAMA::SEARCH ()
{
    m_ui->textEdit_yapilan_islem->clear();

    int     selected_modul   = K9_GET_ADAK_MODULES_ENUM ( m_ui->comboBox_modul_secimi->currentText() );
    ...
    if ( m_ui->checkBox_log_turu->isChecked() EQ true ) {
        log_turu     = K9_GET_LOG_TURLERI_ENUM ( m_ui->comboBox_log_turu->currentText() );
    }
    ...
    sql_query.PREPARE_SELECT ( "k9_log_bilgileri",
    ...
    while ( sql_query.NEXT() EQ true ) {
        ...
        log_turu_str  = K9_GET_LOG_TURLERI_STRING ( sql_query.VALUE("log_turu").toInt() );
        ...
        m_ui->tableWidget->item ( current_row, ISLEM_TURU_COLUMN   )->setText ( K9_GET_LOG_ISLEMLERI_STRING ( sql_query.VALUE(6).toInt() ) );
    }

}

/**************************************************************************************
                         K9_LOG_KAYDI_ARAMA::SELECTED_LINE
***************************************************************************************/

void K9_LOG_KAYDI_ARAMA::SELECTED_LINE ( int p_selected_row_number )
{
    SQL_QUERY sql_query ( DB );
...
/**************************************************************************************
                        K9_LOG_KAYDI_ARAMA::SINGLE_LINE_SELECTED
***************************************************************************************/

int K9_LOG_KAYDI_ARAMA::SINGLE_LINE_SELECTED ( int p_selected_row_number )
{
...
/**************************************************************************************
                        K9_LOG_KAYDI_ARAMA::SEARCH_EDIT_CLICKED
***************************************************************************************/

void K9_LOG_KAYDI_ARAMA::SEARCH_EDIT_CLICKED ( QWidget * p_widget, QLineEdit * p_line_edit )
{
    Q_UNUSED ( p_widget );
...
/**************************************************************************************
                    K9_LOG_KAYDI_ARAMA::FILL_LOG_TURLERI_COMBOBOX
***************************************************************************************/

void K9_LOG_KAYDI_ARAMA::FILL_LOG_TURLERI_COMBOBOX ()
{
    m_ui->comboBox_log_turu->clear();

    int secilen_modul = K9_GET_ADAK_MODULES_ENUM ( m_ui->comboBox_modul_secimi->currentText() );
    ...
    switch ( secilen_modul ) {
        ...
        case K9_YONETIM:
            m_ui->comboBox_log_turu->addItems(QStringList () << QObject::tr("K9 Onar")
