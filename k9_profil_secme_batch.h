#ifndef K9_PROFIL_SECME_H
#define K9_PROFIL_SECME_H
...
enum PROFIL_CAGRILAN_YER {
    ENUM_K9_KULLANICI_YETKILERI = 0,
    ENUM_K9_BASLANGIC           = 1
};

class K9_PROFIL_SECME : public BATCH_KERNEL
{
    Q_OBJECT

public:
    explicit K9_PROFIL_SECME( PROFIL_CAGRILAN_YER p_cagrilan_yer, QWidget *parent = 0, bool * p_degisiklik_yapildimi = false );
    ~K9_PROFIL_SECME() {}

private:
    Ui::K9_PROFIL_SECME *m_ui;
...
private:
    ...
    void    K9_KULLANICI_STRUCT_GUNCELLE();
    void    K9_PROFIL_BILGILERINI_DB_YAZ();

};

void  OPEN_K9_PROFIL_SECME ( PROFIL_CAGRILAN_YER p_cagrilan_yer, QWidget * parent , bool * p_degisiklik_yapildimi = false );

#endif // K9_PROFIL_SECME_H
