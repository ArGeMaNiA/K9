...
int SMM_MAKBUZ_EKLE(SMM_MAKBUZ_STRUCT *P_MAKBUZ)
{
    ...
    query.PREPARE_INSERT("smm_makbuzlar" , "makbuz_id" , "makbuz_no,makbuz_tarihi,aciklama,"
                         ...
                         "program_id,base_record_id,kaydedilecek_sirket,hizmet_tutari,muh_kasa_hesap_id,"
    ...
    query.SET_VALUE(":kaydedilecek_sirket"                  , P_MAKBUZ->kaydedilecek_sirket);
    ...
    if ( P_MAKBUZ->muh_fis_id EQ 0 AND P_MAKBUZ->modul_id EQ SMM_MODULU ) {
        ...
        MUHASEBE_FISI->kaydedilecek_sirket       = P_MAKBUZ->kaydedilecek_sirket;
...
void SMM_MAKBUZ_GUNCELLE(SMM_MAKBUZ_STRUCT *P_MAKBUZ, int p_makbuz_id)
{
    ...
    query.PREPARE_UPDATE("smm_makbuzlar" , "makbuz_id" , "makbuz_no,makbuz_tarihi,aciklama,"
                         ...
                         "sm_sicil_numarasi,kaydedilecek_sirket,muh_kasa_hesap_id,tevkifatli_mi,"
...
void SMM_MAKBUZ_BILGILERINI_OKU(SMM_MAKBUZ_STRUCT *P_MAKBUZ, int p_makbuz_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    query.PREPARE_SELECT("smm_makbuzlar" , "makbuz_no,makbuz_tarihi,aciklama,cari_hesap_id,"
                         ...
                         "modul_id,program_id,base_record_id,kaydedilecek_sirket,hizmet_tutari,makbuz_turu,"
    ...
    P_MAKBUZ->kaydedilecek_sirket                 = query.VALUE("kaydedilecek_sirket").toInt();
...
void SMM_CLEAR_MAKBUZ_STRUCT(SMM_MAKBUZ_STRUCT *P_MAKBUZ)
{
    ...
    P_MAKBUZ->kaydedilecek_sirket                = -1;
...
void SMM_ODENDI_TAHSIL_EDILDI_ENT_FISLERI_OLUSTUR(SMM_MAKBUZ_STRUCT *P_MAKBUZ , int p_makbuz_id , ADAK_SQL * P_GELEN_DB)
{
    ...
    if ( banka_tutari > 0 ) {
        ...
        BNK_FISI->kaydedilecek_sirket       = P_MAKBUZ->kaydedilecek_sirket;
        ...
        BNK_FIS_SATIRI->kaydedilecek_sirket       = P_MAKBUZ->kaydedilecek_sirket;
    ...
    if ( cari_fis_id > 0 ) {
        ...
        CARI_FIS_SATIRI->kaydedilecek_sirket                    =  P_MAKBUZ->kaydedilecek_sirket;
...
void SMM_ENT_FISLERI_OLUSTUR(SMM_MAKBUZ_STRUCT * P_MAKBUZ, int p_makbuz_id,ADAK_SQL * P_GELEN_DB)
{
    ...
    CARI_FISI->kaydedilecek_sirket            = P_MAKBUZ->kaydedilecek_sirket;
    ...
    MUH_FIS_SATIRI->kaydedilecek_sirket     = P_MAKBUZ->kaydedilecek_sirket;
