...
void SMM_ENT_DETAYLARI_BATCH::SETUP_FORM ()
{
    ...
    m_ui->comboBox_sirket->setCurrentIndex(m_ui->comboBox_sirket->findText(K9_GET_KAYDEDILECEK_SIRKET_STRING( M_ENT_DETAYLARI->kaydedilecek_sirket )));
...
{
    M_ENT_DETAYLARI->kaydedilecek_sirket           = K9_GET_KAYDEDILECEK_SIRKET_ENUM(m_ui->comboBox_sirket->currentText());
