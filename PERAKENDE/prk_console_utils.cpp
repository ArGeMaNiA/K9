...
QList <double> PRK_GET_FIS_KDV_HARIC_TOPLAM_TUTAR(QString bas_tarihi, QString bts_tarihi, int kaydedilecek_sirket, double max_tutar, int fat_alis_satis_turu)
{
